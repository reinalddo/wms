        ...
        init: function () {
            ...
            if (jQuery().bootstrapWizard) {
                ...
                var a = function () {
                    ...
                    $(".step-title", $("#form_wizard_1")).text("Paso " + (t + 1) + " de " + i), jQuery("li", $("#form_wizard_1")).removeClass("done");
                    ...
                    onNext: function (tab, navigation, index) {
                        ...
                        switch (index) {
                            case 0:
                                ...
                                break;
                            case 1:
                                if ((typeof sessionStorage.folios == 'undefined' || sessionStorage.folios == '') || $("#select_transporte").val() == '') {
                                    toastr.options = {
                                        "closeButton": true,
                                        "debug": false,
                                    ...
                                    toastr.error("Por Favor escoja un Pedido o un Transporte", "Verifique los Datos");
                                    return false;
                                }
                                $("#form_wizard_1").find(".button-previous").show();
                                //TODO Alberto llamar al procedimiento de contenedores y cajas
                                if (sessionStorage.cargadatablacajas == 0) {
                                    muestra_contcajas();
                                }
                                break;
                            case 2:
                        ...
                        // if (typeof sessionStorage.folios=='undefined') return false;
