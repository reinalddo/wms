...
class GrupoArticulos {
    ...
    function getAllCopiar($id_almacen = "") {

      $sql_almacen = "";
      //if($id_almacen)
      //  $sql_almacen = " AND id_almacen != '{$id_almacen}' ";

        $sql = "SELECT DISTINCT c_gpoarticulo.*, a.clave, a.nombre FROM c_gpoarticulo 
                LEFT JOIN c_almacenp a ON a.id = c_gpoarticulo.id_almacen
