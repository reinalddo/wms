    ...
    $sql2 = "INSERT INTO c_compania
        ...
        if($data['es_3PL'] == 0)
        {
          $sql = "
              ...
              SET
                  cve_proveedor = '".$data['cve_empresa']."', 
                  Nombre = '".utf8_decode($data['des_cia'])."', 
                  direccion = '".utf8_decode($data['des_direcc'])."', 
                  colonia = '".utf8_decode($data['distrito'])."', 
                  cve_dane = '".utf8_decode($data['des_cp'])."', 
                  ciudad = '".utf8_decode($data['distrito'])."', 
                  estado = '".utf8_decode($data['distrito'])."', 
                  pais = '".utf8_decode($data['distrito'])."'  , 
                  RUT = '".utf8_decode($data['cve_empresa'])."', 
                  telefono1 = '".$data['des_telef']."', 
                  es_cliente = 0,
                  es_transportista = 0,
                  Empresa = 1
          ";
