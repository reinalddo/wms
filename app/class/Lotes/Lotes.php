...
/*
      ...
      ';
*/
      $sql = "SELECT DISTINCT cve_lote AS Lote FROM V_ExistenciaGralProduccion WHERE CONVERT(cve_almac, CHAR) = $id_almacen AND CONVERT(tipo, CHAR) = CONVERT('ubicacion', CHAR) AND CONVERT(IFNULL(cve_lote, ''), CHAR) != ''";
    ...
    function getAllLote_Alterno($id_almacen) {

      $sql = "SELECT DISTINCT Lote_Alterno AS Lote FROM V_ExistenciaGralProduccion WHERE CONVERT(cve_almac, CHAR) = $id_almacen AND CONVERT(tipo, CHAR) = CONVERT('ubicacion', CHAR) AND CONVERT(IFNULL(Lote_Alterno, ''), CHAR) != ''";
