      ...
      <div class="ibox ">
          ...
          <div class="ibox-content">
                  ...
                  <tbody id = "tbody">
                     ...
                     <div class="text-right">
                      <br>
                      <button type="button" class="btn btn-primary" id="btn-cambiar-status">
                        <span class="fa "></span> Cambiar a Pendiente por Auditar
                      </button>
                      <button type="button" class="btn btn-primary" id="btn-cambiar-auditado">
        ...
        <div class="modal-dialog vertical-align-center modal-lg" style="width: 1200px!important;">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4>Detalle de Pedido <span id="disponibles_ahora"></span></h4>
                        </div>
                          <div class="modal-body">
