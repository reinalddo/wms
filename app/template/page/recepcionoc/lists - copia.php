                                ...
                                <div class="col-lg-6 b-t">
                                    ...
                                    */
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control chosen-select" v-model="articulo.cve_articulo" v-on:change="set_articulo(articulo.cve_articulo)" v-if="tipo_entrada == 1" :searchable="true" :filterable="true" :clearable="true" id="articulos_lista">
                                        ...
                                        <div>
                                        <select class="form-control chosen-select" v-model="articulo.cve_articulo" v-on:change="set_articulo(articulo.cve_articulo)"  v-if="tipo_entrada == 2">
