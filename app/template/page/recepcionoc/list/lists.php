                                ...
                                <div class="col-lg-6 b-t">
                                    ...
                                    */
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select v-model="con.clave_contenedor" class="form-control" v-on:change="set_con(con.clave_contenedor);"<?php //con.clave_lp=''; ?>>
                                            <option value="" >Seleccione un Pallet/Contenedor</option>
                                            <option v-for="con in contenedores" :value="con.clave_contenedor">[{{con.Generico}}][{{con.clave_contenedor}}] - {{con.descripcion}}</option> 
                                        </select>
                                    </div>
            ...
            if(this.tipo_entrada != 2)
            {
                ...
                for (var j = 0; j < this.ordenes[this.numero_interno_orden].articulos.length; j++) 
                {
                    ...
                    if(this.ordenes[this.numero_interno_orden].articulos[j].cve_articulo == array_val[0] && this.ordenes[this.numero_interno_orden].articulos[j].val_lp == array_val_lp[1])
                    {
                        ...
                        this.articulo.unidad_medida = this.ordenes[this.numero_interno_orden].articulos[j].cve_unidad_medida;
                        console.log("************************************************");
                        console.log("this.articulo.unidad_medida = ", this.articulo.unidad_medida);
                    }
...
*/
        ...
        recibir_un_articulo: function()
        {
            ...
            */
            ...
            if(generar_nuevo_lp == true) this.articulo.pallet = "LP00"+this.con.id+""+window.app.folio_recepcion+""+prefijo_lp_cerrar;
