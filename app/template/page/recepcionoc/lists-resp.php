                        ...
                        <div class="ibox-content">
                            ...
                            <div class="row">
                                <div class="col-lg-6 b-r b-b">
                                    ...
                                    <div class="form-group">
                                        <label>Almacén</label>
                                        <select class="form-control" v-model="almacen_principal" class="chosen-select form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" v-model="orden.id" v-on:change="set_orden(orden.id)" :disabled="tipo_entrada != 1">
                                        <option value="" >Selecione una OC</option>
                                        <option v-for="ord in ordenes" v-if="ord.status == 'C' && ord.Cve_Almac == almacen_principal" :value="ord.num_pedimento">[{{ord.num_pedimento}}] - {{ord.nombre_proveedor}}</option>
                                    </select>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-6 b-t">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" v-model="zona.cve_ubicacion" class="chosen-select form-control" v-on:change="set_zona(zona.cve_ubicacion)">
                                            <option value="" >Selecione una Zona de Recepcion</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" v-model="con.clave_contenedor" class="chosen-select form-control" v-on:change="set_con(con.clave_contenedor)">
                                            <option value="" >Selecione un Pallet/Contenedor</option>
                                            <option v-for="con in contenedores" :value="con.clave_contenedor">[{{con.clave_contenedor}}] - {{con.descripcion}}</option> 
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label>Articulo*</label>
                                        <select class="form-control" v-model="articulo.cve_articulo" v-on:change="set_articulo(articulo.cve_articulo)" v-if="tipo_entrada == 1" :searchable="true" :filterable="true" :clearable="true">
                                            <option value="" >Selecione un Artículo</option>
                                    ...
                                    <div class="form-group" id="cantidadRecibidaOC">
                                        ...
                                        <label v-else id="label-cant-max">Cantidad Recibida* MAX({{articulo.cantidad_pedida}})</label>
                                        <input v-on:keyup="calcular_costo()" v-model="articulo.cantidad_por_recibir" :disabled="(articulo.cve_articulo == '' || articulo.maneja_series == 1)" oninput="parseFloat($(this).val()).toFixed(2)"  type="number" step="0.01" placeholder="Cantidad Recibida" class="form-control" >
                                    </div>
                                ...
                                <div class="col-lg-6 b-t">
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <select class="form-control" class="chosen-select form-control" v-model="articulo.unidad_medida"  v-on:change="set_med(med.id_umed)">
...
window.app = new Vue({
    ...
    methods: 
    {
        ...
        recibir_un_articulo: function()
        {
            ...
            {
                swal("Error","Porfavor Selecione Un Articulo", "error");
                return;
            }
