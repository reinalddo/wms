...
$('#btn-layout').on('click', function(e) {
  ...
  //window.location.href = 'http://www.tinegocios.com/proyectos/wms/stock.xlsx';
  console.log("OK Layout");
  window.location.href = '/Layout/Layout_Stock.xlsx';
}); 
...
swal({
        title: "Aviso",
        text: "Este proceso actualizará las ubicaciones con estas nuevas cantidades",
        type: "warning",
