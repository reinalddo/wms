            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form id="myform" role="form">
                        <div class="row">
                            <div class="col-md-6 b-r">
                                <div class="form-group"><label>Nombre del Recurso *</label> <input id="nombreDeRecurso" name="nombreDeRecurso" type="text" placeholder="Recurso" class="form-control" maxlength="30" required="true"></div>
...
<div class="modal inmodal" id="modalEditarRecurso" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header" id="modaltitle">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            ...
            <form id="myform">
            <div class="modal-body">
                <label>Nombre del Recurso *</label> <input id="new_nombre_recurso" name="new_nombre_recurso" type="text" placeholder="Procedimiento" class="form-control" maxlength="30" required="true">
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success == true) {
                        ...
                        $('#new_nombre_recurso').val(data.nombreDeRecurso);
        ...
        l.click(function() {
            ...
            if ($("#hiddenAction").val() == "edit") {
                $.ajax({
                    ...
                    data: {
                        id: $("#new_hiddenID").val(),
                        nombreDeRecurso: $("#new_nombre_recurso").val(),
                        action: "edit"
                    },
                    beforeSend: function(x) {
                        if (x && x.overrideMimeType) {
