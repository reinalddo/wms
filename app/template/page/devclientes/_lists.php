                            ...
                            <div class="row">
                                <div class="col-lg-6 b-r b-b">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="chosen-list form-control" <?php /* ?>id="orden_de_compra"<?php */ ?> v-model="orden.id" v-on:change="set_orden(orden.id)" :disabled="tipo_entrada != 1">
