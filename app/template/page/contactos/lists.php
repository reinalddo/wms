    ...
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modaltitle">Agregar Contacto</h4>
            </div>
            <form id="myform">
                <div class="modal-body">

                    <label>Clave</label><input id="Clave" type="text" maxlength="20" placeholder="Clave" class="form-control" <?php /* ?>required="true"<?php */ ?>><br>
                    <label>Nombre</label><input id="Nombre" type="text" placeholder="Nombre" class="form-control" <?php /* ?>required="true"<?php */ ?>><br>
                    <label>Apellido</label><input id="Apellido" type="text" placeholder="Apellido" class="form-control" <?php /* ?>required="true"<?php */ ?>><br>
                    <label>Email</label><input id="Email" type="text" placeholder="Email" class="form-control" <?php /* ?>required="true"<?php */ ?>><br>
                    <label>Telefono 1</label><input id="Telefono1" type="text" placeholder="Telefono 1" class="form-control" <?php /* ?>required="true"<?php */ ?>><br>
                    <label>Telefono 2</label><input id="Telefono2" type="text" placeholder="Telefono 2" class="form-control" <?php /* ?>required="true"<?php */ ?>><br>
                    <label>Pais</label><input id="Pais" type="text" placeholder="Pais" class="form-control" <?php /* ?>required="true"<?php */ ?>><br>
                    <label>Estado</label><input id="Estado" type="text" placeholder="Estado" class="form-control" <?php /* ?>required="true"<?php */ ?>><br>
                    <label>Ciudad</label><input id="Ciudad" type="text" placeholder="Ciudad" class="form-control" <?php /* ?>required="true"<?php */ ?>><br>
                    <label>Direccion</label><input id="Direccion" type="text" placeholder="Direccion" class="form-control" <?php /* ?>required="true"<?php */ ?>><br>
        ...
        <div class="modal-dialog vertical-align-center modal-lg" style="width: 1200px!important;">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Recuperar Contactos</h4>
                </div>
                <div class="modal-body">
                    <div class="col-md-4">
                        <div class="input-group">
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            url:'/api/contactos/lista/index.php',
            datatype: "json",
            shrinkToFit: false,
            height:'auto',
            postData: {
            ...
            mtype: 'POST',
            colNames:["Acciones", 'ID', 'Clave','Nombre', 'Apellido', 'Email', 'Telefono 1', 'Telefono 2', 'Pais', 'Estado', 'Ciudad', 'Direccion'],
            colModel:[
                ...
                {name:'apellido',index:'apellido',width:150, editable:false, sortable:false},
                {name:'correo',index:'correo',width:250, editable:false, sortable:false},
                {name:'telefono1',index:'telefono1',width:100, editable:false, sortable:false},
                {name:'telefono2',index:'telefono2',width:100, editable:false, sortable:false},
                {name:'pais',index:'pais',width:100, editable:false, sortable:false},
                {name:'estado',index:'estado',width:100, editable:false, sortable:false},
                {name:'ciudad',index:'ciudad',width:100, editable:false, sortable:false},
                {name:'direccion',index:'direccion',width:350, editable:false, sortable:false},
            ],
        ...
        function imageFormat( cellvalue, options, rowObject ){
            ...
            html += '<a href="#" onclick="editar(\''+serie+'\')"><i class="fa fa-edit" alt="Editar" title="Editar"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';
            if($("#permiso_eliminar").val() == 1)
            html += '<a href="#" onclick="borrar(\''+serie+'\')"><i class="fa fa-eraser" alt="Borrar" title="Borrar"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            url:'/api/contactos/lista/index_i.php',
            datatype: "json",
            height: 250,
            postData: {
                criterio: $("#txtCriterio").val()
    ...
    function borrar(_codigo) {
        ...
        swal({
            title: "¿Está seguro que desea borrar este contacto?",
            text: "",
            type: "warning",
            ...
            $.ajax({
                ...
                url: '/api/contactos/update/index.php',
                success: function(data) {
    ...
    function agregar() {
        $("#CodeMessage").html("");
        $("#modaltitle").text("Agregar Contacto");
...
*/
        ...
        $.post('/api/contactos/update/index.php',
               {
            id: $("#id_contacto").val(),
            Clave : $("#Clave").val(),
            Nombre : $("#Nombre").val(),
    ...
    $("#Clave").keyup(function(e) {
        ...
        if (claveCodeRegexp.test(claveCode)) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success == false) {
                        ...
                        $("#CodeMessage").html(" Clave de Unidades Medida ya existe");
            ...
            $("#CodeMessage").html("Por favor, ingresar una Clave de  Unidades Medida válida");
            $("#btnSave").prop('disabled', true);
        }
    ...
    $('#btn-layout').on('click', function(e) {
        //console.log("Layout_Contactos", window.location.href, '/Layout/Layout_Contactos.xlsx');
