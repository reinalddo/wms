...
<div class="wrapper wrapper-content  animated fadeInRight">
    ...
    <h3>Clasificación de Art&iacute;culos</h3>
                ...
                <div class="ibox-title">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <a href="/api/v2/articulos/clasificaciones/exportar" target="_blank" class="btn btn-primary pull-right" style="margin-left:15px;"><span class="fa fa-upload"></span> Exportar</a>
                            ...
                            <button  class="btn btn-primary pull-right" type="button" id="inactivos"><i class="fa fa-search"></i>&nbsp;&nbsp;Clasificaciones inactivas</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog vertical-align-center">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Importar Clasificaciones</h4>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modaltitle">Agregar Clasificación de Artículos</h4>
            </div>
            <form id="myform">
                <div class="modal-body">
                    <label>Clave *</label>
                    ...
                    <select class="form-control" id="cve_gpoart" name="cve_gpoart" required="true">
                        <option value="">Grupo de Artículo</option>
                        <?php foreach( $listaGrupoArt->getAll($_SESSION['id_almacen']) AS $p ): ?>
...
$('#btn-import').on('click', function() {
    ...
    $.ajax({
        ...
        url: '/articulos/clasificaciones/importar',
        type: 'POST',
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            url:'/api/subgrupodearticulos/lista/index.php',
            datatype: "json",
            shrinkToFit: false,
            height:'auto',
            postData: {
            ...
            mtype: 'POST',
            colNames:["Acciones", "Clave","Grupo","Descripción", "id"],
            colModel:[
                //{name:'id',index:'id', width:60, sorttype:"int", editable: false},
                {name:'myac',index:'', width:100, sortable:false, resize:false, formatter:imageFormat},
                {name:'cve_sgpoart',index:'cve_sgpoart',width:180, editable:false, sortable:false},
                {name:'des_gpoart',index:'des_gpoart',width:290, editable:false, sortable:false, hidden: true},
                {name:'des_sgpoart',index:'des_sgpoart',width:760, editable:false, sortable:false},
                {name:'id',index:'id',width:760, editable:false, sortable:false, hidden: true},
            ],
            rowNum:30,
            rowList:[30,40,50],
...
?>
        ...
        $.post('/api/subgrupodearticulos/update/index.php',
               {
            almacen: <?php echo $_SESSION['id_almacen']; ?>,
            cve_sgpoart : $("#codigo").val(),
            cve_gpoart : $("#cve_gpoart").val(),
            //cve_gpoart : 0,
            des_sgpoart : $("#descripcion").val(),
...
<script>
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            url:'/api/subgrupodearticulos/lista/index_i.php',
            datatype: "json",
            shrinkToFit: false,
            height:'auto',
            postData: {
