    ...
    <div class="modal-dialog modal-lg" style="width: 1200px">
        <div class="modal-content">
            <div class="modal-body" style="text-align: center;">
                ...
                <br>
                <h3 class="modal-title">Listas Formas de Pago</h3>
                <br>
                <div class="jqGrid_wrapper" style="overflow: hidden;">
                  ...
                  <div class="form-group">
                    <div class="input-group-btn">
                      ...
                      Eliminar Lista(s) Formas de Pago</button>
                    </div>
                  </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header" id="modaltitle">
                ...
                <h4 class="modal-title">Agregar Formas de Pago</h4>
            </div>
            <form id="myform">
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            url:'/api/formasdepago/lista/index.php',
            datatype: "json",
            shrinkToFit: false,
			height:'auto',
            postData: {
    ...
    function viewPdf( url ) {
        ...
        function asignar()
        {
          ...
          //$("#array_listas_promociones").val(arr);
            ...
            swal({
                title: "¿Está seguro que desea eliminar las listas seleccionadas del Formas de Pago?",
                text: "Está a punto de borrar lista(s) del Formas de Pago y esta acción no se puede deshacer",
                type: "warning",
                ...
                function(){
                    $.ajax({
                        ...
                        url: '/api/formasdepago/update/index.php',
                        success: function(data) {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.success == true) {
                    swal(
                        '¡Alerta!',
                        'Formas de Pago esta siendo usado en este momento',
                        'warning'
                    );
                    ...
                    //ReloadGrid();
                        ...
                        swal({
                            title: "¿Está seguro que desea borrar la forma de Pago?",
                            text: "",
                            type: "warning",
                            showCancelButton: true,
                            confirmButtonColor: "#DD6B55",
    ...
    function loadDetalles(id) {
        ...
        $('#grid-table_listas').jqGrid('clearGridData')
            ...
            }, datatype: 'json', page : 1, mtype: 'GET', url:'/api/formasdepago/lista/index.php'})
            .trigger('reloadGrid',[{current:true}]);
    }

    function editar(_codigo) {
        console.log("id = ", _codigo);
        $("#modaltitle").html('<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-laptop modal-icon"></i><h4 class="modal-title">Editar Formas de Pago</h4>');
		 $("#CodeMessage").html("");
        $.ajax({
            type: "POST",
            dataType: "json",
    ...
    function agregar() {
        $("#modaltitle").html('<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-laptop modal-icon"></i><h4 class="modal-title">Agregar Formas de Pago</h4>');
        $modal0 = $("#myModal");
		 $("#CodeMessage").html("");
        $modal0.modal('show');
        l.ladda('stop');
    ...
    l.click(function() {
        ...
        if ($("#hiddenAction").val()=="add") {
                $.post('/api/formasdepago/update/index.php',
                {
                    codigo : $("#codigo").val(),
                    cve_almacen: $("#almacen").val(),
...
$(function($) {
        ...
        $(grid_selector).jqGrid({            
			url:'/api/formasdepago/lista/index_i.php',
            datatype: "json",
            shrinkToFit: false,
			height:'auto',
            postData: {
