        ...
        <div class="modal-content animated bounceInRight">
            ...
            <form id="myform">
                <div class="modal-body">
                    ...
                    <select class="form-control" id="grupo_cliente" name="grupo_cliente" required="true">
                        <option value="">Grupo de Cliente</option>
                        <?php foreach( $GrupoCliente->getAll() AS $p ): ?>
                        <option value="<?php echo $p->id; ?>"><?php echo "[".$p->cve_grupo."] - ".$p->des_grupo; ?></option>
                        <?php endforeach; ?>
                    </select><br>
                    <?php 
                    ?>
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            mtype: 'POST',
            colNames:["Acciones", "Grupo", "Clave",'Descripción'],
            colModel:[
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.success == true) {
                    ...
                    $("#grupo_cliente").val(data.id_grupo);
...
*/
        if ($("#Descripcion").val()=="" || $("#grupo_cliente").val()=="") {
