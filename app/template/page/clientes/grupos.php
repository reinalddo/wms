                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            */
                            ...
                            <button  class="btn btn-primary pull-right" type="button" id="inactivos"><i class="fa fa-search"></i>&nbsp;&nbsp;Grupo de Clientes inactivos</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog vertical-align-center modal-lg" style="width: 1200px!important;">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Recuperar Grupo de Clientes</h4>
                </div>
                <div class="modal-body">
                    <div class="col-lg-4">
                        <div class="input-group">
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            url:'/api/grupoclientes/lista/index.php',
            datatype: "json",
            shrinkToFit: false,
			height:'auto',
            postData: {
            ...
            colModel:[
                ...
                {name:'cve_grupo',index:'cve_grupo',width:198, editable:false, sortable:false},
                {name:'des_grupo',index:'des_grupo',width:735, editable:false, sortable:false},
    ...
    function borrar(_codigo) {
        $.ajax({
            ...
            url: '/api/grupoclientes/update/index.php',
            success: function(data) {
                if (data.success == true) {
                    swal(
                        '¡Alerta!',
                        'El grupo de clientes esta siendo usado en este momento',
                        'warning'
                    );
                    ...
                    //ReloadGrid();
                        ...
                        swal({
                            title: "¿Está seguro que desea borrar el grupo de clientes?",
                            text: "Está a punto de borrar un grupo de clientes y esta acción no se puede deshacer",
                            type: "warning",
    ...
    function editar(_codigo) {
        $("#modaltitle").html('<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-laptop modal-icon"></i><h4 class="modal-title">Editar Grupo de Clientes</h4>');
		 $("#CodeMessage").html("");
        $.ajax({
            type: "POST",
            dataType: "json",
    ...
    function agregar() {
        $("#modaltitle").html('<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-laptop modal-icon"></i><h4 class="modal-title">Agregar Grupo de Clientes</h4>');
        $modal0 = $("#myModal");
		 $("#CodeMessage").html("");
        $modal0.modal('show');
        l.ladda('stop');
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success == false) {
                        $.post('/api/grupoclientes/update/index.php',
                        {
                            codigo : $("#codigo").val(),
...
$(function($) {
        ...
        $(grid_selector).jqGrid({            
			url:'/api/grupoclientes/lista/index_i.php',
            datatype: "json",
            shrinkToFit: false,
			height:'auto',
            postData: {
            ...
            colModel:[
                ...
                {name:'cve_grupo',index:'cve_grupo',width:200, editable:false, sortable:false},
                {name:'des_grupo',index:'des_grupo',width:600, editable:false, sortable:false},
