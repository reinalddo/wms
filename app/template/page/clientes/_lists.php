                    ...
                    <div class="ibox-title">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <a href="/api/v2/clientes/exportar" target="_blank" class="btn btn-primary pull-right" style="margin-left:15px"><span class="fa fa-upload"></span> Exportar</a>
                                ...
                                <button class="btn btn-primary pull-right" style="margin-left:15px" type="button" id="inactivos"><i class="fa fa-search"></i>&nbsp;&nbsp;Clientes inactivos</button>
...
<!--                                 <div class="ibox-content"></br></br>
                                  <div class="form-group">
                                    <div class="input-group-btn">
                                      <button id="btn-asignar" onclick="asignar()" type="button" class="btn btn-m btn-primary">Asignar</button>
                                    </div>
                                  </div>
                                </div> -->
                                <?php 
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <br>
                                    <div class="checkbox" id="gps_cliente">
                                        <label style="padding: 0;">
    ...
    <script type="text/javascript">
        ...
        $(function($) {
            ...
            $(grid_selector).jqGrid({
                ...
                mtype: 'POST',
                colNames: ["Acciones"/*,'Asignar'*/,'Ruta', 'Clave Interna', 'Clave ERP', 'Clave WMS', 'Razón Social', 'Dirección', 'CP | CD', 'Colonia', 'Alcaldía | Municipio', 'Ciudad | Departamento', 'Latitud', 'Longitud', 'Almacen'],
                ...
                loadComplete: function(data){
                    ...
                    //$("#num_clientes_contado").text((parseFloat(data.records)-parseFloat(data.credito)));
                }//,almacenPrede()
            });
            ...
            function imageFormat2(cellvalue, options, rowObject) 
            {
                //return '<img src="'+cellvalue+'" />&nbsp;&nbsp;&nbsp;&nbsp;<img src="'+cellvalue+'" />';
                var serie = rowObject[3];
                var client = rowObject[7];
                var ruta = rowObject[5];
                //var html = '';
                if(ruta == "--")
                {
                  var html = '<input type="checkbox" aling="center" class="checkbox-asignator" id="'+serie+'" value="'+client+'"/>';
                }
                else
                {
                  var html = "";
            ...
            $.ajax(
              {
                ...
                success: function(data) {
                    ...
                    if (data.success == true) {
                        ...
                        if (data.ClienteTipo == 'TRASLADO') {
                            $("#cliente_tipo_traslado").iCheck('check');
                        }
            ...
            if (claveCodeRegexp.test(claveCode)) 
            {
              ...
              $.ajax({
                ...
                success: function(data) {
                  ...
                  {
                    $("#CodeMessage").html("La clave del cliente ya existe");
