                        ...
                        <div class="row" style="margin-top:15px">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="status" id="status" class="chosen-select form-control">
                                    ...
                                    <option value="O">Pedidos WS</option>
                ...
                <table id="dt-detalles" class="table" style="table-layout: auto;width: 100%;"> <!--lilo-->
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style="width: 150px !important; min-width: 150px !important;">Tienda Destino</th>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            <div class="input-group" style="margin: 7px;">
                                ...
                                */
                                ?>
                                <button class="btn btn-primary pull-right" id="btnImprimirRemision" onclick="imprimirRemision()" style="margin-right: 5px;"><i class="fa fa-print"></i>Imprimir Remisión</button>
                                <?php 
                                /*
                                ?>
...
<script>
    ...
    <script>
        ...
        function imageFormat(id, surtido, tieneola, tienda, sufijo, is_backorder) {
            //console.log("tienda", tienda);
            var html = '';
            html += '<a href="#" onclick="articulos(\'' + id + '\', \'' + sufijo + '\', \'' + is_backorder + '\')"><i class="fa fa-search" title="Ver Detalles"></i></a>&nbsp;';
                ...
                success: function(data) 
                {
                    ...
                    if (data.status == 200) {
                        ...
                        $.each(data.data, function(index, item){
                            ...
                            //{
                                row += '<tr>'+
                                    '<td align="center">'+imageFormat(item.orden, item.surtido, item.TieneOla, item.destinatario, item.sufijo, is_backorder)+'</td>'+
              ...
              window.detalle_pedido["articulos"].forEach(function (item,index){
                console.log("item detalle",item);
                  obj = {
                      ...
                      acciones: '<button  onclick="guardarSurtidoPorUbicacion('+index+')" type="button" class="btn btn-m btn-primary btn-block" id ="btn_surtir_'+item["clave"]+'" style="width:70px; display:'+((item["surtidas"]>0)?'block':'block')+'" >Surtir</button>'
                  };
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      function filtralo() 
      {
        ...
        $("#btn-asignar").click(function()
        {
            ...
            console.log("asignar() -> asignados_send = ", asignados_send);
            ...
            var claves_users = [];
                ...
                $.ajax({
                    ...
                    error: function(data) 
                    {
                        ...
                        console.log("asignar() -> data = ", data.sql);
                    }
...
//                  {
        ...
        function articulos(_codigo, sufijo, is_backorder) 
        {
          //EDG117
...
//btnImprimirRemision
          ...
          function articulos_detalles(_codigo, sufijo, is_backorder)
          {
            ...
            if(is_backorder) window.estado_del_pedido = 'A'; //si está en backorder, será listo por asignar 

            console.log("HERE3",window.estado_del_pedido);
                  ...
                  if(pedido_status_surtiendo == false)
                  {
                    ...
                    for(var i = 0; i < num_art; i++) 
                    {
                      ...
                      obj = {
                        ...
                        existencia_total: data.articulos[i].existencia,
                        back_order_asignar: (data.articulos[i].pedidas-data.articulos[i].existencia),
                      };
                      emptyItem = [obj];
    ...
    //                     return;
                        ...
                        obj = {
                          folio: data.articulos[i].folio,
                          subpedido1: data.articulos[i].folio+"-"+data.articulos[i].sufijo,
                          cliente: data.articulos[i].cliente,
                          clave: data.articulos[i].clave,
                          articulo: data.articulos[i].articulo,
                          volumen: data.articulos[i].volumen,
                  ...
                  if(is_backorder == 0 && pedido_status_surtiendo == false)
                  {
                    console.log("pedido_status_surtiendo == false");
                      if(data.articulos_surtidos.length > 0)
                      {
                        for (var i = 0; i < data.articulos_surtidos.length; i++) 
                        {
                            ...
                            if(parseFloat(data.articulos_surtidos[i].existencia) > parseFloat(data.articulos_surtidos[i].pedidas) || parseFloat(data.articulos_surtidos[i].existencia) == parseFloat(data.articulos_surtidos[i].pedidas))
                            {
                            ...
                            tabla2 = {
                              ...
                              subpedido2: data.articulos[i].folio+"-"+data.articulos[i].sufijo,
...
/////////////////////////////////////Aqui se contruye el Grid de articulos/////////////////////////////////////////
        $(function($) {
            ...
            $(grid_selector).jqGrid({
                ...
                height: 'auto',
                mtype: 'POST',
                colNames: ['Pedido', 'Subpedido', 'Cliente', 'Clave', 'Articulo', 'Orden de Surtido', 'BL', 'Lote', 'Caducidad', 'Serie', 'Solicitadas', 'Disponible', 'Back Order','Surtidas', 'Volumen (m3)', 'Peso', 'Secuencia', 'Ruta', 'Surtidor'],
                colModel: [
                    {name: 'folio',index: 'folio',width: 80,editable: false,sortable: false},
                    {name: 'subpedido1',index: 'subpedido1',width: 120,editable: false,sortable: false},
        ...
        $(function($) {
            ...
            $(grid_selector).jqGrid({
                ...
                height: 'auto',
                mtype: 'POST',
                colNames: ['Pedido', 'Subpedido', 'Cliente', 'Clave', 'Articulo', 'Solicitadas', 'Disponible', 'Back Order','Surtidas', 'Volumen (m3)', 'Peso', 'Orden de Surtido'],
                colModel: [
                    {name: 'folio',index: 'folio',width: 80,editable: false,sortable: false},
...
/////////////////////////////////////Aqui se contruye el Grid de articulos/////////////////////////////////////////
        $(function($) {
            ...
            $(grid_selector).jqGrid({
                ...
                height: 'auto',
                mtype: 'POST',
                colNames: ['Pedido', 'Cliente', 'Clave', 'Articulo', 'Cantidad Pedida', 'Disponible','BackOrder', 'Volumen (m3)', 'Peso'],
                colModel: [{
                        name: 'folio',
                        index: 'folio',
                        width: 80,
