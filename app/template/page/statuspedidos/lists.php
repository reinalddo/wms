...
$email->setFrom("aolivares@adventech-logistica.com", "AssitPro ADVL");
$email->setSubject("Prueba de Reporte SendGrid");
//$email->addTo("reinalddo@gmail.com", "Reinaldo Matheus");
$email->addTo("aolivares@adventech-logistica.com", "Alejandro Olivares");
...
<body>
<strong>Reporte de Existencias disponibles para el pedido S20230105</strong>
<br><br>
<a href="https://dev.assistpro-adl.com/api/koolreport/export/reportes/pedidos/reporte_existencias_pedido/?folio=S20230105&cve_cia=1&fecha_pedido=24-01-2023" style="color:white;font-weight:bold;border-radius:5px;background-color: green;padding: 15px;text-decoration: none;">Descargar Reporte</a>
<br><br>
</body>
</html>';
...
<input type="hidden" id="VALpedidosPTL" value="1">
<input type="hidden" id="VALpedidosCROSSD" value="0">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Hora Inicio</label>
                                        <input id="horai" type="time" class="form-control" step="1">
                                    </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="data_2">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input id="fechaf" type="text" class="form-control" value="<?php echo $fecha_actual; ?>">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Hora Fin</label>
                                        <input id="horaf" type="time" class="form-control" step="1">
                                </div>
                            </div>
...
?>
                            ...
                            <div class="col-md-3"><label>   </label>
                                <div class="input-group-btn">
                            <a href="#" id="generarExcelPTL" class="btn btn-primary pedidosPTL" style="margin: 10px;float: right;">
                                <span class="fa fa-file-excel-o"></span> Exportar Excel PTL
                            </a>
                            <a href="#" id="generarExcelCrossD" class="btn btn-primary pedidosCROSSD" style="margin: 10px;float: right; display: none;">
                                <span class="fa fa-file-excel-o"></span> Exportar Excel Cross Docking
                            </a>
                                </div>
                            </div>
                ...
                <div class="row pedidosPTL" style="margin-top:15px">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <input id="totalunidades" type="text" value="0" class="form-control" style="text-align: center" disabled><br>
                    </div>

                    <div class="col-md-1">&nbsp;</div>  

                    <div class="col-md-2" style="text-align: center;">
                        <label>Pasillo E</label>
                        <div class="row">
                            <div class="col-md-6">
                            <label>Total Facturas</label>
                            <input id="totalfacturasE" type="text" value="0" class="form-control" style="text-align: center" disabled><br>
                            </div>
                            <div class="col-md-6">
                            <label>Total Unidades</label>
                            <input id="totalunidadesE" type="text" value="0" class="form-control" style="text-align: center" disabled><br>
                            </div>
                        </div>
                    </div>

                    <div class="col-md-2" style="text-align: center;">
                        <label>Pasillo F</label>
                        <div class="row">
                            <div class="col-md-6">
                            <label>Total Facturas</label>
                            <input id="totalfacturasF" type="text" value="0" class="form-control" style="text-align: center" disabled><br>
                            </div>
                            <div class="col-md-6">
                            <label>Total Unidades</label>
                            <input id="totalunidadesF" type="text" value="0" class="form-control" style="text-align: center" disabled><br>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2" style="text-align: center;">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                            <label>Total Facturas</label>
                            <input id="totalfacturasComb" type="text" value="0" class="form-control" style="text-align: center" disabled><br>
                            </div>
                            <div class="col-md-6">
                            <label>Total Unidades</label>
                            <input id="totalunidadesComb" type="text" value="0" class="form-control" style="text-align: center" disabled><br>
                            </div>
                        </div>
                    </div>
                </div>

                <div class="row pedidosCROSSD" style="margin-top:15px; display: none;">
                    <div class="col-md-3">
                        <label>Total Facturas Madre</label>
                        <input id="totalFacturaMadre" type="text" value="0" class="form-control" style="text-align: center" disabled><br>
                    </div>
                    <div class="col-md-3">
                        <label>Total Facturas Hijas</label>
                        <input id="totalFacturaHija" type="text" value="0" class="form-control" style="text-align: center" disabled><br>
                    </div>
                    <div class="col-md-3">
                        <label>Total Unidades</label>
                        <input id="totalTotal_Unidades" type="text" value="0" class="form-control" style="text-align: center" disabled><br>
                    </div>
                    <div class="col-md-3">
                        <label>Total Cajas</label>
                        <input id="totalTotal_Cajas" type="text" value="0" class="form-control" style="text-align: center" disabled><br>
                    </div>
                </div>
    ...
    <div class="ibox-content">
        <div class="row">
            <div class="col-lg-2">
                <div class="checkbox" id="chb_asignar">
                    <label for="btn-pedidosPTL">
                      <input type="checkbox" name="pedidosPTL" id="btn-pedidosPTL" checked>Pedidos de PTL
                    </label>
                </div>
            </div>
            <div class="col-lg-2">
                <div class="checkbox"id="chb_planificar">
                    <label for="btn-pedidosCROSSD">
                        <input type="checkbox" name="pedidosCROSSD" id="btn-pedidosCROSSD">Pedidos de Coss Docking
                    </label>
                </div>
            </div>
        </div>
        <div class="jqGrid_wrapper">
            ...
            <div class="table-responsive">
                ...
                <th scope="col" style="width: 70px !important; min-width: 70px !important;">Acciones</th>
                <th class="pedidosPTL" scope="col" style="width: 100px !important; min-width: 100px !important;">Factura</th>
                <th class="pedidosPTL" scope="col" style="width: 100px !important; min-width: 100px !important;">Unidades x Pedido</th>
                <th class="pedidosPTL" scope="col" style="width: 100px !important; min-width: 100px !important;">Pasillo</th>
                <th class="pedidosPTL" scope="col" style="width: 100px !important; min-width: 100px !important;">Tipo de Pedido</th>

    <th class="pedidosCROSSD" scope="col" style="width: 100px !important; min-width: 100px !important;display: none;">Factura Madre</th>
    <th class="pedidosCROSSD" scope="col" style="width: 100px !important; min-width: 100px !important;display: none;">Factura Hija</th>
    <th class="pedidosCROSSD" scope="col" style="width: 100px !important; min-width: 100px !important;display: none;">Punto de Venta</th>
    <th class="pedidosCROSSD" scope="col" style="width: 100px !important; min-width: 100px !important;display: none;">Total Unidades</th>
    <th class="pedidosCROSSD" scope="col" style="width: 100px !important; min-width: 100px !important;display: none;">Total Cajas</th>
                            ...
                            <!--<th id="col-planificar" scope="col" style="width: 130px !important; min-width: 130px !important;">Planificar Ola | XD</th>-->
            ...
            <div class="modal-content animated bounceInRight">
                <div class="modal-content" style="width: 100%;">
                    <div class="modal-header">
                        ...
                        <button id="SurtirPedidoCompleto" type="button" class="btn btn-primary pull-right"> Surtir Todo El Pedido</button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
            ...
            <div class="modal-dialog vertical-align-center modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Nº de Orden</label>
                            <input type="text" name="txt-prioridad-actual-folio" id="txt-prioridad-actual-folio" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                        <button type="button" class="btn btn-primary" onclick="asignarPrioridad()">Cambiar</button>
                    </div>
                </div>
            </div>
        </div>
...
//imageFormat(item.orden,item.surtido, item.TieneOla, '', item.sufijo, is_backorder, '', item.cliente, item.asignado, item.folio_ws, item.status, item.status_pedido, item.fecha_pedido, item.es_ot, item.ruta_pedido)
        function imageFormat(id, surtido, tieneola, tienda, sufijo, is_backorder, cliente, surtidor, articulo_ot, folio_ws, status, status_pedido, fecha_pedido, es_ot, ruta_pedido, statusaurora, TipoOT, usuario_pedido) {
           ...
           var cve_cia = <?php echo $_SESSION['cve_cia']; ?>;
            ...
            html += '<a href="#" onclick="cambiarPrioridad(\'' + id + '\', \'' + sufijo + '\', \'' + surtido + '\')"><i class="fa fa-check" title="Cambiar Prioridad"></i></a>&nbsp;';
        ...
        function siguienteItem() {
            ...
            if(window.detalle_pedido["articulos"].length > 0){
              ...
              window.detalle_pedido["articulos"].forEach(function (item,index){
                ...
                if(item["surtidas"] == 0 && item.idy_ubica != '')
                {
                  ...
                  obj = {
                      ...
                      acciones: '<button  onclick="guardarSurtidoPorUbicacion('+index+', '+$('#surtido-item-' + index).val()+', \''+((item["LP"]==undefined)?(""):(item["LP"]))+'\', \''+((item["LPNtarima"]==undefined)?(""):(item["LPNtarima"]))+'\')" type="button" class="btn btn-m btn-primary btnShowHide btn-block '+((item["LP"]==undefined || item["LP"] == "")?(""):("TipoLP"))+' LP'+item["LPNtarima"]+'" id ="btn_surtir_'+index+'" style="width:85px; display:'+((!item["idy_ubica"])?'none':'block')+'">Surtir '+((item["LP"]==undefined || item["LP"] == "")?(""):("Todo"))+'</button>'
                  };
...
*/
          ...
          if(surtir_pedido)
          {
            ...
            if(lp != '') {actionSurtido = 'guardarSurtidoPorLP';$("#SurtirPedidoCompleto").hide();}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $("#generarExcelPTL").click(function(){
            ...
            $(this).attr("href", "/api/koolreport/excel/pedidos_PTL/export.php?almacen="+almacen+"&criterio="+criterio+"&clave_almacen="+clave_almacen+"&fechaInicio="+fechaInicio+"&fechaFin="+fechaFin+"");

        });

        $("#generarExcelCrossD").click(function(){
            ...
            $(this).attr("href", "/api/koolreport/excel/pedidos_CROSSD/export.php?almacen="+almacen+"&criterio="+criterio+"&clave_almacen="+clave_almacen+"&fechaInicio="+fechaInicio+"&fechaFin="+fechaFin+"");
      ...
      function filtralo() 
      {
        ...
        $.ajax({
          ...
          data: {
            ...
            modulo_status_pedido: 'S',
            tipo_ptl: $("#VALpedidosPTL").val(),
            tipo_crossd: $("#VALpedidosCROSSD").val(),
            //filtro: $("#filtro").val(),
...
*/
        ...
        }).done(function(data)
        {
          ...
          if (data.status == 200) 
          {
            ...
            {
              i++;
              if($("#VALpedidosPTL").val() == 1)
              {
                    row += '<tr>'+'<td align="center" style="width:70px">'+imageFormat(item.Factura, '', '', '', 0, 0, '', '', '', '', 'A', 'A', '', '', '', '','', '')+'</td>'+
                  '<td style="width:100px">'+item.Factura+'</td>'+
                  '<td align="center" style="width:100px">'+item.Total_Unidades+'</td>'+
                  '<td align="center" style="width:100px">'+item.Pasillo+'</td>'+
                  '<td align="center" style="width:100px">'+item.TipoPed+'</td>'+

                  '</tr>';
              }
              else if($("#VALpedidosCROSSD").val() == 1)
              {
                    row += '<tr>'+'<td align="center" style="width:70px">'+imageFormat(item.FacturaMadre, '', '', '', 0, 0, '', '', '', '', 'A', 'A', '', '', '', '','', '')+'</td>'+
                  '<td style="width:100px">'+item.FacturaMadre+'</td>'+
                  '<td align="center" style="width:100px">'+item.FacturaHija+'</td>'+
                  '<td align="center" style="width:100px">'+item.PuntoDeVenta+'</td>'+
                  '<td align="center" style="width:100px">'+item.Total_Unidades+'</td>'+
                  '<td align="center" style="width:100px">'+item.Total_Cajas+'</td>'+
                  '</tr>';
              }
        ...
        $("#btn-pedidosPTL").click(function()
        {
            if($(this).is(":checked"))
            {
                $("#btn-pedidosCROSSD").prop("checked", false);
                $(".pedidosCROSSD").hide();
                $(".pedidosPTL").show();
                $("#VALpedidosPTL").val(1);
                $("#VALpedidosCROSSD").val(0);
                filtralo();
            }
        });

        $("#btn-pedidosCROSSD").click(function()
        {
            if($(this).is(":checked"))
            {
                $("#VALpedidosPTL").val(0);
                $("#VALpedidosCROSSD").val(1);
                $(".pedidosCROSSD").show();
                $(".pedidosPTL").hide();
                $("#btn-pedidosPTL").prop("checked", false);
                filtralo();
            }
        });
        ...
        $(".check-asignar").click(function(id_pedido, idpedido = $(this).data("idpedido"), subpedido = $(this).data("subpedido"), id = $(this).data("id")){
          ...
          //$("#volumentotal").val(data.volumentotal);
            ...
            $("#totalpedidos").val(data.totalpedidos);
            $("#totalunidades").val(data.totalunidades);
            $("#totalfacturasE").val(data.totalfacturasE);
            $("#totalunidadesE").val(data.totalunidadesE);
            $("#totalfacturasF").val(data.totalfacturasF);
            $("#totalunidadesF").val(data.totalunidadesF);
              if($("#VALpedidosPTL").val() == 1)
              {
                    $("#totalpedidos").val(data.totalpedidos);
                    $("#totalunidades").val(data.totalunidades);
                    ...
                    $("#totalfacturasF").val(data.totalfacturasF);
                    $("#totalunidadesF").val(data.totalunidadesF);
                    $("#totalfacturasComb").val(data.totalfacturasComb);
                    $("#totalunidadesComb").val(data.totalunidadesComb);
              ...
              {
                    $("#totalFacturaMadre").val(data.totalFacturaMadre);
                    $("#totalFacturaHija").val(data.totalFacturaHija);
                    $("#totalTotal_Unidades").val(data.totalTotal_Unidades);
                    $("#totalTotal_Cajas").val(data.totalTotal_Cajas);
              }
                    ...
                    success: function(data) 
                    {
                        ...
                        if (data.success == true) 
                        {
                            ...
                            else
                            {
                                 swal({
                                      title: "Error",
                                      text: "Revise Stock o Ruta de Surtido",//"BL o Usuario no Asignado a Ruta de Surtido",
                                      type: "error"
                                  });
                            }
                        }
        ...
        function VerificarTiposPedidosPlanificar(tipo)
        {
          ...
          $.each( $('.column-planificar'), function (index, item) {
            ...
            if((sufijos_en_cero == sufijos_mayor_a_cero || sufijos_mayor_a_cero_diferente_sufijo == true))
            {
                 swal({
                      title: "Error",
        ...
        function planificar(tipo, tipopedido) {
          var grid = $('#dt-detalles'),
              folios = [],
              pedidosId = [],
              rowId = grid.jqGrid("getDataIDs"),
...
//                  {
        ...
        function articulos(_codigo, sufijo, is_backorder, cliente, surtidor, articulo_ot, folio_ws, ruta_pedido, status_pedido, statusaurora, TipoOT, usuario_pedido)
        {
          //EDG117
            $("#folio_detalle").html("");
...
//btnImprimirRemision
          ...
          window.estado_del_pedido = "";
              ...
              if (status_pedido == 'L' || status_pedido == 'R' || status_pedido == 'P' || status_pedido == 'M' || status_pedido == 'C' || status_pedido == 'E' || status_pedido == 'T' || status_pedido == 'F') 
              {
...
*/
                      ...
                      var surtidor_actual = data.articulos[0].surtidor;
                        var pedido_surtido = "";
                        var lp_actual = data.articulos[0].LP;
                        var lp_orden = 1;
...
//**********************************************************************************************************************
                        ...
                        obj = {
                          ...
                          volumen: data.articulos[i].volumen,
                          peso: data.articulos[i].peso,
                          solicitadas: (solicitadas_cant*a_piezas), //data.articulos[i].pedidas,
                          unidad_medida: data.articulos[i].unidad_medida,
                          ...
                          surtir: '<input id="surtido-item-' + i + '" value="'+existencia_cant+'" type="number" style="width:70px;text-align:right;"  />',
...
/////////////////////////////////////Aqui se contruye el Grid de articulos/////////////////////////////////////////
        $(function($) {
            ...
            $(grid_selector).jqGrid({
                ...
                height: 'auto',
                mtype: 'POST',
                colNames: ['License Plate', 'Pedido', 'Cliente', 'Clave', 'Articulo', 'Lote', 'Caducidad | Elaboración', 'Serie', 'Pallet', 'Cajas', 'Piezas', 'Cantidad Pedida', 'Unidad Medida','Disponible','BackOrder', 'Volumen (m3)', 'Peso'],
                colModel: [{
                        name: 'LP',
                        index: 'LP',
                        width: 150,
...
*/
    ...
    function cambiarPrioridad(_folio, sufijo, surtido) {
...
*/
            ...
            $("#txt-prioridad-actual-folio").val(_folio);
    }
    ...
    $("#status, #tipopedido, #ruta_pedido_list, #ciudad_pedido_list").change(function(){
...

        {
           ...
           $("#btn-planificar, .column-planificar input, .column-dividir input").hide();
        }
        else
        {
            console.log("Entro show");
           $("#btn-planificar, .column-planificar input, .column-dividir input").show();
        }
...
*/
    ...
    function asignarPrioridad() 
    {
        ...
        var folio = $("#txt-prioridad-actual-folio").val();
            console.log("folio = ", folio, " prioridad = ", $('#select-prioridad').val());
        ...
        $.ajax({
            ...
            data: {
                ...
                action: 'cambiarPriodidad'
            }, success: function(data)
            {
              console.log("Cambiando Prioridad...", data);

                    console.log("filtralo 7");
                    filtralo();
                    $("#modal-prioridad").modal('hide');
                    swal("Éxito", "Prioridad de la orden cambiada exitosamente", "success");
                //window.location.reload();
