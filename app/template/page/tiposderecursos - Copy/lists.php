            ...
            <div class="ibox ">
                <div class="ibox-title">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="/api/v2/articulos/exportar" target="_blank" class="btn btn-primary pull-right" style="margin-left:15px; ; margin-top: 22px">
            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form id="myform" role="form">
                        <div class="row">
                            <div class="col-md-6 b-r">
                                <div class="form-group"><label>Nombre del Recurso *</label> <input id="nombreDeRecurso" name="nombreDeRecurso" type="text" placeholder="Presupuesto" class="form-control" maxlength="30" required="true"></div>
...
<!-- Wrapper de editar presupuesto-->
<div class="wrapper wrapper-content  animated fadeInRight" id="presupuestoEditar" style="display: none">
    <div class="row">
        <div class="col-md-12">
            <div class="ibox ">
                <div class="ibox-title">
                ...
                <div class="ibox-content">
                    <form id="myform" role="form">
                        <div class="row">
                            <div class="col-md-6 b-r">
                                <div class="form-group"><label>Nombre del Presupuesto *</label> <input id="new_nombre_presupuesto" name="new_nombre_presupuesto" type="text" placeholder="Presupuesto" class="form-control" maxlength="30" required="true"></div>
                                <div class="form-group"><label>Año del Presupuesto *</label> <input id="new_ano_presupuesto" name="new_ano_presupuesto" type="text" placeholder="Año" class="form-control" maxlength="30" required="true"><label id="CodeMessage" style="color:red;"></label></div>
                                <div class="form-group"><label>Clave de Partida *</label> <input id="new_cve_partida" name="new_cve_partida" type="text" placeholder="Partida" class="form-control" maxlength="30" required="true"><label id="CodeMessage2" style="color:red;"></label></div>
                            </div>
                            <div class="col-md-6 b-r">
                                <div class="form-group"><label>Concepto de Partida *</label> <input id="new_concepto_partida" name="new_concepto_partida" type="text" placeholder="Concepto" class="form-control" maxlength="30" required="true"><label id="CodeMessage3" style="color:red;"></label></div>
                                <div class="form-group"><label>Monto *</label> <input id="new_monto_presupuesto" name="new_monto_presupuesto" type="text" placeholder="Monto" class="form-control" maxlength="30" required="true"><label id="CodeMessage4" style="color:red;"></div>
                                <div class="pull-right" style="clear: both;">
                                    <a href="#" onclick="cancelar()"><button type="button" class="btn btn-white" id="btnCancel">Cerrar</button></a>&nbsp;&nbsp;
                                    <button type="submit" class="btn btn-primary ladda-button" data-style="contract" id="btnSave">Guardar</button>
                                </div>
...
$('#btn-layout').on('click', function(e) {
  ...
  window.location.href = 'http://www.tinegocios.com/proyectos/wms/articulo.xlsx';
}); 
...
<script type="text/javascript">
        ...
        $(function($) {
            ...
            $(grid_selector).jqGrid({
                url: '/api/tiposderecursos/lista/index.php',
                datatype: "json",
                shrinkToFit: true,
                height: 'auto',
                mtype: 'POST',
                ...
                colModel: [
                    {
                        ...
                        name: 'nombreDeRecurso',
                        index: 'nombreDeRecurso',
                        width: 200,
                        editable: false,
                        sortable: false,
                        resizable: false
        ...
        function borrar(_codigo) {
            $.ajax({
                ...
                url: '/api/tiposderecursos/update/index.php',
                success: function(data)
                {
                    if (data.success == true)
                    {
        ...
        function editar(_codigo) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    console.log(data);
                    if (data.success == true) {
                        $("#modaltitle").html('<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-laptop modal-icon"></i><h4 class="modal-title">Editar</h4>');
                        $modal0 = $("#presupuestoEditar");
                        $modal0.wrapper('show');
                        ...
                        if (data.control_lotes == "1")
                            $("#control_lotes").prop("checked", "checked");
                        if (data.control_numero_series == "1")
                            $("#control_numero_series").prop("checked", "checked");
                        if (data.control_peso == "1")
                            $("#control_peso").prop("checked", "checked");
                        if (data.control_volumen == "1")
                            $("#control_volumen").prop("checked", "checked");
                        if (data.req_refrigeracion == "1")
                            $("#req_refrigeracion").prop("checked", "checked");
                        if (data.compuesto == "1")
                            $("#compuesto").prop("checked", "checked");
                        if (data.mat_peligroso == "on")
                            $("#mat_peligroso").prop("checked", "checked");
         ...
         rules: {
            ...
            if ($("#hiddenAction").val() == "add") {
                $.ajax({
                    ...
                    dataType: "json",
                    data: {
                        nombreDeRecurso: $("#nombreDeRecurso").val(),
                        action: "add"
                    },
                    beforeSend: function(x) {
                        if (x && x.overrideMimeType) {
        ...
        function grupo() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    //               options.empty();
                    //         options.append(new Option("Clasificación de Artículo", ""));
                    //       for (var i=0; i<data.clasificaciones.length; i++)
                    //{
                    //    options.append(new Option(data.clasificaciones[i].des, data.clasificaciones[i].clave));
                    //}
        ...
        function clasificacion() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    //           var options = $("#tipo_b");
                    //        options.empty();
                    //         options.append(new Option("Tipo de Artículo", ""));
                    //        for (var i=0; i<data.tipos.length; i++)
                    //{
                    //    options.append(new Option(data.tipos[i].tipo, data.tipos[i].clave));
                    //}
                    // $('.chosen-select').trigger("chosen:updated");   
                    }
                }
