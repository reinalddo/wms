    ...
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header" id="modaltitle">
                ...
                <h4 class="modal-title">Agregar Motivo No Venta</h4>
            </div>
            ...
            <form id="myform">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Clave *</label>
                        <input id="ClaveMotivo" type="text" placeholder="Clave del Motivo No Venta" required="true" class="form-control">
                        <!--<label id="CodeMessage" style="color:red;"></label>-->
                    </div>
                    <div class="form-group">
                        <label>Descripción *</label>
                        <input id="MOT_DESC" type="text" placeholder="Motivo No Venta" class="form-control" required="true"><br>
        ...
        <div class="modal-dialog vertical-align-center modal-lg" style="width: 1200px!important;">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Recuperar Motivo No Venta</h4>
                </div>
                <div class="modal-body">
                    <div class="col-md-4">
                        <div class="input-group">
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            url: '/api/motivosnoventas/lista/index.php',
            datatype: "json",
            shrinkToFit: false,
            height: 'auto',
            postData: {
            ...
            mtype: 'POST',
            colNames: ["Acciones", 'ID', 'Clave', 'Descripci&oacute;n'],
            colModel: [
    ...
    function borrar(_codigo) {
        $.ajax({
            ...
            url: '/api/motivosnoventas/update/index.php',
            success: function(data) {
                if (data.success == true) {
                    swal(
                        '¡Alerta!',
                        'El Motivo No Venta esta siendo usado en este momento',
                        'warning'
                    );
                } else {
                    swal({
                            title: "¿Está seguro que desea borrar el Motivo No Venta?",
                            text: "Está a punto de borrar un Motivo No Venta y esta acción no se puede deshacer",
                            type: "warning",
    ...
    function editar(_codigo) {
        ...
        $("#modaltitle").html('<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-laptop modal-icon"></i><h4 class="modal-title">Editar Motivo No Venta</h4>');
    ...
    function agregar() {
        ...
        $("#ClaveMotivo").val("");
        $("#CodeMessage").html("");
        $("#modaltitle").html('<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-laptop modal-icon"></i><h4 class="modal-title">Agregar Motivo No Venta</h4>');
    }
    ...
    l.click(function() {
        ...
        $.post('/api/motivosnoventas/update/index.php', {
                    MOT_ID: $("#hiddenMOT_ID").val(),
                    MOT_DESC: $("#MOT_DESC").val(),
                    Clave_motivo: $("#ClaveMotivo").val(),
                    id_almacen: <?php echo $_SESSION['id_almacen']; ?>,
    ...
    $("#ClaveMotivo").keyup(function(e) {
        ...
        if (claveCodeRegexp.test(claveCode)) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success == false) {
                        ...
                        $("#CodeMessage").html(" Clave de Motivo No Venta ya existe");
            ...
            $("#CodeMessage").html("Por favor, ingresar una Clave de Motivo No Venta  válida");
            $("#btnSave").prop('disabled', true);
        }
    });
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            url: '/api/motivosnoventas/lista/index_i.php',
            datatype: "json",
            shrinkToFit: false,
            height: 'auto',
            postData: {
