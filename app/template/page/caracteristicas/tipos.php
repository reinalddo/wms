    ...
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header" id="modaltitle">
                ...
                <h4 class="modal-title">Agregar tipo de característica</h4>
            </div>
            ...
            <form id="myform">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Clave</label>
                        <input id="clave_caracteristica" type="text" required="true" class="form-control" readonly>
                        <!--<label id="CodeMessage" style="color:red;"></label>-->
                    </div>
                    <div class="form-group">
                        <label>Descripción *</label>
                        <input id="descripcion_caracteristica" type="text" placeholder="Descripción del Tipo Característica" class="form-control" required="true"><br>
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            mtype: 'POST',
            colNames: ["Acciones", 'Clave', 'Descripci&oacute;n'],
            colModel: [
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.success == true) {
                    ...
                    $('#clave_caracteristica').val(data.max_id);
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.success == true) {
                    swal(
                        '¡Alerta!',
                        'El tipo de característica esta siendo usado en este momento',
                        'warning'
                    );
                } else {
                    swal({
                            title: "¿Está seguro que desea borrar el tipo de característica?",
                            text: "Está a punto de borrar un tipo de característica y esta acción no se puede deshacer",
                            type: "warning",
    ...
    function editar(_codigo) {
        $("#modaltitle").html('<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-laptop modal-icon"></i><h4 class="modal-title">Editar Tipo de Característica</h4>');
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.success == true) {
                    ...
                    $("#clave_caracteristica").val(data.Id_Tipo_car);
    ...
    function agregar() {
        ...
        $("#ClaveMotivo").val("");
        $("#CodeMessage").html("");
        $("#modaltitle").html('<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-laptop modal-icon"></i><h4 class="modal-title">Agregar Tipo de Característica</h4>');
