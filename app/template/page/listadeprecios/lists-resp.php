                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group col-md-4"><label>Numero de Orden (ERP)</label> 
                                    <input id="NumOrden" type="text" placeholder="Numero de Orden" class="form-control" maxlength="10">
                                </div>
                                <div class="form-group col-md-4"><label>Consecutivo</label> 
                                    <input disabled id="Consecut" type="text" placeholder="Consecutivo"  class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group col-md-4">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group date" id="data_5">
                                        <input id="fechaestimada" type="text" class="form-control" >
...
<div class="modal fade" id="ver_detalles" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="width: 1200px">
        <div class="modal-content">
            <div class="modal-body" style="text-align: center;">
                <h3 class="modal-title">Artículos de la orden de compra</h3>
                <div class="jqGrid_wrapper">
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            mtype: 'POST',
            colNames:["Acciones",'Clave','Folio','Almacen','Proveedor','Protocolo','Cons. Protocolo','Fecha Solicitud','Fecha Requerida','Status2','Status','Usuario','cve_usuario','Tipo de Recurso','Tipo de Procedimiento','Dictamen','Presupuesto','Condiciones de Pago','Lugar de Entrega','Fecha De Fallo','Plazo de Entrega','No. de Expediente','Importe de la Orden',"Area Solicitante","Numero de Suficiencia","Fecha de Suficiencia","Fecha de Contrato","Monto de Suficiencia","Numero de Contrato"],/*'Calle y Numero','Colonia','Ciudad','Estado','Pais','Codigo Postal','RFC','Telefono1','Telefono2'*/
            colModel:[
                //{name:'id',index:'id', width:60, sorttype:"int", editable: false},
                {name:'myac',index:'', width:80, fixed:true, sortable:false, resize:false, formatter:imageFormat},
                {name:'ID_Aduana',index:'ID_Aduana',width:110, editable:false, hidden:true, sortable:false},
                {name:'num_pedimento',index:'num_pedimento',width:50, editable:false, sortable:false},
                ...
                {name:'fech_pedimento',index:'fech_pedimento',width:140, editable:false, sortable:false},
                {name:'fech_llegPed',index:'fech_llegPed',width:140, editable:false, sortable:false},
                ...
                {name:'fechaDeFallo',index:'fechaDeFallo',width:140, editable:false, sortable:false, hidden:false},
                {name:'plazoDeEntrega',index:'plazoDeEntrega',width:140, editable:false, sortable:false, hidden:false},
                {name:'numeroDeExpediente',index:'numeroDeExpediente',width:150, editable:false, sortable:false, hidden:false},
                {name:'importe',index:'importe',width:150, editable:false, sortable:false, hidden:false},
              {name:'areaSolicitante',index:'areaSolicitante',width:150, editable:false, sortable:false, hidden:false},
              {name:'numSuficiencia',index:'numSuficiencia',width:150, editable:false, sortable:false, hidden:false},
              {name:'fechaSuficiencia',index:'fechaSuficiencia',width:150, editable:false, sortable:false, hidden:false},
              {name:'fechaContrato',index:'fechaContrato',width:150, editable:false, sortable:false, hidden:false},
              {name:'montoSuficiencia',index:'montoSuficiencia',width:150, editable:false, sortable:false, hidden:false},
              {name:'numeroContrato',index:'numeroContrato',width:150, editable:false, sortable:false, hidden:false},
        ...
        function imageFormat( cellvalue, options, rowObject ){
            ...
            var html = '<a href="#" onclick="ver(\''+serie+'\')"><i class="fa fa-search" title="Ver Detalles"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';
            if (status === "C"){
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            colModel:[
                ...
                {name:'CantPiezas',index:'CantPiezas',width:150, sortable:false},
                {name:'peso',index:'peso',width:150, editable:false, sortable:false},
                {name:'pesohidden',index:'pesohidden',width:100, editable:false, hidden:true, sortable:false},
                {name:'volumen',index:'volumen',width:200, editable:false, hidden:false, sortable:false},
                {name:'precioUnitario',index:'precioUnitario',width:150, editable:false, hidden:false, sortable:false},
                {name:'importeTotal',index:'importeTotal',width:150, editable:false, hidden:false, sortable:false},
        ...
        $("#addrow").click( function() {
            ...
            option = $("#basic").val();
            volumen = parseInt($("#ancho").val()) * parseInt($("#alto").val()) * parseInt($("#fondo").val()) / 1000000000  * parseInt($("#CantPiezas").val());
...
*/
        ...
        $.ajax({
            ...
            success: function(data) {
              if (data.success == true) 
              {
                  if($("#hiddenAction").val() === "add") {swal('Excelente','Orden Creada con exito.','success');}
                  else {swal('Excelente','Orden Modificada con exito.','success');}
                  location.reload();
              } 
              else 
              {
    ...
    importeTotal.value = (inputPU.value*$("#CantPiezas").val());
    }
    ...
    $(function($) {
        ...
        $(grid_selector_detalles).jqGrid({
            ...
            height:'auto',
            mtype: 'GET',
            colNames:['Clave','Descripción', 'Peso', 'Volumen','Precio Unitario', 'Importe Total', 'Lote', 'Caducidad', 'Serie', 'Pedidas', 'Surtidas'],
            colModel:[
                {name:'clave',index:'clave',width: 300, editable:false, sortable:false},
                {name:'descripcion',index:'descripcion',width:300, editable:false, sortable:false},
                {name:'peso',index:'peso',width:300, editable:false, sortable:false},
                {name:'volumen',index:'volumen',width:300, editable:false, sortable:false},
                {name:'precioU',index:'precioU',width:200, editable:false, sortable:false},
                {name:'importeTotal',index:'importeTotal',width:200, editable:false, sortable:false},
                {name:'lote',index:'lote',width:300, editable:false, sortable:false},
                {name:'caducidad',index:'caducidad',width:300, editable:false, sortable:false},
                {name:'serie',index:'serie',width:300, editable:false, sortable:false},
                {name:'pedidas',index:'pedidas',width:300, editable:false, sortable:false},
                {name:'surtidas',index:'surtidas',width:300, editable:false, sortable:false}
            ],
            rowNum:10,
            rowList:[10,20,30],
