...
*/
    ...
    <div class="wrapper wrapper-content  animated fadeInRight" id="DetalleInventario">
        ...
        <div class="col-md-12 animated fadeInRight text-right">
            ...
            <button type="button" class="btn btn-primary ladda-button" data-style="contract" id="btnSave">Planificar</button>
        </div>
    ...
    $(grid_selector).jqGrid({
        ...
        height: 300,
        mtype: 'POST',
        colNames: ['Acciones', 'BL', 'Clave', 'Descripción', 'LP', 'Lote|Serie', 'Caducidad', 'Stock Teórico', '% Stock', 'Zona Almacenaje', 'Ubicación' ],
        colModel: [
        {name: 'acciones', index: 'acciones', width: 70, editable: false, sortable: false, resizable: false, formatter:imageFormat, align:"center" }, 
        {name: 'bl',index: 'bl',width: 120,editable: false,sortable: false,resizable: false}, 
        {name: 'cve_articulo',index: 'cve_articulo',width: 120,editable: false,sortable: false,resizable: false}, 
        {name: 'des_articulo',index: 'des_articulo',width: 300,editable: false,sortable: false,resizable: false}, 
        {name: 'lp',index: 'lp',width: 120,editable: false,sortable: false,align : 'right',resizable: false}, 
        {name: 'lote_serie',index: 'lote_serie',width: 120,editable: false,sortable: false,align : 'right',resizable: false}, 
        {name: 'caducidad',index: 'caducidad',width: 120,editable: false,sortable: false,align : 'right',resizable: false}, 
        {name: 'existencia',index: 'existencia',width: 120,editable: false,sortable: false,align : 'right',resizable: false}, 
        {name: 'abc',index: 'abc',width: 160,align : 'right',editable: false,sortable: false,resizable: false}, 
        {name: 'zona_almacenaje',index: 'zona_almacenaje',width: 180,editable: false,hidden:false,sortable: false,resizable: false},
        {name: 'cve_ubicacion',index: 'cve_ubicacion',width: 180,editable: false,hidden:true,sortable: false,resizable: false}
            ],
        ...
        $(function($) {
            ...
            $('#grid-general').jqGrid({
                ...
                subGridRowExpanded: function(subgrid_id, row_id) {
                    ...
                    console.log("subgrid_table_id = ", subgrid_table_id, "articulo = ", articulo, "almacen = ", almacen);
