...
?>
    ...
    <div class="modal fade" id="modal-articulos" role="dialog">
        <div class="vertical-alignment-helper">
            <div class="modal-dialog vertical-align-center modal-md">
                <!-- Modal content-->
                <div class="modal-content art-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                        <button type="button" class="btn btn-primary" onclick="agregarArti()">Seleccionar</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="wrapper wrapper-content  animated fadeInRight" id="DetalleInventario">
                ...
                <div class="tabs-container">
                    ...
                    <div class="tabs-left">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#tab-1" aria-expanded="true">Un Solo Día</a></li>
                            <li class=""><a data-toggle="tab" href="#tab-2" aria-expanded="false">Diario</a></li>
                            <li class=""><a data-toggle="tab" href="#tab-3" aria-expanded="false">Semanal</a></li>
                            <li class=""><a data-toggle="tab" href="#tab-4" aria-expanded="false">Mensual</a></li>
                        </ul>
        ...
        <div class="col-md-12 animated fadeInRight text-right">
            ...
            <button type="button" class="btn btn-primary ladda-button" data-style="contract" id="btnSave">Aceptar</button>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(function($) {
            ...
            $(grid_selector).jqGrid({
                ...
                height: 300,
                mtype: 'POST',
                colNames: ['Clave', 'Descripción', 'Existencia', '% de la existencia', 'Ubicación'],
                colModel: [{
                    name: 'cve_articulo',
                    index: 'cve_articulo',
                    width: 120,
            ...
            $('#grid-general').jqGrid({
                ...
                subGridRowExpanded: function(subgrid_id, row_id) {
                    ...
                    jQuery("#" + subgrid_table_id).jqGrid({
                        ...
                        colNames: ['id', 'Ubicación', 'cve_articulo', 'Lote', 'Serie', 'Cantidad'],
                        colModel: [{
                            name: "cve_ubicacion",
                            index: "cve_ubicacion",
                            width: 200,
        ...
        l.click(function() {
            ...
            /*$("#toU").each(function() {
                ...
                $(this).find('li').each(function(){
                    user_clone.push( $(this).attr('value') );
                });
            });*/
                    ...
                    if(ss>1){
                        $(this).find('td').each(function(i) {
                            ...
                            if(ggg==1){
                                ...
                                user_clone.push($(this).text());

                            }

                            if(ggg==4){

                                user_clones.push($(this).text());
            ...
            switch (MODE) {
                case "Un Solo Día":
                    for (i = 0; i < user_clone.length; i++) {
                        ...
                        var _user_clones = user_clones[i];
                        arrInv.push({
                            id_plan: '0',
                            fecha: $("#FechaUnSoloDia").val(),
                            articulo: _user_clone,
                            MODE: MODE,
                            ubicacion: _user_clones
                        });
                    }
                    break;
                case "Diario":
    ...
    <style type="text/css">
        ...
        #detalle_wrapper #gview_grid-general,
        ...
        #gview_grid-general>div>.ui-jqgrid-hbox {
        ...
        #grid-general_subgrid {
            width: 5% !important;
            text-align: center;
        }
        
        #grid-general_cve_articulo {
            width: 25% !important;
        }
        
        #grid-general_des_articulo {
            width: 25% !important;
        }
        ...
        #grid-general_acciones {
            width: 20% !important;
        }
        
        #grid-general>tbody>tr>td:nth-child(1) {
            width: 5% !important;
            text-align: center;
        }
        
        #grid-general>tbody>tr>td:nth-child(2) {
            width: 25% !important;
            text-align: center;
        }
        
        #grid-general>tbody>tr>td:nth-child(3) {
            width: 25% !important;
            text-align: center;
        }
        
        #grid-general>tbody>tr>td:nth-child(4) {
            width: 25% !important;
            text-align: center;
        }

        
        #grid-general_jqg1_t_cve_ubicacion {
            display: none;
        }

        
        td[aria-describedby="grid-general_jqg1_t_cve_ubicacion"] {
            display: none;
        }
        
        td[aria-describedby="grid-general_cve_ubicacion"] {
            display: none;
        }
        
        td[aria-describedby="grid-general_jqg1_t_cb"] {
            width: 8% !important;
        }
        
        #grid-general_jqg1_t_cb {
            width: 8% !important;
        }
        
        td[aria-describedby="grid-general_jqg1_t_ubicacion"] {
            width: 23% !important;
        }
        
        #grid-general_jqg1_t_ubicacion {
            width: 23% !important;
        }
        ...
        td[aria-describedby="grid-general_jqg1_t_lote"] {
            width: 23% !important;
        }
        
        #grid-general_jqg1_t_lote {
            width: 23% !important;
        }
        
        td[aria-describedby="grid-general_jqg1_t_serie"] {
            width: 23% !important;
        }
        
        #grid-general_jqg1_t_serie {
            width: 23% !important;
        }
        ...
        td[aria-describedby="grid-general_jqg1_t_suma"] {
            width: 23% !important;
        }
        
        #grid-general_jqg1_t_suma {
            width: 23% !important;
        }

        
        td[aria-describedby="grid-general_jqg1_t_cve_articulo"] {
            display: none;
        }

        
        #grid-general_cve_ubicacion {
            display: none;
        }
        
        #grid-general_jqg1_t_cve_articulo {
            display: none;
        }
