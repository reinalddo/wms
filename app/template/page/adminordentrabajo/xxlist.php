...
$sql = "SELECT a.cve_articulo, a.des_articulo, IFNULL(a.control_lotes, 'N') AS control_lotes, IFNULL(a.Caduca, 'N') AS Caduca, 
        ...
        FROM c_articulo a
        LEFT JOIN c_unimed um ON um.id_umed = a.unidadMedida";//WHERE Compuesto != 'S'
...
while( $a = mysqli_fetch_object($res_art)) {
                                ...
                                <div class="col-lg-3" id="registrar_merma_derivado" style="display: none;">
                                    ...
                                    <div id="sobrante">
                                        ...
                                        <div>
                                            ...
                                            <label for="merma" style="cursor: pointer;"><input type="radio" name="derivado_merma" id="merma" value="merma">&nbsp;&nbsp;Merma</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <br><br>
                                        <label><b>Producto Derivado <span id="peso_derivado"></span></b></label>
                                        ...
                                        <div class="row" id="lote_caducidad_base">
                                            <div class="col-md-6" id="lote_derivado" style="display:none;">
                                                <label>Lote</label>
                                                <input type="text" class="form-control" name="lote_compuesto_derivado" id="lote_compuesto_derivado" placeholder="Lote OT">
                                            </div>
                                            <div class="col-md-6" id="caducidad_derivado" style="display:none;">
                                                <label>Caducidad</label>
                                                <div class="input-group date" id="data_3_derivado">
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input id="caducidad_compuesto_derivado" type="text" class="form-control">
                                                </div>
                                            </div>
                                        </div>
        ...
        function imageFormat( cellvalue, options, rowObject ){
            ...
            if(statusOT == 'T' || statusOT == 'I'){
                ...
                if(palletizado > 0 && traslado <= 1 && (area_produccion == 'S' || area_produccion == '0')) 
                {
                    ...
                    if(status_nombre != 'Envio a Almac&eacute;n' && statusOT == 'T' && $("#permiso_editar").val() == 1)
...
*/
    ...
    $(function($) {
        ...
        $(grid_selector3).jqGrid({
            ...
            viewrecords: true,
            sortorder: "desc",
            loadComplete: function(data){console.log("SUCCESS grid-table3: ", data);},
...
*/
    ...
    function asignar(id, status)
    {
      ...
      $.ajax({
        ...
        $("#faltante").text(($("#compuesto_cantidad").text() -  data.compuesto.Cant_Prod));
...
*/
    ...
    function pasarArticuloCompuesto()
    {
        ...
        if(parseFloat($("#cantidad_art_compuesto").val()) > parseFloat($("#faltante").text()))
        {
            swal('Error', 'La Cantidad a Producir es Mayor a la Cantidad Faltante', 'error');
        }
        else if(parseFloat($("#faltante").text()) == 0)
        {
              ...
              $.ajax({
                ...
                method: 'POST'
                    ...
                    else
                    {
                        ...
                        $("#producida").text(data);
                        $("#faltante").text(($("#compuesto_cantidad").text() -  data));
                       $("#imprimir_etiqueta_btn").show();
...
//*************************************************************************************************
                          if(primera_produccion == 0 && $("#lote_compuesto").val() != '')
                          {
                                ...
                                console.log("++++++++++++++++++++++++++++++++++");
                                if($("#caducidad_compuesto").val() != '' && $("#art_caduca").val() == 'S') 
                                {
    ...
    $("#derivado, #merma, #pbase").change(function(e){
...
//text_max_derivado
    ...
    {
        if($("#cantidad_sobrante").val() == '' && ($("input[name=derivado_merma]:checked").val() == 'derivado' || $("input[name=derivado_merma]:checked").val() == 'pbase'))
        {
...
//caducidad_compuesto_derivado
        ...
        var control_peso_comp_base = $("#componentes_derivado_base").find(':selected').data('granel');
...
*/
    $("#TerminarProduccion").click(function(){
        ...
        if($("#status_terminar_produccion").val() == 'T')
        {
                ...
                if (e == true) {
                    ...
                    $("#pasarArticuloCompuesto").prop("disabled", true);
                      ...
                      }).done(function(data)
                      {
                            ...
                            console.log("SQLs lote_cad = ", data);
...
//******************************************************************************************************
    ...
    $("#cambiar_lote").click(function(){
        ...
        swal({
            ...
            function(e) {
                if (e == true) {
                    Cambiar_Lote_OT($("#lote_usado").val(), 1);
                } 
                else 
    ...
    $("#CancelarSobrante").click(function()
    {
        $("#sobrante").hide(500);
    });
