...
//$GrupoServicio = \db()->prepare("SELECT * FROM c_gposervicios WHERE Cve_GpoServicio = 'G02'");
$GrupoServicio = \db()->prepare("SELECT * FROM c_gposervicios");
$GrupoServicio->execute();
$gs = $GrupoServicio->fetchAll(PDO::FETCH_ASSOC);
        ...
        <div class="modal-content animated bounceInRight">
            ...
            <form id="myform">
                <div class="modal-body">
                    ...
                    <?php /* ?><input id="gruposerv_text" type="text" class="form-control" value="<?php echo $grupo; ?>" readonly="readonly"><?php */ ?>
                    <select class="chosen-select form-control" id="gruposerv_text" required="true">
                        <option value="">Seleccione un Grupo</option>
                        <?php foreach( $gs AS $g ): ?>
                            <option value="<?php echo $g['Id_GpoServicio']; ?>"><?php echo "(".$g['Cve_GpoServicio'].") ".$g['Des_GpoServicio']; ?></option>
                        <?php endforeach; ?>
                    </select>
                    <br>
                    <label>IVA</label><input id="iva" type="text" placeholder="IVA" class="form-control"><br>
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            mtype: 'POST',
            colNames:["Acciones", 'ID', 'Clave','Descripción', 'Unidad Medida', 'Grupo', 'IVA'],
            colModel:[
                ...
                {name:'iva',index:'iva',width:100, editable:false, sortable:false},
            ],
    ...
    l.click(function() {
        ...
        if ($("#Clave").val()=="" || $("#descripcion").val()=="" || $("#unimedida_list").val()=="" || $("#gruposerv_text").val() == "") {
            swal("Aún Hay Campos Vacíos", "Por favor llene todos los datos", "error");
            return;
        }
        console.log("id:", $("#id_servicio").val());
        console.log("Clave:", $("#Clave").val());
        console.log("descripcion:", $("#descripcion").val());
        console.log("iva:", $("#iva").val());
        console.log("unimedida:", $("#unimedida_list").val());
        console.log("gpo_id:", $("#gruposerv_text").val());
