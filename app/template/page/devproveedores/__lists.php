                                ...
                                <div class="col-lg-12 text-center">
                                    <div class="form-group">
                                        <label class="col-md-4" for="checkboxes-0">
                                            <input type="radio" v-model="tipo_entrada" v-bind:value="1">
                                            <label>Orden de Compra</label>
                                        </label>
                                        <label class="col-md-4" for="checkboxes-1" >
                                            <input type="radio" v-model="tipo_entrada" v-bind:value="2" v-on:click="traer_articulos();">
...
?>
                                        <div>
                                            <select class="form-control" v-model="proveedor.id" v-if="tipo_entrada == 1" v-on:change="set_proveedores(proveedor.id)" id="proveedor_select" > <?php /* ?>:disabled="tipo_entrada == 1"<?php */ ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input  type="text"  placeholder="Folio de Devolución" class="form-control" v-model="folio_recepcion" disabled>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group col-md-8">
                                        <label>Indique Orden de Compra o Factura</label>
                                        <select class="chosen-list form-control" v-model="orden.id" v-on:change="set_orden(orden.id)"> 
                                        <option value="" >Seleccione una OC</option>
                                        <option v-for="ord in ordenes" v-if="ord.status == 'T' && ord.Cve_Almac == almacen_principal" :value="ord.num_pedimento">[{{ord.num_pedimento}}] / [{{ord.factura}}]- {{ord.nombre_proveedor}}</option>
                                        </select>
                                    </div>
                                    ...
                                    /*
                                    ?>
                                    <div class="form-group col-md-4 factura_list">
                                        <label>Factura / Remisión</label> 
                                        <?php /* ?><input id="facprove" type="text" placeholder="Factura" class="form-control" ><?php */ /* ?>

                                            <select class="chosen-list form-control" v-model="facturas.factura" v-on:change="set_facturas(facturas.factura)" > <?php /* ?>:disabled="tipo_entrada == 1"<?php */ /* ?>
                                                <?php  ?><option value="0">Seleccione Factura</option><?php  ?>
                                                <option v-for="factura in facturas" :value="factura.factura">
                                                [{{factura.factura}}] - {{factura.Nombre}}</option>
                                            </select>
                            ...
                            <div class="row">
                                <div class="col-lg-6 b-t">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <select v-model="zona.cve_ubicacion" class="form-control" v-on:change="set_zona(zona.cve_ubicacion)">
                                    ...
                                    */
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" v-model="articulo.cve_articulo" v-on:change="set_articulo(articulo.cve_articulo)" v-if="tipo_entrada == 1" :searchable="true" :filterable="true" :clearable="true" id="articulos_lista">
                                            ...
                                            <option v-for="articulo in articulos" :value="articulo.cve_articulo"> [{{articulo.cve_articulo}}] - {{articulo.des_articulo}}</option>
                                        </select>
                                        <div>
                                        <select class="form-control" v-model="articulo.cve_articulo" v-on:change="set_articulo(articulo.cve_articulo)"  v-if="tipo_entrada == 2">
                                            <option value="" >Seleccione un artículo</option>
                                            <option v-for="articulo in articulos_todos" :value="articulo.cve_articulo">
                                            [{{articulo.cve_articulo}}] - {{articulo.des_articulo}}</option>
                                        </select>
                                        </div>
                                    </div>
                                    <div class="form-group" id="cantidadRecibidaOC">
                                        ...
                                        /*
                                        ?>
                                        <label id="label-cant-max">Cantidad Devuelta* MAX(<span id="cant_recOC"></span>)</label>
                                        <input onkeyup="calcular_costo()" type="number" step="0.01" placeholder="Cantidad Devuelta" class="form-control" >
                                        <?php 
                                        */
                                        ?>
                                        <label v-if="articulo.cantidad_pedida ==''" id="label-cant-max">Cantidad Devuelta* {{articulo.cantidad_pedida}}</label>
                                        <label v-else id="label-cant-max">Cantidad a Recibir* MAX({{articulo.cantidad_pedida}})</label>
                                        <input id="a_recibir" v-on:keyup="calcular_costo()" v-model="articulo.cantidad_por_recibir" :disabled="(articulo.cve_articulo == '' || articulo.maneja_series == 1)" oninput="parseFloat($(this).val()).toFixed(2)"  type="number" step="0.01" placeholder="Cantidad Devuelta" class="form-control" >
                                        <?php 
                                ...
                                <div class="col-lg-6 b-t">
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <option v-for="med in medidas" :value="med.id_umed">{{med.des_umed}}</option>
                                    </select>
                                    </div>
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <center>
                                                <div id="recibir_articulo">
                                                    <button type="button" class="btn btn-success t-10" v-on:click="traer_hora_actual()">Registrar Devolución</button>
                                                </div>
                                            </center>
                                        </div>
                                        <?php 
                                    ...
                                    <table class="table table-bordered ">
                                        <thead>
                                            <tr>
                                                ...
                                                <td><label>Devueltas (Pz)</label></td>
...
/*
    ...
    {
        console.log("OK proveedor_select = ", $(this).val());
    });
*/
...
//         $("#almacenoc").val(data.Cve_Almac);
    ...
    function changeColorTable()
    {
        ...
        document.getElementById('label-table-1').innerHTML = "Productos devueltos. ( TOTAL RECIBIDOS "+totalRe+" )";
...
window.app = new Vue({
    ...
    methods: 
    {
        ...
        traer_ordenes: function(id_prov)
        {
            $.ajax({
                type: "POST",
                dataType: "json",
                url: '/api/devproveedores/update/index.php',
                data: {
                    action: 'traer_ordenesRealizadas',
                    id_prov: id_prov
                },
                beforeSend: function(x) {if (x && x.overrideMimeType) {x.overrideMimeType("application/json;charset=UTF-8");}
                },
                success: function(data) 
                {
                    if (data.success == true) 
                    {
                        console.log("ok traer_ordenesRealizadas",data);
        ...
        traer_proveedores: function(almacen)
        {
            console.log("PROVEEDORES this.almacen_principal = ",almacen);
            $.ajax({
                type: "POST",
                dataType: "json",
                url: '/api/devproveedores/update/index.php',
                ...
                success: function(data) 
                {
                    if (data.success == true) 
                    {
                        console.log("ok traer_proveedores",data);
                        window.app.proveedores = data.proveedores;
                        $(".factura_list .chosen-list").val($(".factura_list .chosen-list option:first").val());
                    }
                },
                error: function(data) 
                {
...
/*
        traer_facturas: function(num_orden)
        {
            $.ajax({
                type: "POST",
                dataType: "json",
                ...
                success: function(data) 
                {
                    if (data.success == true) 
                    {
                        console.log("ok facturas",data.facturas);
                        window.app.facturas = data.facturas;
                    }
                },
                error: function(data) 
                {
...
*/
        traer_articulos: function(id_prov, id_orden)
        {
            ...
            //if(!id_fact) id_fact = "";
            console.log("**********************************");
            console.log("Artículos Proveedor ->", id_prov);
            console.log("Artículos Orden ->", id_orden);
            //console.log("Artículos Factura ->", id_fact);
            console.log("**********************************");
            $.ajax({
                type: "POST",
                dataType: "json",
                ...
                success: function(data) 
                {
                    if (data.success == true) 
                    {
                        console.log("data.todos_los_articulos =", data.todos_los_articulos);
                        window.app.articulos_todos = data.todos_los_articulos;
                        window.app.articulos = data.todos_los_articulos;
        ...
        set_orden(id)
        {
            console.log("set_orden = ", id);
            console.log("proveedor.id = ", this.proveedor.id);
            if(this.tipo_entrada == 1)
            { 
                this.orden.id = id;
                ...
                //}
                //this.colores_tabla();
                //this.traer_facturas(id);
                this.traer_articulos(this.proveedor.id, id);
            }
        },
        ...
        set_proveedores(id)
        {
            ...
            console.log("OK proveedor_select = ", id);
            this.traer_articulos(id, "");
            this.traer_ordenes(id);
            //this.traer_facturas(0);
            //this.set_facturas(0);
...
/*
        set_facturas(id)
        {
            console.log("set_facturas = ", id);
            for (var i = 0; i < this.facturas.length; i++) 
            {
                if(this.facturas[i].factura == id)
                {
                    //this.facturas.factura = this.facturas[i].factura;
                    this.facturas.factura = this.facturas[i].factura;
                }
            }
            this.traer_articulos(this.proveedor.id, this.orden.id, id);
        },
*/
        set_zona(id)
        {
            ...
            $.ajax({
                ...
                success: function(data) 
                {
                    if (data.success == true) 
                    {
                        ...
                        window.app.traer_proveedores(data.codigo.clave);
                    }
                },
                error: function(data) 
                {
      ...
      traer_folio_Dev_Proveedores: function()
      {
          $.ajax({
              type: "POST",
              dataType: "json",
              url: '/api/devproveedores/update/index.php',
              data: {
                  action: 'traer_folio_Dev_Proveedores',
              },
              beforeSend: function(x) {if (x && x.overrideMimeType) {x.overrideMimeType("application/json;charset=UTF-8");}
              },
              success: function(data) 
  ...
  beforeMount()
  {
      ...
      this.traer_ordenes();
      this.traer_folio_Dev_Proveedores();
