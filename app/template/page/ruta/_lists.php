...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            mtype: 'POST',
            colNames:['','Clave de la Ruta','Descripción de la Ruta','Status','Descripción de la Compañia',"Acciones"],
            colModel:[
                //{name:'id',index:'id', width:60, sorttype:"int", editable: false},
                {name:'ID_Ruta',index:'ID_Ruta',width:0, editable:false, sortable:false, hidden: true},
                {name:'cve_ruta',index:'cve_ruta',width:10, editable:false, sortable:false, align:"center"},
                {name:'descripcion',index:'descripcion',width:40, editable:false, sortable:false},
                {name:'status',index:'status',width:5, editable:false, sortable:false, align:"center"},
    ...
    function editar(_codigo) {
        ...
        $("#modaltitle").html('<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-laptop modal-icon"></i><h4 class="modal-title">Editar Ruta</h4>');
        $.ajax({
            type: "POST",
            dataType: "json",
            data: {
