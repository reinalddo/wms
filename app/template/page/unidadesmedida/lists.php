    ...
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modaltitle">Agregar Unidades de Medida</h4>
            </div>
            <form id="myform">
                <div class="modal-body">

                    <label>Clave *</label><input id="cve_umed" type="text" maxlength="20" placeholder="Clave de Unidades de Medida" class="form-control" required="true"><!--<label id="CodeMessage" style="color:red;"></label>--><br>
                    <label>Descripción *</label><input id="Des_umed" type="text" placeholder="Descripcion" class="form-control" required="true"><br>
                ...
                <div class="ibox-title">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <button  class="btn btn-primary pull-right" type="button" id="inactivos"><i class="fa fa-search"></i>&nbsp;&nbsp;Unidades de medida inactivas</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog vertical-align-center modal-lg" style="width: 1200px!important;">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Recuperar Unidades de Medida</h4>
                </div>
                <div class="modal-body">
                    <div class="col-md-4">
                        <div class="input-group">
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            url:'/api/unidadesmedida/lista/index.php',
            datatype: "json",
            shrinkToFit: false,
            height:'auto',
            postData: {
            ...
            colModel:[
                ...
                {name:'cve_umed',index:'cve_umed',width:200, editable:false, sortable:false},
                {name:'des_umed',index:'des_umed',width:733, editable:false, sortable:false},
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            url:'/api/unidadesmedida/lista/index_i.php',
            datatype: "json",
            height: 250,
            postData: {
                criterio: $("#txtCriterio").val()
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.success == true) {
                    swal(
                        '¡Alerta!',
                        'La Unidad de medida esta siendo usada en este momento',
                        'warning'
                    );
                }
                else {
                    swal({
                        ...
                        text: "Está a punto de borrar una unidad de medida y esta acción no se puede deshacer",
                        type: "warning",
    ...
    function editar(_codigo) {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.success == true) {
                    //$('#codigo').prop('disabled', true);
                    $("#Des_umed").val(data.des_umed);
                    $("#cve_umed").val(data.cve_umed);
                    l.ladda('stop');
                    $("#btnCancel").show();
                    $modal0 = $("#myModal");
                    $modal0.modal('show');
    ...
    l.click(function() {
        ...
        $.post('/api/unidadesmedida/update/index.php',
               {
            cve_umed : $("#cve_umed").val(),
            des_umed : $("#Des_umed").val(),
