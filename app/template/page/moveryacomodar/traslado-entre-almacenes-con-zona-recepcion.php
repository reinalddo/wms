...
?>
                                ...
                                <div class="col-md-6" style="text-align: center;">
                                    <div class="checkbox">
                                        ...
                                        <label for="fusionar_traslado" style="font-weight: 600;font-size: 14px; -moz-user-select: none; -webkit-user-select: none;-ms-user-select: none; user-select: none; margin-top: 28px;">
                                        <input type="checkbox" name="fusionar_traslado" id="fusionar_traslado" checked value="1" style="margin-right: 5px;">Fusionar</label>
                                    </div>
                                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding:10px 50px;">
                ...
                <div class="form-group" id="fusion_pallet" style="display: none;">
                    ...
                    <select class="form-control" id="select_pallets_fusionar"></select>
...
$("#palletizar_traslado").prop("checked", false);
    ...
    $("#palletizar_traslado").click(function()
    {
...
*/
    ...
    { //PR2
        ...
        console.log("pallet palletizar:", $("#select-pallets").val());
