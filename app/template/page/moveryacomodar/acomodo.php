...
<input type="hidden" id="peso_acum" value="0">
<input type="hidden" id="volumen_acum" value="0">


<input type="hidden" id="clasif_actual" value="">
<input type="hidden" id="permitir_volumen" value="1">
<input type="hidden" id="permitir_peso" value="1">
<input type="hidden" id="peso_capacidad" value="0">
<input type="hidden" id="volumen_capacidad" value="0">
<input type="hidden" id="ubicacion_piso" value="0">
<input type="hidden" id="borrar_selects" value="1">
<input type="hidden" id="cve_ubicacion_usada" value="">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-lg-12 b-b">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group" id="valor_total_pendiente_pa" style="text-align: center;">
                                       <label>Productos Pendientes de Acomodo | Cantidad</label>
                            ...
                            <div class="form-group" style="text-align: center;">
                                <div class="checkbox">
                                    <label for="enviar_folios_entrada" style="font-weight: 600;font-size: 14px; -moz-user-select: none; -webkit-user-select: none;-ms-user-select: none; user-select: none;">
                                    <input type="checkbox" name="enviar_folios_entrada" id="enviar_folios_entrada" value="0">Enviar Folio de Entrada Completo</label>
                                </div>

                            </div>

                                <div class="col-md-3">
                                <label for="filtro_buscador">Buscar: <input type="text" class="form-control" id="filtro_buscador" name="filtro_buscador"></label>
                                </div>

                                <div class="col-md-3">
                                <label for="filtro_lp">LP: <select class="form-control chosen-select" id="filtro_lp" name="filtro_lp">
                                    <option value="">Todos</option>
                                </select></label>
                                </div>

                                <div class="col-md-3">
                                <label for="filtro_clave">Clave: <select class="form-control chosen-select" id="filtro_clave" name="filtro_clave">
                                    <option value="">Todos</option>
                                </select></label>
                                </div>

                                <div class="col-md-3">
                                <label for="filtro_lote_serie">Lote | Serie: <select class="form-control chosen-select" id="filtro_lote_serie" name="filtro_lote_serie">
                                    <option value="">Todos</option>
                                </select></label>
                                </div>
                                <div class="ibox-content">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row" id="mensaje_control_abc" style="display: none;">
                                    <div class="col-lg-4"></div>
                                    <div class="col-lg-4 btn-primary" style="padding: 10px;border-radius: 5px;margin: 10px;">
                                        La Zona de Almacenaje y la Ubicación se calculan automáticamente al seleccionar un artículo con Clasificación ABC
                                    </div>
                                    <div class="col-lg-4"></div>
                                    </div>
                                <div class="col-md-6">
                                    <div class="form-group" id="zonaalmacenajeff">
                                        <label>Zona de Almacenaje*</label>
                                        <select class="form-control" id="zonaalmacenajef" disabled>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Ubicación*</label><?php //chosen-select ?>
                        ...
                        <div class="row">
                            <div class="col-lg-6 b-t">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="palleti"/>
                                    <input type="hidden" id="lpi"/>
                                ...
                                <div class="form-group"><label id="label-pesoA">Peso a trasladar Kg</label><input id="input-pesoA" disabled type="text" class="form-control"></div>
                                <div class="form-group"><label id="label-volumenA">Volumen a trasladar m3</label><input id="input-volumenA" disabled type="text" class="form-control"></div>
                            </div>
                            <div class="col-lg-6 b-t">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="umedidai">
                                        ...
                                        <!--<option value="3">Pallet/Contenedor</option>-->
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-3">
                                        <label id="label-pesoU">Peso Final</label>
                                        <input id="porcentaje_p_ocupado" disabled type="text" class="form-control">
                                    </div>
                                    <div class="col-lg-9">
                                        <label id="label-pesoU">Peso Máximo | Peso Ocupado BL</label>
                                        <input id="input-pesoU" disabled type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-3">
                                        <label id="label-pesoU">Volumen Final</label>
                                        <input id="porcentaje_v_ocupado" disabled type="text" class="form-control">
                                    </div>
                                    <div class="col-lg-9">
                                        <label id="label-volimenU">Volumen Máximo | Volumen Ocupado BL</label>
                                        <input id="input-volumenU" disabled type="text" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <center><a href="#" class="permiso_registrar" id="addrow"><button type="button" class="btn btn-primary" id="btnCancel">Mover a Zona Destino </button></a>&nbsp;&nbsp;</center>
                            </div>
                            <div class="col-lg-12">
                                <label></label>
                                <div class="ibox-content">
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({ //12
            ...
            shrinkToFit: false,
            mtype: 'POST',
            colNames:['Seleccionar','idy_ubica','Folio Entrada','Tipo', 'Clasif. ABC', 'Proyecto','Pallet|Contenedor', 'License Plate (LP)','Clave', 'Descripcion','Lote','Caducidad','Serie','Cantidad Recibida','Peso Total','Volumen Total','Proveedor','id_proveedor','id_articulo','Almacen','Zona de Almacenaje', 'Peso Unitario', 'Volumen Unitario', 'Control Peso'],
            colModel:[
                ...
                {name:'control_abc',index:'control_abc',width:100,editable:false, sortable:false, hidden: false, align: 'center'},
                {name:'proyecto',index:'proyecto',width:100,editable:false, sortable:false, hidden: false, align: 'center'},
                {name:'pallet_contenedor',index:'pallet_contenedor',hidden:false, width:150,editable:false, sortable:false},
                {name:'LP',index:'LP',hidden:false, width:150,editable:false, sortable:false},
                ...
                {name:'caducidad',index:'caducidad', editable:false,width:100, sortable:false, align: 'center'},
                {name:'serie',index:'serie', editable:false,width:80, sortable:false},
                {name:'num_existencia',index:'num_existencia',width:130, editable:false, sortable:false, align: 'right'},
                {name:'peso_total',index:'peso_total', editable:false, width:120, sortable:false, align: 'right'},
                {name:'volumen_ocupado',index:'volumen_ocupado',width:120, editable:false, sortable:false, align: 'right'},
                ...
                {name:'peso_u',index:'peso_u',editable:false,width:150, sortable:false, hidden: false},
                {name:'volumen_u',index:'volumen_u',editable:false,width:150, sortable:false, hidden: false},
                {name:'control_peso',index:'control_peso',editable:false,width:150, sortable:false, hidden: true},
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            colModel:[
                ...
                {name:'caducidad',index:'caducidad', editable:false,width:150, sortable:false, align: 'center'},
...
var tipo_ubicaciones_action_send = "", descripcion_pca_send = "";
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            shrinkToFit: false,
            mtype: 'POST',
            colNames:['Seleccionar','idy_ubica','Ubicacion', 'Tipo', 'Pallet|Contenedor', 'License Plate (LP)','Clave Articulo','id_articulo','Articulo','Lote','Caducidad','Serie','Volumen Ocupado','Existencia','Peso','Proveedor','id_proveedor','Almacen',' Zona de Almacenaje'],/*'Calle y Numero','Colonia','Ciudad','Estado','Pais','Codigo Postal','RFC','Telefono1','Telefono2'*/
            colModel:[
                {name:'myac',index:'', width:80, fixed:true, sortable:false, resize:false, formatter:imageFormat, frozen : true},
                {name:'idy_ubica',index:'idy_ubica',editable:false,width:150, sortable:false, hidden: true},
                {name:'ubicacion',index:'ubicacion',width:250,editable:false, sortable:false, hidden: false},
                {name:'tipo',index:'tipo',width:250,editable:false, sortable:false, hidden: false},
    ...
    function UbicacionesAcomodoTraslado(almacen, action_val, tipo_ubicaciones_action_send)
    {
        ...
        console.log("*****************UbicacionesAcomodoTraslado***********************");
        console.log("cve_articuloi = "+$("#cve_articuloi").val());
        console.log("palleti = "+$("#palleti").val());
        console.log("lpi = "+$("#lpi").val());
    ...
    $('#zonaalmacenajef').change(function(e) {
        ...
        var action_val = "ubicacionNoLlenas-acomodo";
...
//            action_val = "ubicacionesVacias";
    ...
    $('#zonarecepcioni').change(function(e) {
        ...
        console.log("cve_ubicacion_hidden = ", $("#cve_ubicacion_usada").val());
        console.log("cve_ubicacion_change = ", $(this).val());


        $("#grid-tabla").jqGrid('clearGridData');
        console.log("tipo = ", document.getElementById("checkAcomodo").checked ? 'ubicacion' : 'area');
        var almacen= $(this).val();
        ...
        $.ajax({
            ...
            data: {
                ...
                filtro_buscador: $("#filtro_buscador").val(),
                filtro_lp: $("#filtro_lp").val(),
                filtro_clave: $("#filtro_clave").val(),
                filtro_lote_serie: $("#filtro_lote_serie").val(),
            ...
            success: function(data) 
            {
                ...
                var arr_lp = [], arr_clave = [], arr_lote_serie = [];
                if($("#borrar_selects").val() == '1')
                {
                    $("#filtro_lp").empty();
                    $("#filtro_clave").empty();
                    $("#filtro_lote_serie").empty();

                    $("#filtro_lp").append("<option value=''>Todos</option>");
                    $("#filtro_clave").append("<option value=''>Todos</option>");
                    $("#filtro_lote_serie").append("<option value=''>Todos</option>");
                }
                ...
                for (var i=0; i<data.articulos.length; i++)
                {
                  ...
                  emptyItem=[{
                      ...
                      control_abc:          data.articulos[i].control_abc,
                      ...
                      peso_total:           data.articulos[i].peso_total*data.articulos[i].num_existencia,
                      ...
                      volumen_ocupado:      data.articulos[i].volumen_ocupado*data.articulos[i].num_existencia,
                      proveedor:            data.articulos[i].proveedor,
                      id_proveedor:         data.articulos[i].id_proveedor,
                      peso_u:               data.articulos[i].peso_total,
                      volumen_u:            data.articulos[i].volumen_ocupado,
                      almacen:              $("#almacen option:selected").text(),
                      zona:                 $("#zonarecepcioni option:selected").text(),
                      control_peso:         data.articulos[i].control_peso
                   }];
                   //console.log("tipo for["+i+"] = ", data.articulos[i].tipo)

            if($("#borrar_selects").val() == '1')
            {
                if(data.articulos[i].LP && $.inArray( data.articulos[i].LP, arr_lp ) == -1)
                { 
                    $("#filtro_lp").append("<option value='"+data.articulos[i].LP+"'>"+data.articulos[i].LP+"</option>");
                    arr_lp.push(data.articulos[i].LP);
                }
                if(data.articulos[i].clave && $.inArray( data.articulos[i].clave, arr_clave ) == -1) 
                {
                    $("#filtro_clave").append("<option value='"+data.articulos[i].clave+"'>"+data.articulos[i].clave+"</option>");
                    arr_clave.push(data.articulos[i].clave);
                }

                if(data.articulos[i].lote && $.inArray( data.articulos[i].lote, arr_lote_serie ) == -1) 
                {
                    $("#filtro_lote_serie").append("<option value='"+data.articulos[i].lote+"'>"+data.articulos[i].lote+"</option>");
                    arr_lote_serie.push(data.articulos[i].lote);
                }

                if(data.articulos[i].numero_serie && $.inArray( data.articulos[i].numero_serie, arr_lote_serie ) == -1) 
                {
                    $("#filtro_lote_serie").append("<option value='"+data.articulos[i].numero_serie+"'>"+data.articulos[i].numero_serie+"</option>");
                    arr_lote_serie.push(data.articulos[i].numero_serie);
                }
            }
        ...
        if($("#cve_ubicacion_usada").val() != $(this).val()) 
        {
            $("#borrar_selects").val("1"); 
            $("#cve_ubicacion_usada").val($(this).val());
        }
        else
            $("#borrar_selects").val("0");
...
*/
        ...
        $.ajax({
            ...
            success: function(data) 
            {
                ...
                $("#volumen_capacidad").val(data.capacidad[0].capacidad_volumetrica);
                $("#volumen_acum").val(peso.toFixed(6));

                //$("#porcentaje_v_ocupado").val((parseInt((peso*100)/data.capacidad[0].capacidad_volumetrica)+parseInt(($("#input-volumenA").val()*100/data.capacidad[0].capacidad_volumetrica),10))+" %");
    ...
    $('#ubicacionf').change(function(e){
        ...
        $.ajax({
            ...
            success: function(data) 
            {
                ...
                console.log("capacidad_volumetrica HERE", data.capacidad[0]);
                if(!data.capacidad[0].capacidad_volumetrica)
                swal("Error", "Intente Seleccionar de Nuevo el Producto", "error");
                ...
                setTimeout(function(){
                    console.log("VOLUMEN OCUPADO = ", parseFloat($("#volumen_acum").val()), " PESO MAXIMO = ", parseFloat($("#volumen_capacidad").val()));
                    if(parseFloat($("#volumen_acum").val()) > parseFloat($("#volumen_capacidad").val()))
                    {
                        console.log("VOLUMEN Buscar Otro BL");
                        $("#permitir_volumen").val(0);
                    }
                    else
                    {
                        console.log("VOLUMEN Dejar BL Actual");
                        $("#permitir_volumen").val(1);
                    }
                }, 500);

                //$("#porcentaje_v_ocupado").val((parseInt((peso*100)/data.capacidad[0].capacidad_volumetrica)+parseInt(($("#input-volumenA").val()*100/data.capacidad[0].capacidad_volumetrica),10))+" %");

                $("#ubicacion_piso").val(data.capacidad[0].ubicacion_piso);
    ...
    function calculatePesoUbi(_MAX, _OCU)
    {
        ...
        { 
            ...
            console.log("MAX = ", MAX);
            $("#peso_capacidad").val(MAX);
            $("#peso_acum").val(OCU);
/*
            setTimeout(function(){
                console.log("PESO OCUPADO = ", parseFloat($("#peso_acum").val()), " PESO MAXIMO = ", parseFloat($("#peso_capacidad").val()));
                if(parseFloat(OCU) > parseFloat(MAX))
                {
                    console.log("Buscar Otro BL");
                    $("#permitir_peso").val(0);
                }
                else
                {
                    console.log("Dejar BL Actual");
                    $("#permitir_peso").val(1);
                }
            }, 500);

            setTimeout(function(){
            var permitir_peso = $("#permitir_peso").val(),
                permitir_volumen = $("#permitir_volumen").val();
            console.log("permitir_peso = ", permitir_peso);
            console.log("permitir_volumen = ", permitir_volumen);
            if(permitir_volumen == 0 || permitir_peso == 0)
            {

                console.log("------------------------------------");
                console.log("clasif_articulo:", $("#clasif_actual").val());
                console.log("ubicacion:", $("#ubicacionf").val());
                ...
                $.ajax({
                    ...
                    type: "POST",
                    data: {
                        clasif_articulo: $("#clasif_actual").val(),
                        ubicacion: $("#ubicacionf").val(),
                        almacen: $("#almacen").val(),
                        action : "verificar_abc"
                    },
                    beforeSend: function(x) { if(x && x.overrideMimeType) { x.overrideMimeType("application/json;charset=UTF-8"); }},
                    url: '/api/ubicaciones/update/index.php',
                    success: function(data) 
                    {
                        console.log("ZONA ABC 2 = ", data);
                        if(!data.zona)
                        {
                            swal("Error", 'No hay Zonas de Almacenaje Tipo '+data.clasif_articulo+' En este almacén', 'error');
                        }
                        else
                        {
                            $("#zonaalmacenajef").val(data.zona);
                            setTimeout(function(){
                                $("#ubicacionf").val(data.ubicacion); 
                                $("#ubicacionf").change();
...
*/
            //f(true);
            //$("#porcentaje_p_ocupado").val((parseInt(((OCU * 100)/MAX),10)+parseInt(($("#input-pesoA").val()*100/MAX),10))+"%");
        }
        else
        {
            input_pesoU.value = "";
    ...
    function calculatePesoMax(state)
    {
        ...
        { 
            ...
            if(cantTotal)
            {
                ...
                {
                    if(pesoTotal > pesoMaximo && $("#ubicacion_piso").val() != "0")
                    {
                        input_pesoA.style.borderColor = "red";
                        console.log("Peso NO Permitido");
                    }
                    else
                    {
                    ...
                    if(volumenTotal > volumenMaximo && $("#ubicacion_piso").val() != "0")
                    {
                        input_volumenA.style.borderColor = "red";
                        console.log("Volumen NO Permitido");
                    }
                    else
                    {
                        input_volumenA.style.borderColor = "green";
                        console.log("Volumen Permitido");
                    }
                }
                else
                {
...
function Calcular_Num_Piezas()
{
        ...
        console.log("#ctotali = ", $("#ctotali").val());
        ...
        else if(rowData["serie"] != "")
        {  
            console.log("entro serie");
            $("#lotei").val(rowData["serie"]);
        }

        var porc_peso = "", porc_volumen = "";
        porc_peso = $("#peso_acum").val();
        porc_volumen = $("#volumen_acum").val();

        $("#input-pesoA").val(((parseFloat($("#ctotali").val())*parseFloat(rowData["peso_u"]))));
        $("#input-volumenA").val((parseFloat(rowData["volumen_u"])*parseFloat($("#ctotali").val())));

        console.log("porc_peso = ", porc_peso, " - input-pesoA = ", $("#input-pesoA").val(), " - porcentaje_p_ocupado = ", $("#peso_capacidad").val());
        console.log("porc_volumen = ", porc_volumen, " - input-volumenA = ", $("#input-volumenA").val(), " - porcentaje_v_ocupado = ", $("#volumen_capacidad").val());



        if(parseFloat($("#input-pesoA").val()))
        {
            if($("#peso_capacidad").val() > 0)
            $("#porcentaje_p_ocupado").val(((parseFloat($("#input-pesoA").val())+parseFloat(porc_peso))*100/$("#peso_capacidad").val())+"%");

            if($("#volumen_capacidad").val() > 0)
            $("#porcentaje_v_ocupado").val(((parseFloat($("#input-volumenA").val())+parseFloat(porc_volumen))*100/$("#volumen_capacidad").val())+"%");
        }
    ...
    $("#filtro_buscador").keyup(function(e){
        if($('#zonarecepcioni').val()) $('#zonarecepcioni').change();
    });

    $("#filtro_lp, #filtro_clave, #filtro_lote_serie").change(function(){
        if($('#zonarecepcioni').val()) $('#zonarecepcioni').change();
    });
    ...
    function comparar(_codigo)
    {
       ...
       if(document.getElementById("checkAcomodo").checked)
        ...
        console.log("Entro en comparar(", _codigo,"), Folio = ", rowData['idy_ubica']);

       console.log("*******************************************");
       console.log("Evaluar Zonas Control ABC");
       console.log("Clasif ABC = ", rowData['control_abc']);
       //$("#ubicacionf").empty();
       $("#zonaalmacenajef, #ubicacionf").val("0");
       $("#zonaalmacenajef").prop("disabled", false);

       if(rowData['control_abc'])
       {
          console.log("BUSCAR Zonas Control ABC");
          console.log("clasif_articulo: ", rowData['control_abc']);
          console.log("pallet_contenedor: ", rowData['pallet_contenedor']);
          console.log("cve_articulo: ", rowData['clave']);
          console.log("cantidad: ", rowData['num_existencia']);
          console.log("almacen: ", $("#almacen").val());

          $("#mensaje_control_abc").show();
//setTimeout(function(){
            $.ajax({
                dataType: "json",
                type: "POST",
                data: {
                    clasif_articulo: rowData['control_abc'],
                    pallet_contenedor: rowData['pallet_contenedor'],
                    cve_articulo: rowData['clave'],
                    cantidad: rowData['num_existencia'],
                    ubicacion: "",
                    almacen: $("#almacen").val(),
                    action : "verificar_abc"
                },
                ...
                success: function(data) 
                {
                    ...
                    {
                        swal("Error", 'No hay ubicaciones en esta Zona de Almacenaje Tipo '+data.clasif_articulo+' En este almacén, O No hay ninguna secuencia asignada', 'error');
                    }
                    else
                    {
                        $("#zonaalmacenajef").val(data.zona);
                        $("#clasif_actual").val(data.clasif_articulo);
                        setTimeout(function(){
                            //$("#ubicacionf").val(data.ubicacion); 
                            //$("#ubicacionf").change();
                            $("#ubicacionf").empty();
                            $("#ubicacionf").append("<option value='"+data.ubicacion+"'>"+data.BL+"</option>");
                            calculatePesoMax(true);
                            //$("#cantrecibi").change();
                            $("#cantrecibi").keyup();
...
//}, 1500);
       ...
       {
          console.log("NO BUSCAR Zonas Control ABC");
          $("#mensaje_control_abc").hide();
       }

       console.log("*******************************************");


      console.log("control_peso = ", rowData["control_peso"]);

      if(rowData["control_peso"] == "S") 
      {
            $("#cantrecibi").attr("oninput", "");
            $("#cantrecibi").attr("type", "number");
      }
      else 
      {
            $("#cantrecibi").attr("oninput", "this.value = this.value.replace(/[^0-9]/g, '');");
            $("#cantrecibi").attr("type", "text");
      }

        console.log("rowData[tipoa] ----> ", rowData["tipoa"]);
    ...
    function getDataCON(_codigo)
    {
       ...
       $("#palleti").val(rowData["pallet_contenedor"]);
       $("#lpi").val(rowData["LP"]);
       ...
       $.ajax({
          ...
          success: function(data) 
          {
            ...
            if(!document.getElementById("checkAcomodo").checked)
                UbicacionesAcomodoTraslado($("#zonaalmacenajef").val(), "ubicacionesVacias", tipo_ubicaciones_action_send);
    ...
    { //PR3
        console.log("numRowsTable getDataZI = ", $("#grid-tabla").jqGrid('getGridParam', 'reccount'));
        console.log ("codigo",_codigo);
       ...
       $("#zonaalmacenajef").prop("disabled", false);
        ...
        if(document.getElementById("checkAcomodo").checked)
        {
            ...
            //UbicacionesAcomodoTraslado($("#zonaalmacenajef").val(), action_val, tipo_ubicaciones_action_send);
            $("#ubicacionf").prop('disabled',true);
        }
        else
            rowData  = $("#grid-tabla").jqGrid("getRowData", _codigo);
        ...
        if(document.getElementById("checkAcomodo").checked)
        {
            $("#articuloi").val(rowData["articulo"]);
...
*/
        ...
        else
        {
            ...
            $("#cantrecibi").val(rowData["num_existencia"]);
            $("#ctotali").val(rowData["num_existencia"]);
        }
            ...
            success: function(data) 
            {
              ...
              console.log("entro data", data);
                ...
                if(rowData["tipoa"] != "Articulo")
                {
                     ...
                     //$("#ctotali").val(0);
                    if(!document.getElementById("checkAcomodo").checked)
                        UbicacionesAcomodoTraslado($("#zonaalmacenajef").val(), "ubicacionNoLlenas-acomodo", tipo_ubicaciones_action_send);
                }
                else
                {
                     //$("#cantrecibi, #ctotali").prop('disabled',true);
...
//                {
        ...
        //$("#porcentaje_p_ocupado").val(((parseInt($("#input-pesoA").val())+parseInt(porc_peso))*100/$("#peso_capacidad").val())+"%");
        //$("#porcentaje_v_ocupado").val(((parseInt($("#input-volumenA").val())+parseInt(porc_volumen))*100/$("#volumen_capacidad").val())+"%");
                    }
//                }
                        ...
                        //*************************************************************************************
                            ...
                            $.ajax({
                                ...
                                success: function(data) 
                                {
                                    ...
                                    $("#zfxocupado").html("&nbsp;% de Ocupación "+ocupado.toFixed(2)+" ");
                                    $("#amixf").val(data.capacidad[0].amix);
                                    //console.log("ENVIANDO pesos = ", data.capacidad[0].peso, peso2);
                                    calculatePesoUbi(data.capacidad[0].peso, peso2);
    ...
    $("#addrow").click( function() {
        ...
        var select_almacena_a = document.getElementById('zonaalmacenajei'),
            ...
            text_origen;
        if ((pesoActual+pesoAMover)>pesoMaximo && $("#ubicacion_piso").val() != "0" && pesoMaximo > 0)
        {
...
*/
        if ((volumenActual+cantidadVAMover)>volumenMaximo && $("#ubicacion_piso").val() != "0" && volumenMaximo > 0)
        {
        ...
        else 
        {
            ...
            input_arti.value = rowData2["articulo"];
    ...
    { //PR2
        ...
        {
            valor_lp     = rowData['LP'];
            valor_pallet = rowData['pallet'];
        }
        var enviar_folios_entrada = 0;
        if($("#enviar_folios_entrada").is(':checked'))
            enviar_folios_entrada = 1;

        var proyecto = rowData['proyecto'];

        var folio = rowData['idy_ubica'];
        ...
        console.log("cantidad máxima", rowData["num_existencia"]);
        ...
        console.log("enviar_folios_entrada", enviar_folios_entrada);
        ...
        console.log("zonarecepcioni", $("#zonarecepcioni").val());
        ...
        $.ajax({
            ...
            data: {
                ...
                cantidad: $("#cantrecibi").val(),
                cantidad_max: rowData["num_existencia"],
                ...
                enviar_folios_entrada: enviar_folios_entrada,
                lp_val: valor_lp,
                proyecto: proyecto,
                folio: folio,
                ...
                maximo_val : $("#ctotali").val(),
                zonarecepcioni: $("#zonarecepcioni").val(),
    ...
    function totalPendiente()
    {
        ...
        var total =0;
        var productos = [], productos_i = 0;
        console.log("esta es la tabla");
        //console.log(allData);
        for(var i=0; i < allData.length; i++)
        {
            total += parseFloat(allData[i]["num_existencia"]);
            if(!productos.includes(allData[i]["clave"]))
            {
                productos[productos_i] = allData[i]["clave"];
                productos_i++;
            }
        }
        console.log("total pendiente acomodo = ", total);
        console.log("productos = ", productos);
        $("#valor_total_pendiente").val(productos_i+" | "+total);
    }
