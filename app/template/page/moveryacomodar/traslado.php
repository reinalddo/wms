...
<input type="hidden" id="QA" value="No">
            ...
            <div class="modal-dialog vertical-align-center">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Traslados por Importación</h4>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group" style="text-align: center;">
                                <div class="checkbox">
                                    ...
                                    <?php 
                                    //if($_SESSION['cve_usuario'] == 'reinaldo')
                                    //{
                                    ?>
                                    <br><br>
                                    <button type="button" class="btn btn-primary permiso_registrar" style="margin-left:15px" data-toggle="modal" data-target="#importar"><span class="fa fa-file-excel-o"></span> Realizar Traslados por Importación</button>
                                    <?php 
                                    //}
                                    ?>

                                    <br>
                                    <input type="button" class="btn-primary btn-sm"  id="btn_palletizar_traslado_almacen" style="display: none;" value="Enviar en Pallet">
                                </div>
                            ...
                            <div class="col-lg-12">
                                <input type="hidden" id="clave_alamcen" value="">

                            <div class="form-group trasladar_ubicacion" style="text-align: center; display: none;">
                                <div class="checkbox">
                                    <label for="trasladar_ubicacion" style="font-weight: 600;font-size: 14px; -moz-user-select: none; -webkit-user-select: none;-ms-user-select: none; user-select: none;">
                                    <input type="checkbox" name="trasladar_ubicacion" id="trasladar_ubicacion" value="0">Trasladar Toda la Ubicación</label>
                                </div>
                            </div>

                            <div class="form-group palletizar_check" style="text-align: center;display: none;">
                                <div class="checkbox">
                                    <label for="palletizar_traslado" style="font-weight: 600;font-size: 14px; -moz-user-select: none; -webkit-user-select: none;-ms-user-select: none; user-select: none;">
                                    <input type="checkbox" name="palletizar_traslado" id="palletizar_traslado" value="0">Palletizar Traslado</label>
                                </div>
                            </div>
                            <div class="form-group convertir_pzs_check" style="text-align: center;display: none;">
                                <div class="checkbox">
                                    <label for="convertir_pzs" style="font-weight: 600;font-size: 14px; -moz-user-select: none; -webkit-user-select: none;-ms-user-select: none; user-select: none;">
                                    <input type="checkbox" name="convertir_pzs" id="convertir_pzs" value="0">Convertir a cajas y trasladar en Pallet</label>
                                </div>
                            </div>
                            <div class="row palletizar_traslado" style="display:none;">
                            <div class="col-md-3"></div>
                            <div class="form-group col-md-6" id="pallets" style="text-align: left;">
...
<!-- ******************************************************************************************* -->
                                ...
                                <div class="col-md-6 Xtraslado_almacen" style="display: none;">
...
?>
                <div class="row traslado_ubicacion">
                  <div class="form-group col-md-12">
                    <label>Código BL*</label>
                    <input class="form-control" name="cliente_buscar" id="cliente_buscar" placeholder="Código BL" autocomplete="off">
                ...
                <div class="row traslado_ubicacion">
                  <div class="form-group col-md-12">
                  <label>Ubicación*</label>
                       <select id="ubicacionf" name="ubicacionf" class="form-control chosen-select">
                       </select>
                  </div>
                </div>
<?php 
...
?>
                                ...
                                <div class="col-md-6" style="text-align: center;">
                                    <div class="checkbox">
    <?php $title_fusionar = "Al Seleccionar Fusionar, El pallet Origen se elimina y pasa todos su contenido al Pallet destino"; ?>
                                        <label for="fusionar_traslado" style="font-weight: 600;font-size: 14px; -moz-user-select: none; -webkit-user-select: none;-ms-user-select: none; user-select: none; margin-top: 28px;" title="<?php echo $title_fusionar; ?>">
                                        <input type="checkbox" title="<?php echo $title_fusionar; ?>" name="fusionar_traslado" id="fusionar_traslado" value="1" style="margin-right: 5px;">Fusionar</label>
                                        <div><span id="msj_fusionar" style="color:red;font-weight: bolder;display: none;"><?php echo $title_fusionar; ?></span></div>
                                    </div>
                                    <div class="checkbox">
    <?php $title_fusionar_cajas = "El pallet Origen se convierte en una caja y se pasa al Pallet destino elegido"; ?>
                                        <label for="fusionar_traslado_cajas" style="font-weight: 600;font-size: 14px; -moz-user-select: none; -webkit-user-select: none;-ms-user-select: none; user-select: none; margin-top: 28px;" title="<?php echo $title_fusionar_cajas; ?>">
                                        <input type="checkbox" title="<?php echo $title_fusionar_cajas; ?>" name="fusionar_traslado_cajas" id="fusionar_traslado_cajas" value="1" style="margin-right: 5px;">Trasladar en Cajas</label>
                                        <div><span id="msj_fusionar_cajas" style="color:red;font-weight: bolder;display: none;"><?php echo $title_fusionar_cajas; ?></span></div>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding:10px 50px;">
                ...
                <div class="form-group" id="fusion_pallet" style="display: none;">
                    <label ><span class="fas fa-database"></span> Seleccione Pallet a Fusionar</label>
                    <select class="form-control chosen-select" id="select_pallets_fusionar"><option value=""></option></select>
                    <div id="mensaje_pallets" style="color: red;display: none;font-weight: bolder;">No hay Pallets Disponibles para Fusionar</div>
                </div>
                <div class="form-group" id="fusion_pallet_cajas" style="display: none;">
                    <label ><span class="fas fa-database"></span> Seleccione Pallet para Fusionarlos en cajas</label>
                    <select class="form-control chosen-select" id="select_pallets_fusionar_cajas"><option value=""></option></select>
                    <div id="mensaje_pallets_cajas" style="color: red;display: none;font-weight: bolder;">No hay Pallets Disponibles para Fusionar en cajas</div>
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer">
                <button id="boton_mover" onclick="save()" class="btn btn-success btn-block"><span class="glyphicon glyphicon-transfer"></span><span> Mover</span></button>
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.success == true) 
                {
                    ...
                    fillSelectZona();
                    CargarUbicacionesBL();
                    //$("#clave_almacen").val(data.codigo.clave);
                    searchSelects(data.codigo.id);
                }
            },
            error: function(res){
...
var tipo_ubicaciones_action_send = "", descripcion_pca_send = "";
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            height: 400,
            mtype: 'POST',
            colNames:['Seleccionar','idy_ubica','Ubicacion', 'Tipo', 'Pallet|Contenedor', 'License Plate (LP)','Clave Articulo','id_articulo','Articulo','Lote|Serie','Caducidad','Serie','Volumen Ocupado','Existencia','Peso','Proveedor','id_proveedor','Almacen',' Zona de Almacenaje', 'QA'],/*'Calle y Numero','Colonia','Ciudad','Estado','Pais','Codigo Postal','RFC','Telefono1','Telefono2'*/
            colModel:[
                {name:'myac',index:'', width:80, fixed:true, sortable:false, resize:false, formatter:imageFormat, frozen : true},
                {name:'idy_ubica',index:'idy_ubica',editable:false,width:150, sortable:false, hidden: true},
                ...
                {name:'almacen',index:'almacen',editable:false,width:150,sortable:false, hidden: false},
                {name:'zona',index:'zona',editable:false,width:150, sortable:false, hidden: false},
                {name:'QA',index:'QA',editable:false,width:50, sortable:false, hidden: false},
    ...
    function CargarUbicacionesBL()
    {
        ...
        console.log("#traslado_almacen = ", $("#traslado_almacen").is(':checked'));
        ...
        $.ajax({
            ...
            data: {
                ...
                almacen : almacen,
                traslado : ($("#traslado_almacen").is(':checked'))?1:0,
                excludeInventario: 0
            },
            beforeSend: function(x) { if(x && x.overrideMimeType) { x.overrideMimeType("application/json;charset=UTF-8"); }},
            success: function(data) {
                console.log("SUCCES CargarUbicacionesBL = ", data);
                var options = $("#ubicacioni");
                options.empty();
                ...
                console.log("ERROR CargarUbicacionesBL = ", data);
            }
...
$(".palletizar_traslado").hide();
$(".palletizar_check").hide();
$("#palletizar_traslado").prop("checked", false);
$(".convertir_pzs_check").hide();
                ...
                for (var i=0; i<data.articulos.length; i++)
                {
                  ...
                  //console.log(data.articulos[i].volumen_ocupado);
                    emptyItem=[{
                        ...
                        proveedor:data.articulos[i].proveedor,
                        id_proveedor:data.articulos[i].ID_Proveedor,
                        QA:data.articulos[i].Cuarentena
                    }];
    ...
    $('#ubicacionf').change(function(e)
    {
        ...
        console.log("ubicacionf = ", almacen);
        ...
        $.ajax({
            ...
            success: function(data) 
            {
                ...
                console.log("articulosenUbicacion = ", data);
                //console.log("********Zona Ubicacion = ", data.zona[0].cve_almac);
                $("#grid-tabla2").jqGrid("clearGridData");
                var peso  = 0;
                var peso2 = 0;
                for (var i=0; i<data.articulos.length; i++)
                {
                  ...
                  //console.log(data.articulos[i].volumen_ocupado);
                    ...
                    //{
                        ...
                        //$("#zonaalmacenajef").val(data.zona[0].cve_almac);
                        //$("#zonaalmacenajef").val(data.articulos[0].Clave_Zona);
                    
                //$("#grid-tabla2").jqGrid('addRowData',0,lastEmptyItem);
                
                var input_pesoU = document.getElementById('input-volumenU');
                console.log("data.capacidad[0].capacidad_volumetrica = ", data.capacidad[0].capacidad_volumetrica);
                input_pesoU.value = (data.capacidad[0].capacidad_volumetrica + " / " + peso.toFixed(6));
                $("#porcentaje_v_ocupado").val(parseInt((peso*100)/data.capacidad[0].capacidad_volumetrica)+" %");
    ...
    $('#almacen').change(function(e){
        ...
        searchSelects($(this).val());
    });


    $("#palletizar_traslado, #convertir_pzs").click(function()
    {
        if($(this).is(':checked'))
        {
            $(".palletizar_traslado").show();
            $("#fusionar_traslado_cajas").prop("checked", false);
            $("#msj_fusionar_cajas").hide();
        }
        else
        {
            $(".palletizar_traslado").hide();
    ...
    $('#traslado_almacen').change(function() 
    {
        if($("#traslado_almacen").is(':checked'))
        {
            ...
            //$("#ubicacionf_chosen, #ubicacion_label, #zonaalmacenajeff, .traslado_ubicacion").hide();
            ...
            $("#grid-tabla2").jqGrid('clearGridData');
            $("#grid-tabla2").hide();
            //$("#btn_palletizar_traslado_almacen").show();
        }
        else
        {
            //console.log("traslado CHECK OFF");
            $("#ubicacionf_chosen, #ubicacion_label, #zonaalmacenajeff, .traslado_ubicacion").show();
            $(".traslado_almacen").hide();
            $("#grid-tabla2").show();
            $("#grid-tabla2").jqGrid('clearGridData');
            $("#btn_palletizar_traslado_almacen").hide();
            $(".convertir_pzs_check").hide();
        }
        CargarUbicacionesBL();
        $("#grid-tabla3").jqGrid('clearGridData');
    ...
    $('#almacen_alm').change(function(e){
        $("#cliente_buscar, #ubicacionf").val("");
        $("#ubicacionf").empty();
        $("#ubicacionf, #cliente_buscar").trigger("change");
        $("#ubicacionf, #cliente_buscar").trigger("chosen:updated");
        fillSelectZona();
    ...
    function fillSelectZona()
    {
        ...
        var almacen= (!$("#traslado_almacen").is(':checked'))?($('#almacen').val()):($('#almacen_alm').val());
        console.log("Almacen Traslado = ", almacen);
        //if(!$("#traslado_almacen").is(':checked'))
        //{
            $.ajax({
                type: "POST",
...
function Calcular_Num_Piezas()
{
        ...
        if ($("#umedidai").val()=="1" || $("#umedidai").val()=="3")
        {
            ...
            if ($("#umedidai").val()=="3")
            {
                ...
                $("#cantrecibi").val($("#cantidad_max").val());
            }
        }
/*
        if ($("#umedidai").val()=="2")
...
*/
    ...
    { //PR3
        ...
        if(document.getElementById("checkAcomodo").checked)
        {
            ...
            $("#trasladar_ubicacion").prop("checked", false);
            if(rowData['tipo'] == 'Artículo')
            {
                $(".trasladar_ubicacion").show();
                $(".convertir_pzs_check").hide();
            }
            else
            {
                $(".trasladar_ubicacion").hide();
            }
            ...
            if(rowData['tipo'] == "Pallet")
            {
                ...
                //if($("#traslado_almacen").is(':checked')) $(".convertir_pzs_check").show();
            }
        ...
        if(document.getElementById("checkAcomodo").checked)
        {
            if(rowData["pallet"])
            {
                ...
                $("#articuloi").val(rowData["pallet"]+" -> ["+rowData["cve_articulo"]+"] - "+rowData["articulo"]);
        ...
        else
        {
            ...
            {
                $("#articuloi").val(rowData["pallet_contenedor"]+" - ["+rowData["clave"]+"] - "+rowData["descripcion"]);
                PesoYVolumenRowsGridTable(rowData["pallet_contenedor"]);
            }
            $("#cve_articuloi").val(rowData["clave"]);
        }
...
*/
        ...
        // && !$("#traslado_almacen").is(':checked')
        console.log("ubicacionf = ", $("#ubicacionf").val());
        if ($("#ubicacionf").val()=="" || $("#ubicacionf").val()=="0" || $("#ubicacionf").val()=="null" || $("#ubicacionf").val()==null)
        {
        ...
        if ((pesoActual+pesoAMover)>pesoMaximo /*&& !$("#traslado_almacen").is(':checked')*/ && pesoMaximo > 0)
        {
...
*/
        if ((volumenActual+cantidadVAMover)>volumenMaximo /*&& !$("#traslado_almacen").is(':checked')*/ && volumenMaximo > 0)
        {
        ...
        $("#select_pallets_fusionar").empty();
        $("#fusion_pallet, #mensaje_pallets").hide();
        $("#boton_mover").show();
        if($("#fusionar_traslado").is(':checked'))
        {
            $("#fusion_pallet").show();
            $.ajax({
                url: '/api/ubicaciones/update/index.php',
                data: {
                    action: 'getPalletsFusionar',
                ...
                success: function(data) 
                {
                    ...
                    $("#select_pallets_fusionar").append(data.options);
                    if(!data.options) 
                    {
                        $("#mensaje_pallets").show();
                        $("#boton_mover").hide();
                    }
        ...
        $("#select_pallets_fusionar_cajas").empty();
        $("#fusion_pallet_cajas, #mensaje_pallets_cajas").hide();
        $("#boton_mover").show();
        if($("#fusionar_traslado_cajas").is(':checked'))
        {
            $("#fusion_pallet_cajas").show();
            $.ajax({
                url: '/api/ubicaciones/update/index.php',
                data: {
                    action: 'getPalletsFusionar_cajas',
                ...
                {
                    console.log("SUCCESS: ", data);
                    $("#select_pallets_fusionar_cajas").append(data.options);
                    if(!data.options) 
                    {
                        $("#mensaje_pallets_cajas").show();
                        $("#boton_mover").hide();
                    }
                    //$('#ubicacionf').trigger('change');
                    $(".chosen-select").trigger("chosen:updated");
    ...
    $("#fusionar_traslado").click(function()
    {
        $("#fusionar_traslado_cajas").prop("checked", false);
        $("#msj_fusionar_cajas").hide();
    ...
    $("#trasladar_ubicacion").click(function(){
        $("#fusionar_traslado_cajas").prop("checked", false);
        $("#msj_fusionar_cajas").hide();
    });

    $("#fusionar_traslado_cajas").click(function()
    {
        $("#fusionar_traslado, #palletizar_traslado, #trasladar_ubicacion").prop("checked", false);
        $("#msj_fusionar").hide();
        $(".palletizar_traslado").hide();

        if($("#fusionar_traslado_cajas").is(':checked'))
            $("#msj_fusionar_cajas").show();
        else
        {
            $("#msj_fusionar_cajas").hide();
            $("#select_pallets_fusionar_cajas").empty();
    ...
    { //PR2
        ...
        var palletizar_traslado = 0;
        if($("#palletizar_traslado").is(':checked'))
            palletizar_traslado = 1;

        var trasladar_ubicacion = 0;
        if($("#trasladar_ubicacion").is(':checked'))
            trasladar_ubicacion = 1;

        var convertir_pzs = 0;
        if($("#convertir_pzs").is(':checked'))
            convertir_pzs = 1;

        if((palletizar_traslado == 1 || convertir_pzs == 1) && $("#select-pallets").val() == "")
        {
            swal("Error", "Debe Seleccionar un Pallet para trasladar", "error");
            return;
        }
        ...
        console.log("palletizar_traslado:", palletizar_traslado);
        console.log("trasladar_ubicacion:", trasladar_ubicacion);
        console.log("convertir_pzs:", convertir_pzs);
        console.log("pallet_palletizar:", $("#select-pallets").val());
        ...
        console.log("pallet fusionar:", $("#select_pallets_fusionar").val());
        console.log("pallet fusionar cajas:", $("#select_pallets_fusionar_cajas").val());
...
/*
        ...
        console.log("lp_val:",  valor_lp);
        console.log("pallet_val:",  valor_pallet);
        console.log("fusionar:",  $("#select_pallets_fusionar").val());
        console.log("cve_articulo:",  $("#cve_articuloi").val());
        console.log("ID_Proveedor:",  $("#ID_Proveedor").val());
        console.log("cve_almacf:",  DATA.cve_almacf);
        console.log("cve_lote:",  $("#lotei").val());
        console.log("importacion:",  0);
        console.log("piezQAaxcaja:",  $("#xcajai").val());
        console.log("piezaxpallet:",  $("#xpalleti").val());
        console.log("cantidadTotal:",  $("#ctotali").val());
        console.log("cve_usuario:",  $("#usuario").val());
        console.log("QA:",  $("#QA").val());
...
*/
        ...
        $.ajax({
            ...
            data: {
                ...
                palletizar_traslado: palletizar_traslado,
                trasladar_ubicacion: trasladar_ubicacion,
                convertir_pzs: convertir_pzs,
                pallet_palletizar: $("#select-pallets").val(),
                ...
                fusionar: $("#select_pallets_fusionar").val(),
                fusionar_cajas: $("#select_pallets_fusionar_cajas").val(),
...
//******************************************************************************************************
        ...
        function BuscarCliente(cliente)
        {
            ...
            console.log("Almacen = ", (!$("#traslado_almacen").is(':checked'))?($("#almacen").val()):($("#almacen_alm").val()));
            ...
            $.ajax({
                ...
                data: {
                    action: 'getBLSelect',
                    traslado_almacen: ($("#traslado_almacen").is(':checked'))?(1):(0),
                    almacen: (!$("#traslado_almacen").is(':checked'))?($("#almacen").val()):($("#almacen_alm").val()),
                    cliente: cliente
                },
                dataType: 'json',
                method: 'GET',
    ...
    function searchSelects(almacen){
        ...
        $.ajax({
            ...
            success: function(res){
                console.log("res Select pallets = ", res);
...
$('#btn-layout').on('click', function(e) {
  window.location.href = '/Layout/Layout_Traslados.xlsx';
}); 
...
/*
        swal({
            title: "Advertencia",
            text: "Por los momentos está deshabilitado el traslado por cajas, las celdas configuradas en S se trasladaran a un LP Destino sin convertir en caja. Continuar?",
            type: "warning",
                ...
                success: function(data) {
                    ...
                    setTimeout(
                        function(){if (data.status == 200) {
                            if(data.success == 0)
                                swal("Advertencia", data.statusText, "warning");
                            if(data.success == 2)
                                swal("Hay errores que debe corregir antes de importar", data.statusText, "error");
                            else 
...
*/
                    ...
                    console.log("ERROR??", data);
                        $("#loadgif").hide();
                      var cadena = data.responseText;
                      var lf = 'Gateway Timeout', lf2 = 'Deadlock';
                      if(cadena.indexOf(lf)>=0) 
                        swal("Error 504", lf, "error");
                      else if(cadena.indexOf(lf2)>=0) //DeadLock
                      {
                        console.log("DeadLock!, ejecutando nuevamente...");
                        $('#btn-import').click();
                        /*
                        $.ajax({
                            type: "POST",
                      ...
                      {
                        swal("Error", "Error en Traslado", "error");
                        $('#importar').modal('hide');
                      }
                        //window.location.reload();
