                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-12">
                                <div class="form-group col-lg-12" style="padding: 30px;  border: 2.5px solid; border-color: #dedede; border-radius: 15px"><!--#1ab394-->
                                  <div class="form-group col-md-4" id="Articulo" >
...
<div class="row"></div>
                                    <div class="form-group col-md-4" id="descuento_min_porc">
                                        <label>Volumen</label> 
                                        <input id="Volumen" type="number" placeholder="Volumen" class="form-control" 
                                        style="width: 95%;display: inline;text-align: right;">
                                    </div>
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            mtype: 'POST',
            colNames:["Acciones", 'Status Res', 'Status','ID','Clave','Descripción','Tipo', 'Fecha Inicio', 'Fecha Fin', 'Artículo|Grupo', 'Total Clientes', 'Almacén'], 
            colModel:[
                ...
                {name:'articulo_grupo',index:'articulo_grupo',width:300, editable:false, sortable:false},
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            height:'auto',
            mtype: 'POST',
            colNames:['Acciones', 'Clave','Artículo|Grupo','Cantidad','Monto $','Volumen','CveMedida', 'Unidad Medida'],
            colModel:[
                {name:'myac',index:'', width:130, fixed:true, sortable:false, resize:false, formatter:imageFormat2, hidden: true},
                ...
                {name:'volumen',index:'volumen',width:150, editable:false, sortable:false, align: 'right'},
...
*/
    ...
    l.click(function() 
    {
        ...
        if ($("input[name=tipo_lista]:checked").val() == 1 && $("#basic").val()==""){
            swal(
                'Error',
...
//******************************************************************************************************
    ...
    $(function($) {
        ...
        $(grid_selector_detalles).jqGrid({
            ...
            height:'auto',
            mtype: 'GET',
            colNames:['Clave','Artículo', 'Cantidad', 'Monto', 'Volumen', 'Unidad Medida'],
            colModel:[
                {name:'codigo',index:'codigo',width:150, editable:false, sortable:false},
                {name:'descripcion',index:'descripcion',width:250, editable:false, sortable:false},
                {name:'cantidad',index:'cantidad',width:150, editable:false, hidden:false, sortable:false, align: 'right'},
