    ...
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header" id="modaltitle">
                ...
                <h4 class="modal-title">Agregar Motivo de Devoluci&oacute;n</h4>
            </div>
            ...
            <form id="myform">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Clave *</label>
                        <input id="ClaveMotivo" type="text" placeholder="Clave del Motivo de devolución" required="true" class="form-control">
...
<div class="wrapper wrapper-content  animated fadeInRight">
    ...
    <h3>Motivo de Devoluci&oacute;n</h3>
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            url: '/api/motivodevolucion/lista/index.php',
            datatype: "json",
            shrinkToFit: false,
            height: 'auto',
            postData: {
    ...
    function agregar() {
        ...
        $("#ClaveMotivo").val("");
        $("#CodeMessage").html("");
        $("#modaltitle").html('<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-laptop modal-icon"></i><h4 class="modal-title">Agregar Motivo de Devoluci&oacute;n</h4>');
    }
    ...
    l.click(function() {
        ...
        $.post('/api/motivodevolucion/update/index.php', {
