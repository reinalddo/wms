...
<div class="wrapper wrapper-content  animated fadeInRight" id="form-prin">
    <h3>Devolución Pallets | Contenedores</h3>
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                  <div class="form-group">
                                     ...
                                     <input id="pallet-contenedor" class="form-control">
                                  </div>
                              </div>
                              ...
                              <div class="col-sm-5">
                                  <div class="form-group">
                                      <label>Cliente</label>
                                      <input id="cliente" class="form-control" readonly="readonly">
                                  </div>
                              </div>
<!--
                              <div class="col-sm-2">
                                    <div class="form-group">
                                       <label>BL</label>
                                       <input id="slect-BL" class="form-control">
                                    </div>
                              </div>
-->
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input id="fecha-fin" class="form-control" readonly="readonly">
                            </div>
                        </div>
<!--
                        <div class="col-sm-2">
...
-->
                        <div class="col-sm-2">
                                <div class="input-group">
                                    ...
                                    <input type="button" name="registrar-devolucion" id="registrarD" class="btn btn-primary permiso_registrar" value="Registrar">
                                </div>
                        </div>
...
-->
                        <div class="col-sm-1">
                            <div class="form-group">
                                <label>Pallets</label>
                                <input style="text-align:center;margin-left:8px;" id="pconsignacion" class="form-control" disabled style="margin-left: 10px">
                            </div>
                        </div>
                        <div class="col-sm-1">
                            <div class="form-group">
                                <label>Devuelto</label>
                                <input style="text-align:center;" id="pdevuelto" class="form-control" disabled style="margin-left: 10px">
                            </div>
                        </div>
                        <div class="col-sm-1">
                            <div class="form-group">
...
-->
                        ...
                        <div class="col-sm-1" >
                            <div class="form-group">
                                <label>Contenedores</label>
                                <input style="text-align:center;margin-left:8px;" id="cconsignacion" class="form-control" disabled>
                            </div>
                        </div>
                        <div class="col-sm-1">
                            <div class="form-group">
                                <label>Devuelto</label>
                                <input style="text-align:center;" id="cdevuelto" class="form-control" disabled>
                            </div>
                        </div>
                        <div class="col-sm-1">
                            <div class="form-group">
...
<script>
    ...
    $(function($) 
    {
        ...
        {
            url: '/api/devpalletsycontenedores/lista/index.php',
            datatype: "json",
            height: 250,
            shrinkToFit: false,
            height: 'auto',
            ...
            mtype: 'POST',
            colNames: ['ID','Acciones', 'Pallet|Contenedor', 'Descripción', 'Status', 'Tipo', 'Cliente', 'Fecha Consignación','Fecha Devolución','Días en Prestamo'],
            colModel: [
                ...
                {name: 'fecha',index: 'fecha',width: 130,editable: false,sortable: false, align:"center"},
                {name: 'fechadev',index: 'fechadev',width: 130,editable: false,sortable: false, align:"center"},
...
$("#pallet-contenedor").keyup(function(){
        ...
        $.ajax({
          ...
          success: function(data) {
                if(data.success)
                {
                    ...
                    //console.log("Cliente = ", data.cliente.cliente);
                    //console.log("Razon = ", data.cliente.razon);
                    $("#cliente").val("["+data.cliente.cliente+"] - "+data.cliente.razon);
                    $("#select-tipo").val(data.cliente.tipo);
                    $("#fecha").val(data.cliente.fecha);
                }
                else
                {
                    $("#cliente").val("");
  ...
  //////////////////////////////////////////////////////////////Nueva Tabla //////////////////////////////////////////////////////////////////
    ...
    function traer_cant_ac(){
        $.ajax({
          ...
          success: function(data) {
              $("#pconsignacion").val(data.con_pallet+data.dev_pallet);
              $("#pdevuelto").val(data.dev_pallet);
              $("#ptotal").val(data.con_pallet);

              $("#cconsignacion").val(data.con_contenedor+data.dev_contenedor);
              $("#cdevuelto").val(data.dev_contenedor);
              $("#ctotal").val(data.con_contenedor);
          },
          error:function(res){
    ...
    function almacenPrede() 
    {
        ...
        $.ajax({
            ...
            url: '/api/devpalletsycontenedores/lista/index.php',
            success: function(data) {
                $("#fecha-fin").val(data.fecha_actual.actual);
            },
            error:function(res){
                window.console.log(res);
            }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $("#registrarD").click(function(){
        ...
        if($("#cliente").val())
        {
            $.ajax({
                ...
                success: function(data) {
                    swal({
                        title: "Éxito!",
                        text: "Devolución del Pallet "+$("#pallet-contenedor").val()+" Registrada",
                        type: "success",
        ...
        else
        {
            swal({
                title: "Atención!",
                text: "Antes de Registrar un devolución debe buscar un cliente.",
                type: "warning",
                showCancelButton: false
            });
        }
