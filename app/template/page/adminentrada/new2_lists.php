...
<div class="modal fade" id="fotos_oc_th" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-subir-fotos-th" action="import" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="file_th">Seleccione las fotos a documentar</label>
                        ...
                        <br>
                        <button id="btn-fotos-th" type="button" class="btn btn-primary btn-block">Subir Foto(s)</button>
                    </div>
                </form>
                ...
                <br>
                <div id="fotos_th" class="container-fluid">
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            mtype: 'POST',
            colModel:[
                {label: 'Acciones' ,name:'myac',index:'',fixed:true, sortable:false, resize:false, formatter:imageFormat, width:330},
