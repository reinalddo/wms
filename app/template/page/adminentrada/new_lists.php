...
<link href="https://cdn.datatables.net/colreorder/2.0.4/css/colReorder.bootstrap.min.css" rel="stylesheet">
...
<div class="wrapper wrapper-content  animated" id="list">
    ...
    <label for="fechai_visible">Fecha Inicio</label>
    <div class="input-group">
        <span class="input-group-addon" onclick="document.getElementById('fechai_visible').focus();">
            <i class="fa fa-calendar"></i>
        </span>
        <!-- Campo visible con formato YYYY-MM-DD para el calendario -->
        <input id="fechai_visible" type="date" class="form-control" 
               onchange="document.getElementById('fechai').value = formatearFecha(this.value)">
        <!-- Campo oculto con el formato original DD-MM-YYYY para el backend -->
        <input id="fechai" type="hidden" name="fechai" value="<?php echo $fecha_semana; ?>">
    </div>
</div>

<div class="form-group col-md-4">
    <label for="fechaf_visible">Fecha Fin</label>
    <div class="input-group">
        <span class="input-group-addon" onclick="document.getElementById('fechaf_visible').focus();">
            <i class="fa fa-calendar"></i>
        </span>
        <!-- Campo visible con formato YYYY-MM-DD para el calendario -->
        <input id="fechaf_visible" type="date" class="form-control"
               onchange="document.getElementById('fechaf').value = formatearFecha(this.value)">
        <!-- Campo oculto con el formato original DD-MM-YYYY para el backend -->
        <input id="fechaf" type="hidden" name="fechaf" value="<?php echo $fecha_actual; ?>">
    </div>
</div>
                                    </div>
                                        ...
                                        <?php if ($instancia == "welldex"): ?>
                                            <div class="form-group col-md-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="refWell" type="text" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="pedimentoW" type="text" class="form-control">
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 text-right">
                                            <button onclick="obtenerEntradas()" type="submit" class="btn btn-primary"
                                                    id="buscarA">
                ...
                <div class="ibox-content">
                    <div style="width: 100%; text-align: center; margin-bottom: 50px;">
                        <div class="text-center">
                            <button id="importRL" type="button" class="btn btn-primary btn-sm permiso_registrar">
                                <i class="fa fa-file-excel-o"></i> Importar Entradas RL
                            </button>

                            <?php if ($instancia != 'welldex') { ?>
                                <button id="importExcelOC" type="button" class="btn btn-primary btn-sm"
                                        style="margin-left: 10px;">
                                    <i class="fa fa-file-excel-o"></i> Importar Entradas OC
                                </button>
                            <?php } ?>
                        </div>
            ...
            <span>
                <b style="font-size: 14px;">
                    Las entradas que se muestran al iniciar son de los últimos 7 días, use los filtros para buscar más entradas
                </b><br><br>
            </span>
                        </div>
                        ...
                        <div class="table-responsive" style="overflow-x: auto;">
                            <table id="entradasTable"
                                ...
                                <tr>
                                    ...
                                    <th>Tipo</th>
                                    <th>Numero OC</th>
                                    <th>Numero de Orden (ERP)</th>
                                    <th>Folio Entradas</th>
                                    <th>Factura | Remisión</th>
                                    <th>Proyecto</th>
                                    <th>Referencia Well</th>
                                    <th>Pedimento</th>
                                    <th>Fecha Recepcion</th>
                                    <th>Total Pedido (Pzas)</th>
                                    <th>Cantidad Recibida (Pzas)</th>
                                    <th>Peso Est. (Kgs)</th>
                                    <th>Fecha E. Solicitada</th>
                                    <th>Fecha Fin Recepcion</th>
                                    <th>Status</th>
                                    ...
                                    <th>Importe de la Entrada</th>
                                    <th>Area Solicitante</th>
                                    <th>Numero de Suficiencia</th>
                                    <th>Fecha de Suficiencia</th>
                                    <th>Fecha de Contrato</th>
                                    <th>Monto de Suficiencia</th>
                                    <th>Numero de Contrato</th>
                                    <th>Empresa</th>
                                    <th>envioSAP_disponible</th>
                                    <th>Proveedor</th>
                                    <th>ID_Protocolo</th>
                                </tr>
                                </thead>
                                <tbody id="entradasTableBody">
                                <!-- Contenido dinámico generado vía JS o backend -->
                                </tbody>
                            </table>
                        </div>
        ...
        <div class="modal-dialog vertical-align-center modal-lg" style="width: 80%;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button id="btn-enviarSAP" type="button" class="btn btn-primary">Enviar</button>
                    <!--funcion de import-->
...
<div class="modal inmodal" id="DetalleTransporte" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" style="width: 1000px;">
        <div class="modal-content animated bounceInRight">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <table class="table table-striped">
                        <tr>
                            <td><b>Nombre Operador: </b></td>
                            <td><input type="text" class="form-control input_transporte" readonly id="nombre_operador"
                                       value="0" style="background-color: transparent;text-align: right;"></td>
                            <td><b>ID Chofer: </b></td>
                            <td><input type="text" class="form-control input_transporte" readonly id="id_chofer"
                                       value="0" style="background-color: transparent;text-align: right;"></td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" class="form-control input_transporte" readonly id="num_unidad"
                                       value="0" style="background-color: transparent;text-align: right;"></td>
                            <td><b>Clave Transportadora:</b></td>
                            <td>
                                <select class="chosen-select form-control input_transporte" id="cve_transportadora"
                                        name="cve_transportadora" disabled style="background-color: transparent;">
                        ...
                        <tr>
                            <td><b>Placa: </b></td>
                            <td><input type="text" class="form-control input_transporte" readonly id="placa" value="0"
                                       style="background-color: transparent;text-align: right;"></td>
                            <td><b>Sello/Precinto: </b></td>
                            <td><input type="text" class="form-control input_transporte" readonly id="sello" value="0"
                                       style="background-color: transparent;text-align: right;"></td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="form-group" id="data_1">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control input_transporte" readonly
                                               id="fecha_transp"
                            ...
                            <td>
                                ...
                                <div class="form-group" id="data_H">
                                    <div class="input-group date">
                                        <input type="time" class="form-control input_transporte" readonly
                                               id="hora_transp" value="0"
                                               style="background-color: transparent;text-align: right;">
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="6"><textarea class="form-control input_transporte" readonly
                                                      style="background-color: transparent;" id="observaciones_transp"
                                                      rows='5'></textarea></td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="btnGuardarTransporte" style="display: none;">Guardar
                    <i class="fa fa-floppy-o" aria-hidden="true"></i></button>
                <button type="button" class="btn btn-primary" id="btnEditarTransporte">Editar <i
...
<div class="modal inmodal" id="DetalleEdicion" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" style="width: 500px;">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header" id="modaltitle">
                <a href="#" onclick="CerrarDetalleEdicion()">
                    <button type="button" class="close" data-dismiss="modal"><span
                                aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                </a>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <table class="table table-striped">
                        <tr>
                            <td><b>Pedimento: </b></td>
                            <td><input type="text" class="form-control input_edicion" readonly id="pedimentoW_edit"
                                       value="0" style="background-color: transparent;text-align: right;"></td>
                        </tr>
                        <tr>
                            <td><b>Referencia: </b></td>
                            <td><input type="text" class="form-control input_edicion" readonly id="referenciaW_edit"
                                       value="0" style="background-color: transparent;text-align: right;"></td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="btnGuardarEdicion" style="display: none;">Guardar <i
                            class="fa fa-floppy-o" aria-hidden="true"></i></button>
                <button type="button" class="btn btn-primary" id="btnEditarEdicion">Editar <i
                            class="fa fa-pencil-square-o" aria-hidden="true"></i></button>&nbsp;&nbsp;
                &nbsp;&nbsp;
                <a href="#" onclick="CerrarDetalleEdicion()">
                    <button type="button" class="btn btn-white" id="btnCancelEdit">Cerrar</button>
                </a>&nbsp;&nbsp;
                &nbsp;&nbsp;
            </div>
        </div>
...
<div class="modal inmodal" id="DetalleEdicionProyecto" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" style="width: 500px;">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header" id="modaltitle">
                <a href="#" onclick="CerrarDetalleEdicionProyecto()">
                    <button type="button" class="close" data-dismiss="modal"><span
                                aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                </a>
                <h4 class="modal-title">Editar Pedimento y Referencia</h4>
                <br>
                <h3>Folio Entrada: <span id="folio_ent2Proyecto"></span> | Folio OC: <span
                            id="folio_ent3Proyecto"></span></h3>
            </div>
            <div class="modal-body">

                <div class="form-group">
                    <label>Proyecto</label>
                    <select class="form-control input_edicionProyecto" name="claveproyectoEdicion"
                            id="claveproyectoEdicion" disabled>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="btnGuardarEdicionProyecto" style="display: none;">
                    Guardar <i class="fa fa-floppy-o" aria-hidden="true"></i></button>
                <button type="button" class="btn btn-primary" id="btnEditarEdicionProyecto">Editar <i
                            class="fa fa-pencil-square-o" aria-hidden="true"></i></button>&nbsp;&nbsp;
                &nbsp;&nbsp;
                <a href="#" onclick="CerrarDetalleEdicionProyecto()">
                    <button type="button" class="btn btn-white" id="btnCancelEditProyecto">Cerrar</button>
                </a>&nbsp;&nbsp;
                &nbsp;&nbsp;
            </div>
        </div>
        ...
        <div class="modal-dialog vertical-align-center">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="form-import" action="import" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <select class="form-control" id="almacenes" name="almacenes">
                                    ...
                                    <?php foreach ($listaAlma->getAll() as $a): ?>
                                        <option selected
                                                value="<?php echo $a->clave . '-' . $a->id; ?>"><?php echo "($a->clave) $a->nombre"; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                                ...
                                <select name="txtUsuario" id="txtUsuario" class="chosen-select form-control">
                                    ...
                                    <?php foreach ($usuarios as $usuario): ?>
                                        <?php if ($usuario->Activo == 1 && $usuario->cve_usuario == $_SESSION['cve_usuario']): ?>
                                            <option selected
                                                    value="<?php echo $usuario->cve_usuario; ?>"><?php echo "($usuario->cve_usuario) " . $usuario->nombre_completo; ?></option>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group"><label>Consecutivo de Protocolo</label>
                                <input id="Consecut" name="Consecut" type="text" placeholder="Consecutivo de Protocolo"
                                       class="form-control" readonly="readonly">
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md-6 form-group" <?php if ($instancia == 'welldex') echo "style='display:none;'"; ?>
                                 id="factura_remision_input"><label>Factura | Remisión</label>
                                <input id="factura_remision" name="factura_remision" type="text"
                                       placeholder="Factura|Remisión" class="form-control">
                            </div>

                            <div class="col-md-6 form-group" <?php if ($instancia == 'welldex') echo "style='display:none;'"; ?>
                                 id="factura_remision_input"><label>Tipo de Cambio</label>
                                <input id="tipo_cambio" name="tipo_cambio" type="number" min="0" class="form-control"
                                       value="1">
                            </div>
                        </div>
                        ...
                        <div class="checkbox">
                            <label for="palletizar_entrada"
                                   style="font-weight: 600;font-size: 14px; -moz-user-select: none; -webkit-user-select: none;-ms-user-select: none; user-select: none;">
                                <input type="checkbox" name="palletizar_entrada" id="palletizar_entrada" value="0">Palletizar
                                Entrada</label>
                        </div>

                        <div class="checkbox">
                            <label for="sobreescribir_existencias"
                                   style="font-weight: 600;font-size: 14px; -moz-user-select: none; -webkit-user-select: none;-ms-user-select: none; user-select: none;">
                                <input type="checkbox" name="sobreescribir_existencias" id="sobreescribir_existencias"
                                       value="0">Reemplazar Existencias</label>
                        </div>

                        <div class="checkbox"><?php //style="display: none;" ?>
                            <label for="convertir_a_oc"
                                   style="font-weight: 600;font-size: 14px; -moz-user-select: none; -webkit-user-select: none;-ms-user-select: none; user-select: none;">
                                <input type="checkbox" name="convertir_a_oc" id="convertir_a_oc" checked value="0">Registrar
                                Orden de Compra</label>
                        </div>

                        <div class="form-group" id="factura_oc_input"><label>Número de Orden | Cross Docking
                                (ERP)</label>
                            <input id="factura_oc" name="factura_oc" type="text" placeholder="Número de Orden"
                                   class="form-control">
                        </div>
                        ...
                        if ($instancia == 'welldex') {
                            ?>
                            <div class="row">
                                <div class="col-md-6 form-group" id="referencia_well_input"><label>Referencia
                                        Well</label>
                                    <input id="referencia_well" name="referencia_well" type="text"
                                           placeholder="Referencia Well" class="form-control">
                                </div>

                                <div class="col-md-6 form-group" id="pedimento_well_input"><label>Pedimento</label>
                                    <input id="pedimento_well" name="pedimento_well" type="text" placeholder="Pedimento"
                                           class="form-control">
                                </div>
                            </div>
                            <?php
                    ...
                    <div class="row" id="loadgif"
                         style="text-align: center;padding: 15px; display: none;font-size: 16px;top: 15px;position: relative;">
                ...
                <div class="modal-footer">
                    <div class="col-md-6" style="text-align: left">
                        <button id="btn-layoutRL" type="button" class="btn btn-primary">Descargar Layout</button>
                        <!--cambiar layout-->
                    </div>
                    <div class="col-md-6" style="text-align: right">
                        <button id="btn-importRL" type="button" class="btn btn-primary">Importar</button>
                        <!--funcion de import-->
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                    </div>
                </div>
    ...
    <div class="vertical-alignment-helper">
        <div class="modal-dialog vertical-align-center">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="form-importOC" action="import" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group"><label>Consecutivo de Protocolo</label>
                                <input id="ConsecutOC" name="ConsecutOC" type="text"
                                       placeholder="Consecutivo de Protocolo" class="form-control" readonly="readonly">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group" <?php if ($instancia == 'welldex') echo "style='display:none;'"; ?>
                                 id="factura_remision_inputOC"><label>Tipo de Cambio</label>
                                <input id="tipo_cambioOC" name="tipo_cambioOC" type="number" min="0"
                        ...
                        <div class="checkbox">
                            <label for="palletizar_entradaOC"
                                   style="font-weight: 600;font-size: 14px; -moz-user-select: none; -webkit-user-select: none;-ms-user-select: none; user-select: none;">
                                <input type="checkbox" name="palletizar_entradaOC" id="palletizar_entradaOC" value="0">Palletizar
                                Entrada</label>
                        </div>

                        <div class="checkbox">
                            <label for="sobreescribir_existenciasOC"
                                   style="font-weight: 600;font-size: 14px; -moz-user-select: none; -webkit-user-select: none;-ms-user-select: none; user-select: none;">
                                <input type="checkbox" name="sobreescribir_existenciasOC"
                                       id="sobreescribir_existenciasOC" value="0">Reemplazar Existencias</label>
                        </div>
                        <div class="checkbox">
                            <label for="registrar_soloOC"
                                   style="font-weight: 600;font-size: 14px; -moz-user-select: none; -webkit-user-select: none;-ms-user-select: none; user-select: none;">
                                <input type="checkbox" name="registrar_soloOC" id="registrar_soloOC" value="0">Registrar
                                solo OC</label>
                        </div>
                ...
                <div class="modal-footer">
                    <div class="col-md-6" style="text-align: left">
                        <button id="btn-layoutOC" type="button" class="btn btn-primary">Descargar Layout</button>
                        <!--cambiar layout-->
                    </div>
                    <div class="col-md-6" style="text-align: right">
                        <button id="btn-importOC" type="button" class="btn btn-primary">Importar</button>
                        <!--funcion de import-->
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <form id="form-subir-fotos-th" action="import" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="file" name="image_file_th" id="file_th" class="form-control"
                                   accept=".png, .PNG, .jpg, .JPG, .JPEG, .jpeg" required>
                            <br>
                            <input type="text" class="form-control" name="descripcion_foto" id="descripcion_foto"
                ...
                <div class="modal-body">
                    <form id="form-subir-fotos-td" action="import" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="file" name="image_file_td" id="file_td" class="form-control"
                                   accept=".png, .PNG, .jpg, .JPG, .JPEG, .jpeg" required>
                            <br><br>
                            <input class="form-control" name="descripcion_foto_td" id="descripcion_foto_td"
                                   placeholder="Descripción del Daño">
                            <br><br>
                            <button id="btn-fotos-td" type="button" class="btn btn-primary permiso_registrar">Subir Foto
        ...
        <div class="modal-dialog vertical-align-center">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-lp" action="import" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <select id="lista_lp" name="lista_lp[]" multiple size="10px" data-folio="" data-proveedor=""
                                    data-oc="" style="width: 100%;" placeholder="Todos">
                            </select>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    ...
                    <div class="col-md-6" style="text-align: right">
                        <button id="btn-lp" type="button" class="btn btn-primary" onclick="exportarPDFCodigoBarras()">
                            Imprimir Reporte
                        </button>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                    </div>
...
<script src="https://cdn.datatables.net/colreorder/2.0.4/js/ColReorder.js"></script>
...
<script>
// Inicializar los campos visibles con las fechas formateadas al cargar la página
document.addEventListener('DOMContentLoaded', function() {
    // Convertir fechas de DD-MM-YYYY a YYYY-MM-DD para los campos visibles
    document.getElementById('fechai_visible').value = convertirFormatoFecha('<?php echo $fecha_semana; ?>');
    document.getElementById('fechaf_visible').value = convertirFormatoFecha('<?php echo $fecha_actual; ?>');
});
...
<script type="text/javascript">
    ...
    function obtenerEntradas() {
        var session_data = <?php echo json_encode($_SESSION); ?>;
         session_data.permiso_consultar = $("#permiso_consultar").val();
        session_data.permiso_registrar = $("#permiso_registrar").val();
        session_data.permiso_editar = $("#permiso_editar").val();
        session_data.permiso_eliminar = $("#permiso_eliminar").val();
        session_data.valor_sap = <?php echo json_encode($ValorSAP); ?>;
        console.log(session_data);
        session_data=session_data;
        // Verifica si la tabla ya está inicializada
        if ($.fn.dataTable.isDataTable('#entradasTable')) {
            // Si ya está inicializada, solo recarga los datos sin destruir la tabla
            var table = $('#entradasTable').DataTable();

            // Actualiza la configuración del servidor (usando la URL y los filtros)
            table.ajax.url('https://wswms.assistpro-adl.com/api/entradas');

            // Actualiza los parámetros de la solicitud AJAX sin destruir el DataTable
            table.settings()[0].ajax.data = function (d) {
                d.search = $("#txtCriterio").val();
                d.refWell = $("#refWell").val();
                d.pedimentoW = $("#pedimentoW").val();
                d.filtro = $("#filtro").val();
                d.fechaInicio = $("#fechai").val();
                d.fechaFin = $("#fechaf").val();
                d.almacen = $("#almacen").val();
                d.status = $("#status").val();
                d.tipo_ent = $("#tipo_entrada").val();
                d.cve_cliente = $("#cve_cliente").val();
                d.presupuesto = $("#presupuestoSelect").val();
                d.session_data = session_data;
            };

            // Recarga los datos de la tabla sin perder la paginación, búsqueda, etc.
            table.ajax.reload();
        } else {

            // Si el DataTable no está inicializado, inicialízalo por primera vez
            $('#entradasTable').DataTable({
                serverSide: true,
                colReorder: true, // MOVIDO AQUÍ como opción principal del DataTable
                ordering: false, // Movido aquí a nivel principal
                ajax: {
                    url: 'https://wswms.assistpro-adl.com/api/entradas',
                    type: 'POST',
                    data: function (d) {
                        d.search = $("#txtCriterio").val();
                        d.refWell = $("#refWell").val();
                ...
                drawCallback: function (settings) {
                    ...
                    $('#totales').html('Total de Pedidos: ' + json.recordsTotal);
                },
                searching: false,
                paging: true,
                columnDefs: [
    ...
    $(document).ready(function(){
        // obtenerEntradas();
        //despues de 3 segundos se ejecuta la funcion
        setTimeout(function(){
            obtenerEntradas();
        }, 2000);
    });
    ...
    $(function ($) {
        ...
        function imageFormat(cellvalue, options, rowObject) {
            ...
            {
            ?>
            if (tipo == 'OC' && envioSAP_disponible > 0 && $("#permiso_registrar").val() == 1)
    ...
    $(function ($) {
        ...
        $(grid_selector).jqGrid({
            ...
            colModel: [
                ...
                {
                    name: 'factura_articulo',
                    index: 'factura_articulo',
                    width: 150,
                    editable: false,
                    sortable: false,
                    align: 'left'
            ...
            loadComplete: function (data) {
                console.log("SUCCESS DETALLE = ", data);
            },
    ...
    function loadResumen(codigo, oc) {
        ...
        console.log("2", oc);
        $('#grid-table2').jqGrid('clearGridData').jqGrid('setGridParam', {
            postData:
                {
                    action: 'loadResumen',
                    codigo: codigo,
    ...
    function loadDetalle(codigo, ordenCompra) {
        $('#grid-table3').jqGrid('clearGridData').jqGrid('setGridParam', {
            postData:
                {
                    action: 'loadDetalle',
                    codigo: codigo
    ...
    function loadBitacora(codigo) {
        $('#grid-table4').jqGrid('clearGridData').jqGrid('setGridParam', {
            postData:
                {
                    action: 'loadBitacora',
                    codigo: codigo
    ...
    ///////////////////////////////////////////////Funcion de Importar///////////////////////////////////////////////
    $('#btn-importRL').on('click', function () {
    ...
    $('#btn-fotos-th').on('click', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                setTimeout(
                    function () {
                        if (data.status == 200 && data.statusType == 1) {
                            swal("Exito", data.statusText, "success");
