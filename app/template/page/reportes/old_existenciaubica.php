...
*/
                        ...
                        body_content += `
                            <tr>
                                ...
                                <td style="border: 1px solid #ccc; text-align: center; font-size: 10px;">${(item.QA=='No')?(item.cantidad):('')}</td>
                                <td style="border: 1px solid #ccc; text-align: center; font-size: 10px;">${(item.RP!=0)?(item.RP):('')}</td>
                                <td style="border: 1px solid #ccc; text-align: center; font-size: 10px;">${(item.QA=='Si')?(item.cantidad):('')}</td>
