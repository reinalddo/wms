                    ...
                    <div class="row justify-content-center" style="display: none;">
                        ...
                        <div class="col-xs-12 col-md-2">
                            <div class="card">
                                ...
                                <div>
                                    <div class="title">Total Devolución:</div>
                                    <div class="amount"><span id="ttotalDev"></span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-12 col-md-2">
                            <div class="card">
                                ...
                                <div>
                                    ...
                                    <div class="amount"><span id="tcredito"></span></div>
                                </div>
                            </div>
                        </div>

                        <div class="col-xs-12 col-md-2">
                            <div class="card card_color_liq">
                                <div class="icon-container">
                                    <div class="icon"><i class="fa fa-credit-card"></i></div>
                                </div>
                                <div>
                                    <div class="title">Devoluciones:</div>
                                    <div class="amount"><span id="tdevoluciones"></span></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xs-12 col-md-2">
                            <div class="card card_color_liq">
                                ...
                                <div>
                                    <div class="title">Total a Liq:</div>
                                    <div class="amount"><span id="tliq"></span></div>
                                </div>
                            </div>
                        </div>
    ...
    $(function ($) {
        ...
        $(grid_selector_detalles).jqGrid({
            ...
            loadComplete: function (data) {
                ...
                //$('#grid-table-3').DataTable().columns.adjust().draw();
            },
            viewrecords: true
        });
// Setup buttons
    ...
    $(function ($) {
        ...
        $(grid_selector).jqGrid({
            ...
            loadComplete: function (data) {
                ...
                let totalDevoluciones = data.tdevoluciones;
                let totalOtrosPagos = data.totrospagos;
                let totalCobranza = data.tcobranza;
                let totalLiq = data.ttliq;
                let idsVenta = [];
                let idsVentaTipo = [];
                let idsFolio = [];
                if (data.total > 0) {
                    ...
                    console.log("data.rows.length = ", data.rows.length, " dataGrid.length = ", dataGrid.length);
                    for (let i = 0; i < data.rows.length; i++) {
                ...
                console.log("totalCobranza = ", totalCobranza);
                console.log("totalDevoluciones = ", totalDevoluciones);
                console.log("************************************");
                $("#tventa").text(totalVentas);
                $("#totrosdepositos").text(totalOtrosDepositos);
                $("#tefectivo").text(totalEfectivo);
                $("#tcontado").text(totalCobranza);
                ...
                $("#tdevoluciones").text(totalDevoluciones);
                $("#totrosdepositos").text(totalOtrosPagos);
                $("#tliq").text(totalLiq);
        ...
        function imageFormat(cellvalue, options, rowObject) {
            ...
            html += '<a class="btn btn-danger" href="/api/koolreport/export/reportes/ventas/ventas_sfa/?id_venta=' + id_venta + '&cve_cia=' + clave_cia + '&folio=' + folio+ '&ruta=' + ruta + '" target="_blank"><i class="fa fa-file-pdf-o" title="Reporte de Venta"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';
            ...
            */
            //if($(".sorting_1", this).empty())console.log('html VACIO', html);
            return html;
        }
    ...
    $("#generarExcel").click(function () {
        ...
        $(this).attr("href", "/listadeprecios/exportarsfa?almacen=" + almacen + "&ruta=" + ruta + "&diao=" + diao + "&operacion=" + operacion + "&fechaini=" + fechaini + "&fechafin=" + fechafin + "&clientes=" + clientes + "&articulos=" + articulos + "&articulos_obsq=" + articulos_obsq + "&tipoV=" + tipoV + "&criterio=" + criterio);
