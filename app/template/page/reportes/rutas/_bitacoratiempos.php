...
<div id="app" v-cloak>
  <h2 class="text-center">Bitacora de Tiempos</h2>
  <div>
...
<!--     <div class="d-inline selectBorder" v-if=" filtros.idProducto != undefined && filtros.idProducto != ''">
    ...
    <div class="d-inline selectBorder" v-if=" filtros.vendedor != undefined && filtros.vendedor !=''">
      <div class="d-inline">
        Vendedor: {{filtros.vendedor}} 
        <button class="btn btn-xs btn-danger br50" type="button" v-on:click="filtros.vendedor=''; buc_cobranza_vendedor = ''; test(filtros);"><i class="fa fa-times" aria-hidden="true"></i></button>
      </div>
    </div>
    <div class="d-inline selectBorder" v-if="filtros.nombreReponsable != undefined && filtros.nombreReponsable !=''">
      <div class="d-inline">
        Nombre: {{filtros.nombreReponsable}} 
    ...
    <div class="d-inline selectBorder" v-if=" filtros.nombreCliente != undefined && filtros.nombreCliente !=''">
      <div class="d-inline">
        Razon Social: {{filtros.nombreCliente}}
    ...
    <div class="d-inline selectBorder" v-if=" filtros.cDocumento != undefined && filtros.cDocumento !=''">
      <div class="d-inline">
        Documento: {{filtros.cDocumento}} 
        <button class="btn btn-xs btn-danger br50" type="button" v-on:click="filtros.cDocumento=''; buc_cobranza_cDocumento = ''; test(filtros);"><i class="fa fa-times" aria-hidden="true"></i></button>
      </div>
    </div>
    <div class="d-inline selectBorder" v-if=" filtros.tipoDocumento != undefined && filtros.tipoDocumento !=''">
      <div class="d-inline">
        TipoDoc: {{filtros.tipoDocumento}} 
        <button class="btn btn-xs btn-danger br50" type="button" v-on:click="filtros.tipoDocumento=''; buc_cobranza_tipoDoc = ''; test(filtros);"><i class="fa fa-times" aria-hidden="true"></i></button>
      </div>
    </div>
...
<!--         <div class="d-inline selectBorder">
          <div class="d-inline">
            Filtrado por Día operativo
            <button class="btn btn-xs btn-secondary br50" type="button" v-on:click="step = 0"><i class="fa fa-times" aria-hidden="true"></i></button>
          </div>
        </div> -->
...
<!--       <div>
  ...
  <!-- Filtro de Articulo -->
  <div class="row" v-if="mostarArticulo">
    <div class="col-md-2"></div>
    <div class="col-md-8">
      <div class="text-center h4 m-1">
      ...
      <button class="btn btn-info" @click="mostarArticulo = false;">
        <i class="fa fa-arrow-left" aria-hidden="true"></i> Regresar
      </button>
      <div class="listado">
        <div>
                ...
                <table class="table table-striped table-sm text-center">
                  ...
                  <tbody>
                    <tr v-for="arti in articulos" >
                      ...
                      <td>
                        <div class="btn btn-sm btn-primary" style="margin:2px;" v-on:click="selectArticulo(arti.cve_articulo); mostarArticulo = false;">
                          Seleccionar
                        </div>
                      </td>
                    </tr>
...
<!--         <div class="col-md-2 p-0">
          <div>Articulo</div>
          <button class="btn btn-primary" @click=" mostarArticulo = true; buscarArticulos();">Seleccionar Articulo</button>
...
<!--           <input type="number" class="form-control" placeholder="" id="buc_venta_Cliente_venta" v-model="buc_venta_Cliente_venta"> -->
        ...
        <div class="col-md-2 p-0">
          <div>Vendedor</div>
          <input type="text" class="form-control" placeholder="" id="buc_cobranza_vendedor" v-model="buc_cobranza_vendedor">
        </div>
        <div class="col-md-2 p-0" >
          <div>Nombre</div>
        ...
        <div class="col-md-2 p-0">
          <div>Documento</div>
          <input type="text" class="form-control" placeholder="" id="buc_cobranza_cDocumento" v-model="buc_cobranza_cDocumento">
        </div>
        <div class="col-md-2 p-0">
          <div>Tipo Doc</div>
          <input type="text" class="form-control" placeholder="" id="buc_cobranza_tipoDoc" v-model="buc_cobranza_tipoDoc">
        </div>
        <div class="col-md-2 p-0">
          <div>Fechas:</div>
          <select class="form-control" id="buc_cobranza_fechas" v-model="buc_cobranza_fechas">
            <option value="" selected >Todas</option>
            <option value="fechaR">Fecha Registro</option>
            <option value="fechaV">Fecha Vencimiento</option>
          </select>
        </div>
        <div class="col-md-2 p-0">
          <div>Fecha Inicio</div>
...
<!--     <div class="col-md-2">Saldo Vencido <h2 class="totales">${{totales.saldoVencido}}</h2></div>
    <div class="col-md-2">Saldo Corriente <h2 class="totales">${{totales.saldoCorriente}}</h2></div>
    <div class="col-md-2">Saldo Actual <h2 class="totales">${{totales.saldoActual}}</h2></div> -->
    
    
    <div class="row">
    <div class="col-md-3 mt-g">    
      <h3>Efectividad % </h3>
      
		
		</div>
    
    <div class="col-md-3 mt-g pd-left"> 
      <h3>Totales Pedidos/Entregas </h3>
      <div class="mt-1">Pedidos/Entregas total:</div>
      <div class="input-group mt-1">
        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
      </div>
      <div class="mt-1">Pedidos/Entregas contado:</div>
      <div class="input-group mt-1">
        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
      </div>
      <div class="mt-1">Pedidos/Entregas crédito:</div>
      <div class="input-group mt-1">
        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
      </div>
      <div class="mt-1">Devoluciones:</div>
      <div class="input-group mt-1">
        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
      </div>
    ...
    <div class="col-md-3 mt-g pd-left"> 
      ...
      <div class="mt-1">Ventas total:</div>
      <div class="input-group mt-1">
        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
      </div>
      <div class="mt-1">Ventas contado:</div>
      <div class="input-group mt-1">
        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
      </div>
      <div class="mt-1">Ventas crédito:</div>
      <div class="input-group mt-1">
        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
      </div>
      <div class="mt-1">Devoluciones:</div>
  ...
  <div class="row">
    <div class="col-md-2 mt-g">
      <h3>Pedidos/Entregas </h3>
      <div class="mt-1">Cajas:</div>
      <div class="input-group mt-1">
        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
      </div>
      <div class="mt-1">Piezas:</div>
      <div class="input-group mt-1">
        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-md-6 mt-g pd-left">
      <div class="mt-1">Consumo Promedio Por cliente(Venta total/Clientes con Vta)</div>
      <div class="input-group mt-1">
        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
      </div>
      <div class="mt-1">Efectividad en visitas(Prog. Realizadas / Programadas)</div>
      <div class="input-group mt-1">
        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" placeholder="%">
      </div>
    </div>
    <div class="col-md-6 mt-g pd-left">
      <div class="mt-1">Efectividad de la Venta (Ctes. Prog. con Vta./Prog. Realizadas):</div>
      <div class="input-group mt-1">
        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" placeholder="%">
      </div>
    </div>
        ...
        <div>
          <div class="row">
            <form v-on:submit.prevent="">
              ...
              <div class="col-md-6 p-0">
                <div>Sin Vta/Ped/Ent: </div>
                <input type="text" class="form-control" placeholder="" >
              </div>
              <div class="col-md-6 p-0">
                <div>Programadas realizadas:</div>
                <input type="text" class="form-control" placeholder="" >
              </div>
              <div class="col-md-6 p-0">
                <div>Clientes con Vta/Ped/Ent: </div>
                <input type="text" class="form-control" placeholder="" >
              </div>
              <div class="col-md-6 p-0">
                <div>Realizadas no repetidas:</div>
                <input type="text" class="form-control" placeholder="" >
              </div>
              <div class="col-md-6 p-0">
                <div>Prog. con Vta/Ped/Ent: </div>
                <input type="text" class="form-control" placeholder="" >
              </div>
              <div class="col-md-6 p-0">
                <div>No Programadas:</div>
                <input type="text" class="form-control" placeholder="" >
              </div>
              <div class="col-md-6 p-0">
                <div>No Prog con Vta/Ped/Ent: </div>
                <input type="text" class="form-control" placeholder="" >
              </div>
          ...
          <table class="table table-striped table-sm text-center">
            <thead>
              <tr>
                ...
                <td>
                  <div>Tiempo traslado</div>
                </td>
                <td>
                  <div>Tiempo Servicio</div>
                </td>
                <td>
                  <div>Ruta</div>
                </td>
            ...
            <tbody>
              <tr v-for="ve in ventas" >
                <td>
                  <div>{{ve.codigo}}<br>{{ve.idVenta}}</div>
                </td>
                <td>
                  <div>{{ve.diaOpB}}</div>
                </td>
                <td>
                  <div>{{ve.descripcion}}</div>
                </td>
<!--                 
                ...
                <td>
                  <div>{{ve.tiempoTraslado}}</div>
                </td>
                <td>
                  <div>{{ve.tiempoServicio}}</div>
                </td>
                <td>
                  <div>{{ve.rutaName}}</div>
                </td>
...
<script>
  ...
  window.app = new Vue({
    ...
    data: {
      ...
      buc_cobranza_vendedor:"",
      buc_cobranza_fechas:"",
      buc_cobranza_tipoDoc:"",
      buc_cobranza_cDocumento:"",
    ...
    methods:
    {
      ...
      eliminarBurbujas:function()
      {
        ...
        this.buc_cobranza_vendedor = '',  
        this.filtros.cDocumento = '',
        this.buc_cobranza_cDocumento = '',  
        this.filtros.tipoDocumento = '', 
        this.buc_cobranza_tipoDoc = '',   
      ...
      {
        this.$api(API_URL,{queryName:"reporteBitacoraTiempo",data:{params},debug:true},"testSuccess");
      },
...
//           ruta_id:this.selected.ruta.ID_Ruta,
        ...
        this.$api(API_URL,{queryName:"getDiaOperativoBitacora",data:data,debug:true},"buscarDiaOperativoSuccess");
...
//         this.step = 2;
      ...
      selectVendedor: function(id)
      {
        this.filtros.vendedor = id;
        this.test(this.filtros);
        this.$forceUpdate();
        this.addFiltro = false;
        //this.step = 2;
...
//         }
        ...
        if(this.buc_cobranza_vendedor !='')
        {
          this.filtros.vendedor = this.buc_cobranza_vendedor;  
          
        }
        else
        {
          delete this.filtros.vendedor;
        }
        if(this.buc_cobranza_tipoDoc !='')
        {
          this.filtros.tipoDocumento = this.buc_cobranza_tipoDoc;  
          
        }
        else
        {
          delete this.filtros.tipoDocumento;
        }
        if(this.buc_cobranza_cDocumento !='')
        {
          this.filtros.cDocumento = this.buc_cobranza_cDocumento;  
          
        }
        else
        {
          delete this.filtros.cDocumento;
        }
        if(this.buc_cobranza_fechas !='')
        {
          this.filtros.fechasRV = this.buc_cobranza_fechas;  
          
        }
        else
        {
          delete this.filtros.fechasRV;
        }
