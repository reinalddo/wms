        ...
        <div class="modal-content">
            <div class="modal-body" style="text-align: center;">
                ...
                */
                ?>
                <br>
                <h3 > <?php /* ?><b>Operación:</b> <span id="val_operacion"></span> |<?php */ ?> <b>Sucursal:</b> <span id="val_sucursal"></span> | <b>Día Operativo:</b> <span id="dia_operativo"></span> | <b>Ruta:</b> <span id="val_ruta"></span> <?php /* ?> | <b>Vendedor:</b> <span id="val_vendedor"></span><?php */ ?></h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                                <a href="#" id="generarExcel" class="btn btn-primary" style="margin: 10px;">
                                    <span class="fa fa-file-excel-o"></span> Generar Reporte de Liquidación
                                </a>
                        </div>
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            colModel: [
                {name: 'myac',index: '',width: 80,fixed: true,sortable: false,resize: false,formatter: imageFormat, hidden: true},//0
                ...
                {name: 'fecha',index: 'fecha',width: 100,editable: false,sortable: false, align: 'center',hidden: true},//5
                ...
                {name: 'nombre_comercial',index: 'nombre_comercial',width: 150,editable: false,sortable: false,hidden: true},//10
                ...
                {name: 'cajas_total',index: 'cajas_total',width: 80,editable: false,sortable: false, align: 'right'},//20
                {name: 'piezas_total',index: 'piezas_total',width: 80,editable: false,sortable: false, align: 'right'},//21
