                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                                ...
                                <button type="submit" id="generarExcel" class="btn btn-primary" style="margin: 10px;" disabled>
                                    <span class="fa fa-file-excel-o"></span> Generar Reporte de Visitas sin Ventas
                                </button>
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            mtype: 'POST',
            colNames: ["Acciones", 'Fecha', 'Ruta','Cliente', 'Nombre Cliente', 'Motivo No Venta'],
            colModel: [
                {name: 'myac',index: '',width: 80,fixed: true,sortable: false,resize: false,formatter: imageFormat, hidden: true},//0
                {name: 'fecha',index: 'fecha',width: 80,editable: false,sortable: false,align: 'center'},//1
                {name: 'ruta',index: 'ruta',width: 80,editable: false,sortable: false, align: 'left'},//2
                {name: 'cliente',index: 'cliente',width: 100,editable: false,sortable: false, align: 'left'},//3
                {name: 'nombrecliente',index: 'nombrecliente',width: 200,editable: false,sortable: false, align: 'left'},//4
                {name: 'motivo',index: 'motivo',width: 350,editable: false,sortable: false, align: 'left'},//5
            ],
            rowNum: 30,
            rowList: [30, 40, 50],
            pager: pager_selector,
...
*/
        ...
        $("#generarExcel").click(function(){
            ...
            console.log("almacen =", $("#almacenes").val());
            console.log("/api/koolreport/excel/visitas_sin_venta/export.php?almacen="+almacen+"&ruta="+ruta+"&diao="+diao+"");
            $(this).attr("href", "/api/koolreport/excel/visitas_sin_venta/export.php?almacen="+almacen+"&ruta="+ruta+"&diao="+diao);
