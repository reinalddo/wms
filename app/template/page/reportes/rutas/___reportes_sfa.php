...
?>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select" id="articulos_obsq_list" name="articulos_obsq_list">
                                    <option value="">Seleccione Artículo</option>
                                    <?php 
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div id="busqueda">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="txtCriterio" style="margin: 10px 10px  10px 0;" id="txtCriterio" placeholder="Id Venta, Folio, Cliente, Vendedor...">
                                    <div class="input-group-btn">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            colModel: [
                ...
                {name: 'clienteD',index: 'clienteD',width: 100,editable: false,sortable: false, align: 'right', hidden: true},//8
                ...
                {name: 'abono',index: 'abono',width: 100,editable: false,sortable: false, align: 'right', hidden: true},//19
                {name: 'saldofinal',index: 'saldofinal',width: 100,editable: false,sortable: false, align: 'right', hidden: true},//20
            ...
            loadComplete: function(data){
                ...
                if($("#txtCriterio").val() == 'SQL0000WMS')
                {
                    console.log("SQL: ", data.sql);
                    console.log("SQL Conteos: ", data.sql_conteos);
                }

                $("#tventa").text(data.tventa);
                $("#totrosdepositos").text(data.totrosdepositos);
                $("#tefectivo").text(data.tefectivo);
                $("#tcredito").text(data.tcredito);
                $("#tcontado").text(data.tcontado);
...
*/
        ...
        $("#LimpiarFiltros").click(function(){
            ...
            $("#rutas_list").val(""); $("#rutas_list").trigger("chosen:updated");
            $("#diao_list").val(""); $("#diao_list").trigger("chosen:updated");
            $("#agentes_list").val(""); $("#agentes_list").trigger("chosen:updated");
            $("#operacion_list").val(""); $("#operacion_list").trigger("chosen:updated");
            $("#clientes_list").val(""); $("#clientes_list").trigger("chosen:updated");
            $("#fechaini").val(""); $("#fechaini").trigger("chosen:updated");
            $("#fechafin").val(""); $("#fechafin").trigger("chosen:updated");
            $("#articulos_list").val(""); $("#articulos_list").trigger("chosen:updated");
            $("#articulos_obsq_list").val(""); $("#articulos_obsq_list").trigger("chosen:updated");
            $("#tipo_list").val(""); $("#tipo_list").trigger("chosen:updated");
        ...
        $("#generarExcel").click(function(){
            ...
            console.log("diao =", $("#diao_list").val());
            console.log("almacen =", $("#almacenes").val());
            console.log("/api/koolreport/excel/ventas_sfa/export.php?almacen="+almacen+"&ruta="+ruta+"&diao="+diao+"&operacion="+operacion+"&fechaini="+fechaini+"&fechafin="+fechafin+"&clientes="+clientes+"&articulos="+articulos+"&articulos_obsq="+articulos_obsq+"&tipoV="+tipoV);
