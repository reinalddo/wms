    ...
    <div class="modal-dialog modal-lg" style="width: 1200px">
        <div class="modal-content">
            <div class="modal-body" style="text-align: center;">
                ...
                <h3 class="modal-title simple">Cliente: (<span id="num_cliente"></span>) - <span id="cod_responsable"></span></h3>
                <h3 class="modal-title grupo">Cliente: (<span id="num_cliente_g"></span>) - <span id="cod_responsable_g"></span></h3>
                <input type="hidden" name="id_dest_cliente" id="id_dest_cliente" value="">

                <br>
                <h3 class="simple" ><b>Operación:</b> <span id="val_operacion"></span> | <b>Sucursal:</b> <span id="val_sucursal"></span> | <b>Día Operativo:</b> <span id="dia_operativo"></span> | <b>Ruta:</b> <span id="val_ruta"></span> | <b>Vendedor:</b> <span id="val_vendedor"></span></h3>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-2"><button type="button" id="btn-aplicar-pago-grupo" class="btn btn-primary" style="margin-top: 20px;display: none;"><i class="fa fa-check" aria-hidden="true"></i> Aplicar Pagos</button></div>
                </div>
                <br><br>
            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    ...
                    -->
                        ...
                        <br>
                        <input type="button" class="btn btn-primary" name="aplicar-pago-grupo" id="aplicar-pago-grupo" value="Aplicar Pagos de Cliente">
                    </div>
                </div>
            </div>
        </div>
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            colModel: [
                ...
                {name: 'cliente',index: 'cliente',width: 100,editable: false,sortable: false, align: 'right', hidden: true},//8
                ...
                {name: 'importe',index: 'importe',width: 100,editable: false,sortable: false, align: 'right', hidden: true},//15
                {name: 'iva',index: 'iva',width: 100,editable: false,sortable: false, align: 'right', hidden: true},//16
                {name: 'descuento',index: 'descuento',width: 100,editable: false,sortable: false, align: 'right', hidden: true},//17
                ...
                {name: 'cajas_total',index: 'cajas_total',width: 80,editable: false,sortable: false, align: 'right', hidden: true},//21
                {name: 'piezas_total',index: 'piezas_total',width: 80,editable: false,sortable: false, align: 'right', hidden: true},//22
                {name: 'PromoC',index: 'PromoC',width: 80,editable: false,sortable: false, align: 'right', hidden: true},//23
                {name: 'PromoP',index: 'PromoP',width: 80,editable: false,sortable: false, align: 'right', hidden: true},//24
                {name: 'ObseqC',index: 'ObseqC',width: 80,editable: false,sortable: false, align: 'right', hidden: true},//25
                {name: 'ObseqP',index: 'ObseqP',width: 80,editable: false,sortable: false, align: 'right', hidden: true},//26
                ...
                {name: 'promociones',index: 'promociones',width: 120,editable: false,sortable: false, align: 'right', hidden: true},//30
                {name: 'tienepromo',index: 'tienepromo',width: 120,editable: false,sortable: false, align: 'right', hidden: true},//31
                {name: 'limite_credito',index: 'limite_credito',width: 120,editable: false,sortable: false, align: 'right', hidden: false}//32
            ],
            rowNum: 30,
            rowList: [30, 40, 50],
            pager: pager_selector,
...
*/
        ...
        function imageFormat(cellvalue, options, rowObject) 
        {
            ...
            var html = '';
            html = '<a href="#" onclick="ver(\''+id_venta+'\', \''+folio+'\', \''+id_destinatario+'\', \''+cliente+'\', \''+responsable+'\', \''+operacion+'\', \''+sucursal+'\', \''+dia_operativo+'\', \''+ruta+'\', \''+vendedor+'\', \''+tienepromo+'\', \''+saldo_restante+'\', \''+limite_credito+'\', \''+total+'\')"><i class="fa fa-search" title="Ver Detalles"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';
            ...
            html += '<input type="checkbox" class="checkbox-asignator" id="'+folio+'" data-idcliente="'+cliente+'" value="'+id_venta+'" />';
...
*/
        ...
        $("#aplicar-pago-grupo").click(function(){
          ...
          $("input[type=checkbox].checkbox-asignator").each(function(i, e){
            ...
            if($(this).is(":checked"))
            {
                ...
                {
                    if(mismo_cliente != "") {swal("Clientes Diferentes", "Las ventas seleccionadas deben ser de un mismo cliente", "error"); mensaje_diferentes = true; return;}
                    else 
                        folios.push("'"+folio+"'");
    ...
    function ver(id, folio, id_destinatario, cliente, responsable, operacion, sucursal, dia_operativo, ruta, vendedor, tienepromo, saldo_restante, limite_credito, total)
    {
        if(id) 
