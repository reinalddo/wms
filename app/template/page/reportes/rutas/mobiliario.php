...
<div class="wrapper wrapper-content  animated fadeInRight" id="form-prin">
    <h3>Control de Mobiliario | Activo Fijo</h3>
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox ">
...
<script>
    ...
    $(function($) 
    {
        ...
        $(grid_selector).jqGrid(
        {
            ...
            mtype: 'POST',
            colNames: ['ID','Acciones', 'Folio Doc','Fecha', 'Clave', 'Descripción', 'Marca', 'Modelo', 'Serie', 'Status', 'Tipo', 'Clave Cliente','Cliente','Razón Social','Responsable','Fecha Consignación','Días en Prestamo','Autorizó'],
            colModel: [
                ...
                {name: 'marca',index: 'marca',width: 100,editable: false,sortable: false, align:"center"}, 
                {name: 'modelo',index: 'modelo',width: 100,editable: false,sortable: false, align:"center"}, 
                {name: 'serie',index: 'serie',width: 100,editable: false,sortable: false, align:"center"}, 
