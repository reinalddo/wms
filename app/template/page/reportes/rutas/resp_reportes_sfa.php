    ...
    $(function ($) {
        ...
        $(grid_selector).jqGrid({
            ...
            loadComplete: function (data) {
                ...
                $("#tventa").text(totalVentas.toFixed(2));
                $("#totrosdepositos").text(totalOtrosDepositos.toFixed(2));
                $("#tefectivo").text(totalEfectivo.toFixed(2));
                $("#tcontado").text(totalContado.toFixed(2));
                $("#tcredito").text(totalCredito.toFixed(2));
                $("#timporte").text(importeTotal.toFixed(2));
                $("#tiva").text(ivaTotal.toFixed(2));
                $("#tdescuento").text(descuentoTotal.toFixed(2));
                $("#ttotal").text(totalTotal.toFixed(2));
