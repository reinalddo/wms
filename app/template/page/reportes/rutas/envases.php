            ...
            <div class="ibox ">
                <div class="ibox-title">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select" id="rutas_list" name="rutas_list">
                                    ...
                                    <?php 
                                    foreach( $listaRuta->getAllEnvases($cve_almacen) AS $r ): 
                                    ?>
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <label for="tipo_dev_envase">Operación:</label> 
                                <select class="form-control chosen-select" id="tipo_dev_envase" name="tipo_dev_envase">
                                    <option value="">Seleccione Operación</option>
                                    <option value="Venta">Venta</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <a href="#" id="generarReporte" class="btn btn-primary" style="margin: 10px;" disabled>
                                <span class="fa fa-file-excel-o"></span> Generar Reporte de Envases
                            </a>
                        </div>
                    ...
                    <div class="row text-center">
                        <div class="col-sm-1">
                            <div class="form-group" style="display: none;">
                                <label>Venta</label>
                                <input style="text-align:center;" id="plibre" class="form-control" disabled style="margin-left: 10px">
                            </div>
                        </div>
                        <div class="col-sm-1">
                            <div class="form-group" style="display: none;">
                                <label>Promoción</label>
                                <input style="text-align:center;" id="pocupado" class="form-control" disabled style="margin-left: 10px">
                            </div>
                        </div>
                        <div class="col-sm-1">
                            <div class="form-group">
                                <label>Plástico</label>
                                <input style="text-align:center;margin-left:8px;" id="envplastico" class="form-control" disabled style="margin-left: 10px">
                            </div>
                        </div>
                        <div class="col-sm-1">
                            <div class="form-group" style="display: none;">
                                <label>Total</label>
                                <input style="text-align:center;" id="ptotal" class="form-control" disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-1">
                            <div class="form-group" style="display: none;">
                                <label>Venta</label>
                                <input style="text-align:center;" id="clibre" class="form-control" disabled >
                            </div>
                        </div>
                        <div class="col-sm-1">
                            <div class="form-group" style="display: none;">
                                <label>Promoción</label>
                                <input style="text-align:center;" id="cocupado" class="form-control" disabled>
                            </div>
                        </div>
                        <div class="col-sm-1">
                            <div class="form-group">
                                <label>Cristal</label>
                                <input style="text-align:center;margin-left:8px;" id="envcristal" class="form-control" disabled>
                            </div>
                        </div>
                        <div class="col-sm-1">
                            <div class="form-group" style="display: none;">
                                <label>Total</label>
                                <input style="text-align:center;" id="ctotal" class="form-control" disabled >
                            </div>
                        </div>     
                        ...
                        <div class="col-sm-1">
                            <div class="form-group" style="display: none;">
                                <label>Venta</label>
                                <input style="text-align:center;" id="plibre" class="form-control" disabled >
                            </div>
                        </div>
                        <div class="col-sm-1">
                            <div class="form-group" style="display: none;">
                                <label>Promoción</label>
                                <input style="text-align:center;" id="pocupado" class="form-control" disabled>
                            </div>
                        </div>
                        <div class="col-sm-1">
                            <div class="form-group">
                                <label>Garrafón</label>
                                <input style="text-align:center;margin-left:8px;" id="envgarrafon" class="form-control" disabled>
                            </div>
                        </div>
                        <div class="col-sm-1">
                            <div class="form-group" style="display: none;">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            postData: {
                ...
                ruta: $("#rutas_list").val(),
                diao: $("#diao_list").val(),
                tipo_dev_envase: $("#tipo_dev_envase").val(),
                almacen: $("#almacenes").val(),
                action: 'getEnvases'

            },
            mtype: 'POST',
            colNames: ["Acciones", 'Id Venta', 'Fecha', 'Ruta', 'Operación', 'DiaO','Folio', 'Cliente', 'Nombre Comercial', 'Envase', 'Cantidad', 'Tipo Envase'],
            colModel: [
                {name: 'myac',index: 'myac',width: 80,fixed: true,sortable: false,resize: false, hidden: true,formatter: imageFormat},//0
                {name: 'ID_Venta',index: 'ID_Venta',width: 70,editable: false,sortable: false,hidden: true, align: 'right'},//1
                {name: 'fecha',index: 'fecha',width: 100,editable: false,sortable: false, align: 'center'},//2
                ...
                {name: 'dia_o',index: 'dia_o',width: 50,editable: false,sortable: false, align: 'right'},//5
                {name: 'folio',index: 'folio',width: 100,editable: false,sortable: false},//6
                {name: 'cliente',index: 'cliente',width: 100,editable: false,sortable: false, align: 'right'},//7
                {name: 'nombre_comercial',index: 'nombre_comercial',width: 150,editable: false,sortable: false},//8
                {name: 'envase',index: 'envase',width: 120,editable: false,sortable: false},//9
                {name: 'cantidad',index: 'cantidad',width: 120,editable: false,sortable: false, align: 'right'},//10
                {name: 'tipo_envase',index: 'tipo_envase',width: 120,editable: false,sortable: false}//11
            ],
            rowNum: 30,
            rowList: [30, 40, 50],
            pager: pager_selector,
            sortname: 'ID_Venta',
            viewrecords: true,
            loadError: function(data){console.log("ERROR 8: ", data);},
            sortorder: "desc",
...
*/
        ...
        {
            console.log("rowObject = ", rowObject, " options = ", options, " cellvalue = ", cellvalue);
            var id_venta = rowObject["ID_Venta"];
            var clave_cia = <?php echo $_SESSION['cve_cia']; ?>;
            var folio = rowObject["folio"],
                cliente = rowObject["cliente"],
                responsable = rowObject["nombre_comercial"],
                operacion = rowObject["Operacion"],
                dia_operativo = rowObject["dia_o"],
                ruta = rowObject["ruta"],
            ...
            html += '<a href="/api/koolreport/export/reportes/ventas/envases/?id_venta='+id_venta+'&cve_cia='+clave_cia+'&folio='+folio+'&cliente='+cliente+'&responsable='+responsable+'&operacion='+operacion+'&dia_operativo='+dia_operativo+'&ruta='+ruta+'&fecha='+fecha+'&envase" target="_blank"><i class="fa fa-file-pdf-o" title="Reporte de Envases"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';
/*
...
*/
        ...
        {
            if($(this).val() == '') $("#generarReporte").attr("disabled", "disabled"); else $("#generarReporte").removeAttr("disabled");
    ...
    $("#generarReporte").click(function () {
        ...
        if($("#rutas_list").val() == "")
        {
            swal("Aviso", "Debe Seleccionar un Ruta para generar el Reporte de Envases", "warning");
            return;
        }
        ...
        console.log("almacen =", $("#almacenes").val());
        console.log("/api/koolreport/export/reportes/ventas/envases/?almacen=" + almacen + "&ruta=" + ruta + "&diao=" + diao + "&operacion=" + operacion + "&cve_cia=" + cve_cia + "&criterio=" + criterio);

        $(this).attr("href", "/api/koolreport/export/reportes/ventas/envases/?almacen=" + almacen + "&ruta=" + ruta + "&diao=" + diao + "&operacion=" + "&cve_cia=" + cve_cia + operacion + "&criterio=" + criterio);
    });
