...
$clientes_venta = new \Clientes\Clientes();
                ...
                <div class="ibox-title">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select" id="clientes_list" name="clientes_list">
                                    ...
                                    <?php 
                                    foreach( $clientes_venta->getClientesVentas($_SESSION['cve_almacen']) AS $ch ): 
                                    ?>
                                    <option value="<?php echo $ch->CodCliente; ?>"><?php echo $ch->CodCliente." - ( ".$ch->Cve_Clte." ) - ".$ch->Nombre; ?></option>
                                    <?php endforeach; ?>
                        ...
                        <div class="col-sm-2" style="display: none;">
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select" id="agentes_list" name="agentes_list">
                                    ...
                                    foreach( $vendedores->getAllVendedor() AS $ch ): 
                                    ?>
                                    <option value="<?php echo $ch->id_user; ?>"><?php echo "( ".$ch->cve_usuario." ) - ".$ch->nombre_completo; ?></option>
                                    <?php endforeach; ?>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div id="busqueda">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="txtCriterio" style="margin: 10px;" id="txtCriterio" placeholder="Id Venta, Folio, Cliente, Vendedor...">
                                    <div class="input-group-btn">
                    ...
                    -->
                        <div class="tab-content">
                            <div class="tab-pane active" id="panel-928563">
                                ...
                                <br>
                                <div class="jqGrid_wrapper">
                                    <table id="grid-table-envase"></table>
                                    <div id="grid-pager-envase"></div>
                                </div>
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            mtype: 'POST',
            colNames: ["Acciones", 'Id Venta', 'Fecha', 'Ruta', 'Operación', 'DiaO', 'F. Compromiso','Folio', 'Cliente', 'Responsable', 'Nombre Comercial', 'Status', 'Tipo', 'Método de Pago', 'Cantidad', 'Envase', 'Descuento', 'Total', 'Abono', 'Saldo Final', 'Total C', 'Total P', 'PromoC', 'PromoP', 'Obseq C', 'Obseq P', 'Vendedor', 'Ayudante 1', 'Ayudante 2', 'Promociones', 'Tiene Promoción', 'limite crédito'],
            colModel: [
                {name: 'myac',index: '',width: 80,fixed: true,sortable: false,resize: false,formatter: imageFormat},//0
                {name: 'ID_Venta',index: 'ID_Venta',width: 70,editable: false,sortable: false,hidden: true, align: 'right'},//1
                ...
                {name: 'Operacion',index: 'Operacion',width: 100,editable: false,sortable: false, hidden: true},//4
                {name: 'dia_o',index: 'dia_o',width: 50,editable: false,sortable: false, align: 'right'},//2
                {name: 'fechac',index: 'fechac',width: 100,editable: false,sortable: false, align: 'center', hidden: true},//6
                ...
                {name: 'nombre_comercial',index: 'nombre_comercial',width: 150,editable: false,sortable: false},//10
                {name: 'status',index: 'status',width: 80,editable: false,sortable: false},//11
                {name: 'tipo',index: 'tipo',width: 80,editable: false,sortable: false},//12
                {name: 'metodo_pago',index: 'metodo_pago',width: 110,editable: false,sortable: false},//13
                ...
                {name: 'descuento',index: 'descuento',width: 100,editable: false,sortable: false, align: 'right', hidden: true},//16
                {name: 'total',index: 'total',width: 100,editable: false,sortable: false, align: 'right'},//17
                {name: 'abono',index: 'abono',width: 100,editable: false,sortable: false, align: 'right'},//18
                {name: 'saldofinal',index: 'saldofinal',width: 100,editable: false,sortable: false, align: 'right'},//19
                {name: 'cajas_total',index: 'cajas_total',width: 80,editable: false,sortable: false, align: 'right', hidden: true},//20
                {name: 'piezas_total',index: 'piezas_total',width: 80,editable: false,sortable: false, align: 'right', hidden: true},//21
                {name: 'PromoC',index: 'PromoC',width: 80,editable: false,sortable: false, align: 'right', hidden: true},//22
                {name: 'PromoP',index: 'PromoP',width: 80,editable: false,sortable: false, align: 'right', hidden: true},//23
                {name: 'ObseqC',index: 'ObseqC',width: 80,editable: false,sortable: false, align: 'right', hidden: true},//24
                {name: 'ObseqP',index: 'ObseqP',width: 80,editable: false,sortable: false, align: 'right', hidden: true},//25
                ...
                {name: 'promociones',index: 'promociones',width: 120,editable: false,sortable: false, align: 'right', hidden: true},//29
                {name: 'tienepromo',index: 'tienepromo',width: 120,editable: false,sortable: false, align: 'right', hidden: true},//30
                {name: 'limite_credito',index: 'limite_credito',width: 120,editable: false,sortable: false, align: 'right', hidden: true}//31
            ],
            rowNum: 30,
            rowList: [30, 40, 50],
            pager: pager_selector,
        ...
        function imageFormat(cellvalue, options, rowObject) 
        {
            ...
            var folio = rowObject[7],
                ...
                total = rowObject[17],
                limite_credito = rowObject[31],
                vendedor = rowObject[26];

            var html = '';
            html = '<a href="#" onclick="ver(\''+id_venta+'\', \''+folio+'\', \''+cliente+'\', \''+responsable+'\', \''+operacion+'\', \''+sucursal+'\', \''+dia_operativo+'\', \''+ruta+'\', \''+vendedor+'\', \''+tienepromo+'\', \''+saldo_restante+'\', \''+limite_credito+'\', \''+total+'\')"><i class="fa fa-search" title="Ver Detalles"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';
            html += '<a href="/api/koolreport/export/reportes/ventas/ventas_sfa/?id_venta='+id_venta+'&cve_cia='+clave_cia+'&folio='+folio+'&cobranza" target="_blank"><i class="fa fa-file-pdf-o" title="Reporte de Cobranza"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';
/*
...
//*******************************************************************************************************************
//*******************************************************************************************************************
        var grid_selector = "#grid-table-envase";
        var pager_selector = "#grid-pager-envase";
        ...
        $(grid_selector).jqGrid({
            ...
            mtype: 'POST',
            colNames: ["Acciones", 'Id Venta', 'Fecha', 'Ruta', 'Operación', 'DiaO', 'F. Compromiso','Folio', 'Cliente', 'Responsable', 'Nombre Comercial', 'Status', 'Tipo', 'Método de Pago', 'Importe', 'IVA', 'Descuento', 'Total', 'Abono', 'Saldo Final', 'Env Plástico', 'Env Cristal', 'Env Garrafón', 'PromoP', 'Obseq C', 'Obseq P', 'Vendedor', 'Ayudante 1', 'Ayudante 2', 'Promociones', 'Tiene Promoción'],
            colModel: [
                {name: 'myac',index: '',width: 80,fixed: true,sortable: false,resize: false,formatter: imageFormat2},//0
                {name: 'ID_Venta',index: 'ID_Venta',width: 70,editable: false,sortable: false,hidden: true, align: 'right'},//1
                {name: 'fecha',index: 'fecha',width: 100,editable: false,sortable: false, align: 'center'},//5
                {name: 'ruta',index: 'ruta',width: 70,editable: false,sortable: false},//3
                {name: 'Operacion',index: 'Operacion',width: 100,editable: false,sortable: false, hidden: true},//4
                ...
                {name: 'importe',index: 'importe',width: 100,editable: false,sortable: false, align: 'right', hidden: true},//14
                {name: 'iva',index: 'iva',width: 100,editable: false,sortable: false, align: 'right', hidden: true},//15
                {name: 'descuento',index: 'descuento',width: 100,editable: false,sortable: false, align: 'right', hidden: true},//16
                {name: 'total',index: 'total',width: 100,editable: false,sortable: false, align: 'right', hidden: true},//17
                {name: 'abono',index: 'abono',width: 100,editable: false,sortable: false, align: 'right', hidden: true},//18
                {name: 'saldofinal',index: 'saldofinal',width: 100,editable: false,sortable: false, align: 'right', hidden: true},//19
                {name: 'cajas_total',index: 'cajas_total',width: 100,editable: false,sortable: false, align: 'right'},//20
                {name: 'piezas_total',index: 'piezas_total',width: 100,editable: false,sortable: false, align: 'right'},//21
                {name: 'PromoC',index: 'PromoC',width: 100,editable: false,sortable: false, align: 'right'},//22
                {name: 'PromoP',index: 'PromoP',width: 80,editable: false,sortable: false, align: 'right', hidden: true},//23
                {name: 'ObseqC',index: 'ObseqC',width: 80,editable: false,sortable: false, align: 'right', hidden: true},//24
                {name: 'ObseqP',index: 'ObseqP',width: 80,editable: false,sortable: false, align: 'right', hidden: true},//25
                {name: 'vendedor',index: 'vendedor',width: 120,editable: false,sortable: false, hidden: true},//26
...
/*
                ...
                $("#tobseqp").text(data.tobseqp);
*/
                $("#envplastico").val(data.envplastico);
                $("#envcristal").val(data.envcristal);
                $("#envgarrafon").val(data.envgarrafon);
            }
        });

        // Setup buttons
        $("#grid-table-envase").jqGrid('navGrid', '#grid-pager-envase', {
            edit: false,
            add: false,
            del: false,
            search: false
        ...
        function imageFormat2(cellvalue, options, rowObject) 
        {
            ...
            html += '<a href="/api/koolreport/export/reportes/ventas/ventas_sfa/?id_venta='+id_venta+'&cve_cia='+clave_cia+'&folio='+folio+'&envase" target="_blank"><i class="fa fa-file-pdf-o" title="Reporte de Venta"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';
/*
            html += '<a href="#" onclick="borrar(\'' + serie + '\')"><i class="fa fa-eraser" alt="Borrar"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';
            html += '<a href="#" onclick="select_clientes(\'' + clave_ruta + '\')"><i class="fa fa-times" alt="Eliminar Clientes Ruta" title="Eliminar Clientes Ruta"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';
            html += '<a href="#" onclick="select_transporte(\'' + clave_ruta + '\')"><i class="fa fa-truck" alt="Catálogo de Transportes" title="Catálogo de Transportes"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';
...
//*******************************************************************************************************************
        ...
        $("#diao_list, #operacion_list, #clientes_list, #agentes_list").change(function(){
        ...
        function ReloadGrid() 
        {
            ...
            $('#grid-table-envase').jqGrid('clearGridData')
                .jqGrid('setGridParam', {
                    postData: {
                        criterio: $("#txtCriterio").val(),
                        ruta: $("#rutas_list").val(),
