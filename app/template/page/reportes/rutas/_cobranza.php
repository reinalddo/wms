...
<div id="app" v-cloak>
  <h2 class="text-center">Reporte de Cobranza</h2>
  <div>
                ...
                <table class="table table-striped table-sm text-center">
                  ...
                  <tbody>
                    <tr v-for="dO in diasOp" >
                      ...
                      <td>
                        <div class="btn btn-sm btn-primary" style="margin:2px;" v-on:click="selectDiaO(dO.Id); mostrarDiaOp = false;" >
                          Seleccionar
                        </div>
                      </td>
                    </tr>
...
<script>
  ...
  window.app = new Vue({
    ...
    methods:
    {
      ...
      {
        this.$api(API_URL,{queryName:"reporteCobranza",data:{params},debug:true},"testSuccess");
      },
