...
<script type="text/javascript"
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCc_ej3xfMCxtyW7oYhgUIw8Rk_NK_ASR0"></script>
<script type="text/javascript">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-6 col-sm-4 col-md-3 col-lg-3">
                            <div class="card">
                                ...
                                <div>
                                    <div class="title">Clientes con Pedido o Venta</div>
                        ...
                        <div class="col-6 col-sm-4 col-md-3 col-lg-3">
                            <div class="card">
                                ...
                                <div>
                                    <div class="title">Clientes sin Venta o sin Pedido</div>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.status == "success") {
                    ...
                    console.log("No se pudo cargar la tabla");
                    /*
                    Swal.fire({
                        icon: 'error',
