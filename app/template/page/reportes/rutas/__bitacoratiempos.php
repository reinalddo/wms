    ...
    <div class="modal-dialog modal-lg" style="width: 1200px">
        <div class="modal-content">
            <div class="modal-body" style="text-align: center;">
                ...
                <br>
                <h3 ><b>Operación:</b> <span id="val_operacion"></span> | <b>Sucursal:</b> <span id="val_sucursal"></span> | <b>Día Operativo:</b> <span id="dia_operativo"></span> | <b>Ruta:</b> <span id="val_ruta"></span> | <b>Vendedor:</b> <span id="val_vendedor"></span></h3>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-2"><button type="button" id="btn-aplicar-pago" class="btn btn-primary" style="margin-top: 20px;"><i class="fa fa-check" aria-hidden="true"></i> Aplicar Pago</button></div>
                </div>
                <br><br>
            ...
            <div class="ibox ">
                <div class="ibox-title">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <button type="button" onclick="verGpsRutas()" class="btn btn-primary" id="visitas" data-toggle="modal" data-target="#visitasgps" style="margin-top: 24px;" disabled><span class="fa fa-map-marker"></span> Ver Visitas GPS</button>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4" style="display:none;">
                            <div id="busqueda">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="txtCriterio" style="margin: 10px;" id="txtCriterio" placeholder="Código, Descripción, Responsable, Cliente, Vendedor...">
                                    <div class="input-group-btn">
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            sortname: 'ID_Venta',
            viewrecords: true,
            loadError: function(data){console.log("ERROR 2: ", data);},
            sortorder: "desc",
        ...
        $(grid_selector_detalles).jqGrid({
            ...
            colModel:[
                ...
                {name:'promc',index:'promc',width:100, editable:false, sortable:false, align: 'right', hidden: true},
                {name:'promp',index:'promp',width:100, editable:false, sortable:false, align: 'right', hidden: true},
            ],
            rowNum:10,
            rowList:[10,20,30],
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            ...
            colModel: [
                ...
                {name: 'codigo',index: 'codigo',width: 100,editable: false,sortable: false,hidden: false, align: 'right'},//1
                ...
                {name: 'pila',index: 'pila',width: 100,editable: false,sortable: false, align: 'right', hidden: true}//20
            ],
            rowNum: 30,
            rowList: [30, 40, 50],
            pager: pager_selector,
            sortname: 'ID_Venta',
            viewrecords: true,
            loadComplete: function(data){console.log("SUCCESS BITACORA: ", data);},
            loadError: function(data){console.log("ERROR 1: ", data);},
            sortorder: "desc",
            /*loadComplete: function(data){
                console.log("Ventas: ", data);
