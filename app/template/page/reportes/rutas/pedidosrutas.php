            ...
            <div class="ibox ">
                <div class="ibox-title">
                    ...
                    <a href="#" id="generarExcelDescarga" class="btn btn-primary" style="margin: 10px;" >
                        <span class="fa fa-file-excel-o"></span>  Reporte de Pedidos por Ruta
                    </a>
                    <br>
...
*/
        ...
        function ReloadGrid() 
        {
            ...
            $('#grid-table').jqGrid('clearGridData')
                .jqGrid('setGridParam', {
                    ...
                    url: '/api/reportesRutas/lista/index_pedidosrutas.php',
                    datatype: 'json',
                    page: 1
                })
                .trigger('reloadGrid', [{
    ...
    $("#generarExcelDescarga").click(function(){
        ...
        $(this).attr("href", "/api/koolreport/excel/pedidosrutas/export.php?almacen="+almacen+"&ruta="+ruta+"&diao="+diao+"&fechaini="+fechaini+"&fechafin="+fechafin+"&criterio="+criterio);
