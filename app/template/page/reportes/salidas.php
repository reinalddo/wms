...
almacenPrede();
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            url:'/api/reportes/lista/salidas.php',
            datatype: 'local',
            shrinkToFit: false,
            height:'auto',
            mtype: 'POST',
            colNames:[ 'Acciónes', 'Folio', 'Fecha', 'Tipo Salida', 'Motivo','Usuario','Status','Folio REF', 'Proveedor', 'Cliente'],
            colModel:[
            {name:'accion',index:'accion', align:'left', width:100, fixed:true, sortable:false, resize:false, formatter: getActions},
            {name:'folio',index:'folio', align:'left', editable:false, sortable:false,width:120},
            {name:'fecha',index:'fecha', align:'center', editable:false, sortable:false,width:150},
            {name:'tipo_salida',index:'tipo_salida',  sortable:false,width:220, align:"left", hidden: true},
            {name:'motivo',index:'motivo',  sortable:false,width:120, align:"left"},
            {name:'usuario',index:'usuario',  sortable:false,width:100, align:"left"},
            {name:'status',index:'status', editable:false, sortable:false,width:150,align:"left"},
            {name:'folio_ref',index:'folio_ref', editable:false, sortable:false,width:120,align:"left"},
            {name:'proveedor',index:'proveedor', editable:false, sortable:false,width:200,align:"left"},
            {name:'cliente',index:'cliente', editable:false, sortable:false,width:200,align:"left"},
            ],
            rowNum:30,
            rowList:[30,40,50],
...
*/
    ...
    function ReloadGrid() 
    {
        ...
        console.log("tipo_salida = ", $("input[name=tipo_salida]:checked").val());
          ...
          console.log("search5 = ", $("#txtCriterio").val());
            $('#grid-table').jqGrid('clearGridData')
                .jqGrid('setGridParam', {postData: {
                    ...
                    tipo_salida: $("input[name=tipo_salida]:checked").val(),
                    almacen: almacen,
                    action: 'load'
...
/*
        ...
        form.setAttribute('action', '/api/reportes/lista/salidas.php');
        form.setAttribute('method', 'post');
        form.setAttribute('target', '_blank');
