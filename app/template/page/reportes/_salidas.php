    ...
    function fillTableInfo(node){
        ...
        for(var i = 0; i < node.length ; i++){
            ...
            var button = "<button class='btn btn-sm btn-default no' title='Ver Detalle' onclick='searchDataDeta("+node[i].folio+")'><i class='fa fa-search'></i></button>"+
                        "&nbsp;"+
                        "<button class='btn btn-sm btn-danger no' title='Reporte PDF' onclick='printPDF("+node[i].folio+")'> <i class='fa fa-print'></i><sup> PDF</sup></button>"+
                        "&nbsp;"+
                        "<button class='btn btn-sm btn-primary no' title='Reporte Excel' onclick='printExcel("+node[i].folio+")'> <i class='fa fa-print'></i><sup> Excel</sup></button>"+
                        "&nbsp;"+
                        "<button class='btn btn-sm btn-success no' title='Reporte txt' onclick='test("+node[i].folio+")'> <i class='fa fa-print'></i><sup> TXT</sup></button>";
    ...
    function printPDF(consecutivo){
        ...
        $.ajax({
            ...
            success: function(data, textStatus, xhr){
                ...
                var head_content_header = '<tr><th style="border: 1px solid #ccc;text-align:center;width:16.6% !important">Folio de Embarque</th>'+
                    '<th style="border: 1px solid #ccc;text-align:center;width:16.6% !important">Cliente</th>'+
                    '<th style="border: 1px solid #ccc;text-align:center;width:16.6% !important">Factura</th>    '+
                    '<th style="border: 1px solid #ccc;text-align:center;width:16.6% !important">Pedido</th>'+
                    '<th style="border: 1px solid #ccc;text-align:center;width:16.6% !important">Cantidad</th>   '+
                    '<th style="border: 1px solid #ccc;text-align:center;width:16.6% !important">Total Cajas</th>  '+                           
                    '</tr>';
                var body_content_header = '<tr>'+
                    '<td style="border: 1px solid #ccc;text-align:center;width:16.6% !important">'+data.header[0].folio+'</td> '+
                    ...
                    '<td style="border: 1px solid #ccc;text-align:center;">'+data.header[0].total_cajas+'</td> '+
                    '</tr>  ';    
                /*Detalle*/
                ...
                var head_content = '<tr>'+
                    '<th style="border: 1px solid #ccc; text-align:center;">Folio</th>     '+
                    '<th style="border: 1px solid #ccc; text-align:center;">Clave</th>     '+
                    '<th style="border: 1px solid #ccc; text-align:center;">Articulo</th>     '+
                    '<th style="border: 1px solid #ccc; text-align:center;">Lote|Serie</th>     '+
                    '<th style="border: 1px solid #ccc; text-align:center;">Caducidad</th>     '+
                    '<th style="border: 1px solid #ccc; text-align:center;">Cantidad</th>     '+
                    '<th style="border: 1px solid #ccc; text-align:center;">Clave Caja</th>     '+
                    '<th style="border: 1px solid #ccc; text-align:center;">Guia</th>     '+
                    '</tr>';
                var body_content = '';
                data.body.forEach(function(item, index){
                    body_content += '<tr>'+
                        '<td style="border: 1px solid #ccc; text-align:center;">'+item.folio+'</td>         '+
                        '<td style="border: 1px solid #ccc; text-align:center;">'+item.clave+'</td>         '+
                        '<td style="border: 1px solid #ccc; text-align:center;">'+item.articulo+'</td>         '+
                        '<td style="border: 1px solid #ccc; text-align:center;">'+item.Lote_Serie+'</td>         '+
                        '<td style="border: 1px solid #ccc; text-align:center;">'+item.caducidad+'</td>         '+
                        '<td style="border: 1px solid #ccc; text-align:center;">'+item.cantidad+'</td>         '+
                        '<td style="border: 1px solid #ccc; text-align:center;">'+item.caja+'</td>         '+
                        '<td style="border: 1px solid #ccc; text-align:center;">'+item.guia+'</td>         '+
                        '</tr>  ';                                                         
