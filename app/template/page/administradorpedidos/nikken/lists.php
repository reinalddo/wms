...
*/
                ...
                $("#totalpeso").val(data.pesototal);// se cambió por Pedidos asignados
...
//////////////////////////////////////////////////////////hace un reload del grid llamando al php en la carpera "c" para hacer la consulta//////////////////////////////////////////////////////////
    ...
    function asignarStatus() 
    {
        ...
        */
        ...
        console.log("asignarStatus3");
        console.log("**************************");
        console.log("folio", folio);
        console.log("nuevo_status", nuevo_status);
        console.log("$('#almacen').val()", $('#almacen').val());
        ...
        $.ajax({
            ...
            if (data.success) {
                ...
                swal("Error", "Este cambio de status no puede realizarse", "error");
            }
        }).fail(function(data){
            console.log("STATUS ERROR = ", data);
        });
        console.log("asignarStatus4");
    }
