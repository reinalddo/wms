...
<style type="text/css">
            ...
            <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="totalpeso" type="text" value="0" class="form-control" disabled><br>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <label for="factura_inicio">Factura Inicio</label>
                                        <input type="text" class="form-control" name="factura_inicio" id="factura_inicio">
                                    </div>
                                    <div class="form-group">
                                        <label>Total de Pedidos</label>
                                        <input id="totalpedidos" type="text" value="0" class="form-control" disabled><br>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <label for="factura_final">Factura Final</label>
                                        <input type="text" class="form-control" name="factura_final" id="factura_final">
                                    </div>
                                    <div class="form-group">
                                        <label>Volumen Total</label>
                                        <input id="volumentotal" type="text" value="0" class="form-control" disabled><br>
                                    </div>
                                </div>

                                <div class="col-md-12">
                                    <a href="/api/v2/pedidos/exportar-detalles" target="_blank" class="btn btn-primary pull-right" style="margin-left:15px;"><span class="fa fa-upload"></span> Exportar detalles</a>
                                    <a href="/api/v2/pedidos/exportar-cabecera" target="_blank" class="btn btn-primary pull-right" style="margin-left:15px;"><span class="fa fa-upload"></span> Exportar cabecera</a>
                                    
                                    <button type="button" class="btn btn-primary pull-right" style="margin-left:15px;" data-toggle="modal" data-target="#modal-importar"><span class="fa fa-download"></span> Importar</button>
                                </div>
                ...
                <div class="ibox-content">
                    <div class="row">
                        ...
                        <input type="checkbox" name="planificarTodo" id="btn-planificarTodo">
                        Planificar Todo
                      </label>
                            </div>
                        </div>
                    ...
                    <div class="jqGrid_wrapper">
                        ...
                        <div class="table-responsive">
                            <table id="dt-detalles" class="table" style="table-layout: auto;width: 100%;">
                                <thead>
                                    <tr>
                                        <th id="col-seleccionar" scope="col" style="width: 30px !important; min-width: 30px !important;"></th>
                                        <th id="col-asignar" scope="col" style="width: 100px !important; min-width: 100px !important;">Asignar</th>
                                        ...
                                        <th scope="col" style="width: 200px !important; min-width: 200px !important;">Cliente</th>
                                        <th scope="col" style="width: 350px !important; min-width: 350px !important;">Dirección</th>
                                        ...
                                        <th scope="col" style="width: 100px !important; min-width: 100px !important;">Fecha Surtido</th>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group date" id="data_3">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input id="txt-ola-fechaentrega" type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
    ...
    <div class="modal fade" id="modalItems" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog vertical-align-center modal-lg" style="width: 1200px!important;">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4>Lista de articulos a surtir</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody id="modalItems_tbody"></tbody>
                            </table>
                        </div>
                    </div>
                    <br/>
                    ...
                    <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody id="modalItems_ubicaciones"></tbody>
                            </table>
                        </div>
                    </div>
                ...
                <div class="modal-footer text-center">
                    <button id="btnGuardarSurtidoPorUbicacion" type="button" class="btn btn-primary pull-right" onclick="javscript:guardarSurtidoPorUbicacion()"><span class="fa fa-sign-out"></span> Finalizar</button>
                    <button id="btnSiguienteItem" type="button" class="btn btn-primary pull-right" onclick="javscript:siguienteItem()"><span class="fa fa-chevron-right"></span> Siguiente</button>
                    <button id="btnAnteriorItem" type="button" class="btn btn-default pull-right" onclick="javscript:anteriorItem()"><span class="fa fa-chevron-left"></span > Anterior</button>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <select id="usuario" class="chosen-select form-control">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content animated bounceInRight">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4>Articulos del pedido</h4>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                        <div class="col-md-12">
                            <div class="input-group" style="margin: 7px;">
                                <button id="btnRealizarSurtido" class="btn btn-primary pull-right" onclick="prepararSurtido()" style="margin-right: 5px;"><i class="fa fa-cubes"></i>Realizar surtido
                                </button>

                                <button class="btn btn-primary pull-right" onclick="imprimirRemision()" style="margin-right: 5px;"><i class="fa fa-print"></i>Imprimir Remisión
                                </button>
                                <button class="btn btn-primary pull-right" onclick="imprimirGuiasEmbarque()" style="margin-right: 5px;"><i class="fa fa-print"></i>Imprimir Guías de Embarque
                                </button>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    <script>
        ...
        function prepararSurtido() {
            itemActual = -1;
            siguienteItem();
            $('#btnAnteriorItem').prop('disabled', true);
            $('#modalItems').modal('show');
            $('#coModal').modal('hide');
            $('#btnSiguienteItem').show();
            $('#btnGuardarSurtidoPorUbicacion').hide();
        }
        ...
        function siguienteItem() {
            ...
            if (itemActual >= itemsArticulosPedidos.length - 1) {
                itemActual = (itemsArticulosPedidos.length - 1);
                $('#btnGuardarSurtidoPorUbicacion').show();
                $('#btnSiguienteItem').hide();
            }

            $('#btnAnteriorItem').prop('disabled', false);

            item = itemsArticulosPedidos[itemActual];

            html = '<tr> <td>' + item.clave + '</td>' +
                '<td>' + item.articulo + '</td>' +
                '<td>' + item.solicitadas + '</td>' +
                '<td>' + item.surtidas + '</td>' +
                //'<td><a href="javascript:obtenerUbicacion('+"'"+item.clave+"'"+')"><span class="fa fa-check"></span></a></td>'+
                '</tr>';



            obtenerUbicacion(item.clave, item.solicitadas, item.surtidas);
            $('#modalItems_tbody').html(html);

            if (itemActual >= itemsArticulosPedidos.length - 1 || itemsArticulosPedidos.length == 1) {
                $('#btnSiguienteItem').hide();
                $('#btnGuardarSurtidoPorUbicacion').show();
            }
        ...
        function obtenerUbicacion(articulo, solicitadas, surtidas) {

            $('#modalItems_ubicaciones').html('<tr><td colspan="10"><h3 class="text-center">Cargando...</h3></td></tr>');
            ...
            $.ajax({
                ...
                success: function(data) {
                    html = '';
                    surtir = parseInt(solicitadas) - parseInt(surtidas);
                    pendiente = surtir;
                    totalSurtido = parseInt(surtidas);

                    itemsArticulosPedidos[itemActual].ubicaciones = [];


                    if (data.data == null || data.data.length < 1) {
                        html = '<tr><td colspan="10"><h3 class="text-center">No hay existencia para este artículo</h3></td></tr>';
                        itemsArticulosPedidos[itemActual].ubicaciones.push({});
                    } else {

                        $.each(data.data, function(key, value) {
                            existencia = parseInt(value.cantidad);

                            if (surtir > existencia) {
                                surtir = existencia;
                            }

                            html += '<tr> <td>' + value.zona + '</td>' +
                                '<td>' + value.pasillo + '</td>' +
                                '<td>' + value.rack + '</td>' +
                                '<td>' + value.nivel + '</td>' +
                                '<td>' + value.seccion + '</td>' +
                                ...
                                '<td><input id="surtir-item-' + articulo + '" value="' + surtir + '" class="surtir-item" data-item="' + articulo + '" type="number"/></td>' +
                                '</tr>';

                            totalSurtido += parseInt(surtir);
                            pendiente = parseInt(solicitadas - totalSurtido);
                            obj = value.ubicacion_id + '|' + value.lote + '|' + surtir;
                            surtir = parseInt(pendiente);
                            itemsArticulosPedidos[itemActual].ubicaciones.push(obj);
                        });
                    }

                    if (parseInt(solicitadas) - parseInt(surtidas) > 0) {
                        $('#modalItems_ubicaciones').html(html);
                    }

                    itemsArticulosPedidos[itemActual].totalsurtido = totalSurtido;
        ...
        function guardarSurtidoPorUbicacion() {
    ...
    <script type="text/javascript">
        ...
        $(function($) {
            ...
            $(grid_selector).jqGrid({
                ...
                mtype: 'POST',
                colNames: ['ID', 'Asignar', 'Planear Ola', 'No. Orden', 'No. OC Cliente', 'Prioridad', 'Status', 'Cliente', 'Dirección', 'Código Dane', 'Ciudad', 'Estado', 'Cantidad', 'Volumen', 'Peso', 'Fecha Registro', 'Fecha Surtido', 'Surtidor', '% Surtido', 'totalpedidos', "Acciones"],
                colModel: [{
                        name: 'id_pedido',
                        index: 'id_pedido',
                        editable: false,
                ...
                beforeSelectRow: function(rowid, e) {
                    ...
                    if (cmName === "planear") {
                        localData.planear = $(e.target).is(":checked");
                    }
            ...
            $('#planificaloTodo').hide();
            $('#btn-planificar').hide();
            $("#grid-table").jqGrid('hideCol', ["asignar", "planear"]);
        });
        ...
        function ReloadGrid() {
                    ...
                    if (data.status == 200) {
                        ...
                        $.each(data.data, function(index, item){
                            ...
                            row += '<tr>'+
                                        ...
                                        '<td align="center">'+imageFormat(item.id,item.surtido)+'</td>'+
                                    '</tr>';                            
                        });
            ...
            if ($("#status").val() == 'A') {
                ...
                $('#planificaloTodo').show();
                $('#btn-planificar').show();
                $("#grid-table").jqGrid('showCol', ["asignar", "planear"]);
            } else {
                $('#btn-asignar').hide();
                $('#planificalo').hide();
                $('#planificaloTodo').hide();
        ...
        function filtralo() {
            ...
            if ($("#status").val() == 'A') {
                ...
                $('#btn-asignar').show();
                $('#btn-planificar').show();
                $('#btn-asignarTodo').parent().show();
                $('#btn-planificarTodo').parent().show();
            } else {
                $("#grid-table").jqGrid('hideCol', ["asignar", "planear"]);
                $('#btn-asignar').hide();
                $('#btn-planificar').hide();
                $('#btn-asignarTodo').parent().hide();
                $('#btn-planificarTodo').parent().hide();
            }
        ...
        function crearConsolidadoDeOla(folios) {
            ...
            if ($('#txt-ola-fechaentrega').val() == '') {
                swal({
                    title: "Campos incompletos",
                    text: "Debe seleccionar la Fecha de entrega de la Ola para continuar",
                    type: "error"
                }, function() {
                    $('#txt-ola-fechaentrega').focus();
                });
                $('#txt-ola-fechaentrega').focus();
                return false
            }
            ...
            for (var i = 0; i < rowCount; i++) {
                var row = grid.jqGrid("getRowData", rowId[i]);
                if (row.planear == 'Yes') {
                    folios.push(row.orden);
                }
            }
            ...
            $.ajax({
                    ...
                    data: {
                        folios: folios,
                        fecha_entrega: $('#txt-ola-fechaentrega').val(),
    ...
    <script type="text/javascript">
        ...
        function asignar() {
            ...
            for (var i = 0; i < rowCount; i++) {
                ...
                if (row.asignar == 'Yes') {
                    asignados.push(row.orden);
                }
            }

            $('#txt-cantidad-pedidos').text(asignados.length);
            $("#modal-asignar-usuario").modal('show');
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success == true) {
                        var arr = $.map(data.usuarios, function(el) {
                            return el;
                        })
                        arr.pop();
                        for (var i = 0; i < data.usuarios.length; i++) {
                            ...
                            li.appendChild(document.createTextNode(data.usuarios[i].nombre_usuario));
                            li.setAttribute("dayta-draggable", "item");
                            li.setAttribute("draggable", "true");
                            li.setAttribute("aria-grabbed", "false");
                            li.setAttribute("tabindex", "0");
                            li.setAttribute("class", "itemlist");
                            li.setAttribute("value", data.usuarios[i].clave_usuario);
                            ul.appendChild(li);
                        }
        ...
        function asignarPedido() {
            ...
            for (i = 0; i < n; i++) {
                ...
                if (rowData.asignar == 'Yes') {
                    names.push(rowData.orden);
                }
            }
            ...
            if ($('#usuario').val() == "") {
                swal({
                    title: "Solo puede asignar un usuario",
                    text: "Por favor seleccione un unico usuario para asignar el pedido",
                    type: "error"
                });
                return;
            }
                ...
                success: function(data) {
                    if (data.success == true) {
                        swal({
                            ...
                            text: "Los pedidos han sido asignados",
                            type: "success"
                        });
                        ReloadGrid();
        ...
        function articulos(_codigo) {
            ...
            $.ajax({
                ...
                if (data.data.asignado == '' || data.data.asignado == null) {
                    $('#btnRealizarSurtido').hide();
                } else {
            ...
            $.ajax({
                ...
                if (data.success) {
                    ...
                    $("#total_productos_detalle").html(detalles_productos.total);
                    ...
                    $("#cantidad_caja_detalle").html(detalles_cajas.cantidad);
                } else {
                    ...
                    if (data.success == true) {
                        ...
                        for (var i = 0; i < data.articulos.length; i++) {
                            ...
                            itemsArticulosPedidos.push({
                                ...
                                solicitadas: data.articulos[i].pedidas,
                                surtidas: data.articulos[i].surtidas,
                                lote: data.articulos[i].surtidas,
                                existencia: data.articulos[i].existencia,
                                ubicaciones: {}
                            });
    ...
    <script type="text/javascript">
        ...
        $(function($) {
            ...
            //resize to fit page size
            $(window).on('resize.jqGrid', function() {
                    $(grid_selector).jqGrid('setGridWidth', $("#coModal").width() - 50);
                })
                //resize on sidebar collapse/expand
            var parent_column = $(grid_selector).closest('[class*="col-"]');
            $(document).on('settings.ace.jqGrid', function(ev, event_name, collapsed) {
            ...
            $(grid_selector).jqGrid({
                ...
                height: 'auto',
                mtype: 'POST',
                colNames: ['Folio', 'Cliente', 'Clave', 'Articulo', 'Existencia', 'Volumen (m3)', 'Peso', 'Solicitadas', 'Surtidas'],
                colModel: [{
                        name: 'folio',
                        index: 'folio',
                        width: 80,
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#btn-asignarTodo").on('click', function(e) {
                var $checkboxes = $('td[aria-describedby="grid-table_asignar"] input[type="checkbox"]');
                if (e.target.checked) {
                    $("#btn-asignar").show();
            ...
            $("#planificarTodo").on('click', function(e) {
                var $checkboxes = $('td[aria-describedby="grid-table_planear"] input[type="checkbox"]');
                if (e.target.checked) {
                    if ($checkboxes.length > 0) {
                        $checkboxes.each(function(i, v) {
                            v.checked = true;
    ...
    <script type="text/javascript">
        ...
        function imprimirRemision() {
            var folio = $("#grid-table2").jqGrid('getRowData')[0].folio,
