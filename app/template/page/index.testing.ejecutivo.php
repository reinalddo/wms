...
$sql_capacidad_ocupado = "
    ...
    inner join c_ubicacion on c_ubicacion.idy_ubica = V_ExistenciaGralProduccion.cve_ubicacion 
    inner join c_articulo on c_articulo.cve_articulo = V_ExistenciaGralProduccion.cve_articulo
...
if($almacenSeleccionadoId && !empty($almacenSeleccionadoId))
{
    $sql_alamcenaje = "
        SELECT 
...
<div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Codigo testing</h5>
                </div>
                <div class="ibox-content">
<iframe width="100%" height="450" src="https://lookerstudio.google.com/embed/reporting/d926b3fe-275d-4211-828a-9385ef7f85d2/page/p_n1w2lrv0ld" frameborder="0" style="border:0" allowfullscreen sandbox="allow-storage-access-by-user-activation allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox"></iframe>                </div>
            </div>
        </div>
</div>
    <div class="row">
