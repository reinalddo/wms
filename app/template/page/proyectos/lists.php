...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            url:'/api/proyectos/lista/index.php',
            datatype: "json",
            shrinkToFit: false,
            height:'auto',
            postData: {
            ...
            mtype: 'POST',
            colNames:["Acciones", 'ID', 'Clave','Descripción'],
            colModel:[
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            url:'/api/proyectos/lista/index_i.php',
            datatype: "json",
            height: 250,
            postData: {
                criterio: $("#txtCriterio").val()
    ...
    function borrar(_codigo) {
        ...
        swal({
            ...
            $.ajax({
                ...
                url: '/api/proyectos/update/index.php',
                success: function(data) {
...
*/
        ...
        $.post('/api/proyectos/update/index.php',
               {
            id: $("#id_proyecto").val(),
