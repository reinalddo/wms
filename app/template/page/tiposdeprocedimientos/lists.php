            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form id="myform" role="form">
                        <div class="row">
                            <div class="col-md-6 b-r">
                                <div class="form-group"><label>Nombre del Procedimiento *</label> <input id="nombreDeProcedimiento" name="nombreDeProcedimiento" type="text" placeholder="Procedimiento" class="form-control" maxlength="30" required="true"></div>
...
<div class="modal inmodal" id="modalEditarProcedimiento" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header" id="modaltitle">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            ...
            <form id="myform">
            <div class="modal-body">
                <label>Nombre del Procedimiento *</label> <input id="new_nombre_procedimiento" name="new_nombre_procedimiento" type="text" placeholder="Procedimiento" class="form-control" maxlength="30" required="true">
...
<script type="text/javascript">
        ...
        $(function($) {
            ...
            $(grid_selector).jqGrid({
                url: '/api/tiposdeprocedimientos/lista/index.php',
                datatype: "json",
                shrinkToFit: true,
                height: 'auto',
                mtype: 'POST',
                ...
                colModel: [
                    {
                        ...
                        name: 'nombreDeProcedimiento',
                        index: 'nombreDeProcedimiento',
                        width: 200,
                        editable: false,
                        sortable: false,
                        resizable: false
        ...
        function borrar(_codigo) {
            $.ajax({
                ...
                url: '/api/tiposdeprocedimientos/update/index.php',
                success: function(data)
                {
                    if (data.success == true)
                    {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success == true) {
                        ...
                        $('#new_nombre_procedimiento').val(data.nombreDeProcedimiento);
        ...
        l.click(function() {
            ...
            if ($("#hiddenAction").val() == "add") {
                $.ajax({
                    ...
                    dataType: "json",
                    data: {
                        nombreDeProcedimiento: $("#nombreDeProcedimiento").val(),
                        action: "add"
                    },
                    beforeSend: function(x) {
                        if (x && x.overrideMimeType) {
        ...
        l.click(function() {
            ...
            if ($("#hiddenAction").val() == "edit") {
                $.ajax({
                    ...
                    data: {
                        id: $("#new_hiddenID").val(),
                        nombreDeProcedimiento: $("#new_nombre_procedimiento").val(),
                        action: "edit"
                    },
                    beforeSend: function(x) {
                        if (x && x.overrideMimeType) {
