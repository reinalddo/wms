...
<link rel="stylesheet" id="ebor-roboto-font-css" href="./Caesar _ A Beautiful Blogging Theme_files/css" type="text/css" media="all">
<link rel="stylesheet" id="ebor-theme-layout-css" href="./Caesar _ A Beautiful Blogging Theme_files/caesar-layout.css" type="text/css" media="all">
<link rel="stylesheet" id="ebor-style-css" href="./Caesar _ A Beautiful Blogging Theme_files/style.css" type="text/css" media="all">
		...
		<div class="wrapper main-wrapper">
			...
			<header role="header" class="main-item main-header" data-js="main-item">
				<div class="wrapper">
							...
							<!--<a itemprop="url" href="http://<?php /*echo $_SERVER['HTTP_HOST']; */?>/f/<?php /*echo $user->identifier; */?>" title="Audi">-->
							<a itemprop="url" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/<?php echo $user->identifier; ?>" title="Audi">
...
<article>
	<div>
		...
		<p style="color:#ff0000;font-weight:bold;text-align:right;">29/01/2016</p>
			<h2 class="post-title"><a itemprop="url" href="#" title="<?php echo $templates->title; ?>"><?php echo $templates->title; ?>
</a></h2>
<p class="post-excerpt"><?php echo $templates->content; ?></p>
	...
	<div class="wrapper sidebar-wrapper">
		<div id="text-2" class="sidebar-item sidebox widget widget_text">			<div class="nav nav--icons"><a href="#" target="_blank"><img src="facebook500.png" style="width:25px;margin-right:5px;"></a> <a href="#" target="_blank"><img src="twitter.png" style="width:25px;"></a></div>
		</div>	<div style="width:100%;text-align:center;">
			<h4>Suscribete al Press Room</h4>

		<?php echo @$error; ?>
<!--<form method="post" action="http://<?php /*echo $_SERVER['HTTP_HOST']; */?>/f/<?php /*echo $user->identifier; */?>/<?php /*echo $templates->id_template; */?>">-->
<form method="post" action="http://<?php echo $_SERVER['HTTP_HOST']; ?>/<?php echo $user->identifier; ?>/<?php echo $templates->id_template; ?>/">
			<input type="hidden" name="action" value="create_subscriber" />
				<div style="width:90%;margin:0 auto;">
		 			<div style="float:left;width:30%;font-size:0.95em;line-height: 2.7em;margin:0;"><p>Nombre:<br /> Apellido: <br /> Medio: <br /> Email: </p></div>
					 <div style="float:right;width:69%;line-height: 50%;"><input type="text" name="first_name" style="padding: 8px;border: 1px solid #ccc;border-radius: 3px;margin-bottom: 10px;width: 90%;box-sizing: border-box;color: #2C3E50;font-size: 13px;"/><br /><input type="text" name="last_name" style="padding: 8px;border: 1px solid #ccc;border-radius: 3px;margin-bottom: 10px;width: 90%;box-sizing: border-box;color: #2C3E50;font-size: 13px;"/><br /><input type="text" name="media" style="padding: 8px;border: 1px solid #ccc;border-radius: 3px;margin-bottom: 10px;width: 90%;box-sizing: border-box;color: #2C3E50;font-size: 13px;"/><br /><input type="text" name="email" style="padding: 8px;border: 1px solid #ccc;border-radius: 3px;margin-bottom: 10px;width: 90%;box-sizing: border-box;color: #2C3E50;font-size: 13px;"/><br />
...
</div><div style="text-align:center;margin-top:10px;margin-bottom:15px;font-size:13px;">Powered by <a href="#">PressHunters</a></div>
