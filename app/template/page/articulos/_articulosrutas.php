...
<?php */ ?>
                            ...
                            <div class="col-xs-2" style="margin-bottom: 15px;display: none;">
                                  <input type="date" class="form-control" id="fecha_search" placeholder="Fecha...">
                            </div>
<?php /* ?>
                            <div class="col-lg-4" style="margin-bottom: 15px;">
        ...
        $(function($) {
            ...
            $(grid_selector).jqGrid({
                ...
                colModel:[
                    ...
                    {name:'folio',index:'folio',width:80, editable:false, sortable:false, resizable: false, hidden: false},//**
                    {name:'cve_ruta',index:'cve_ruta',width:80, editable:false, sortable:false, resizable: false, hidden: false},
                    {name:'transporte',index:'transporte',width:120, editable:false, sortable:false, resizable: false, hidden: false},//**
                    {name:'tipo_transporte',index:'tipo_transporte',width:120, editable:false, sortable:false, resizable: false, hidden: false},//**
                    {name:'ruta',index:'ruta',width:170, editable:false, sortable:false, resizable: false, hidden: false},//**
                    {name:'orden_stop',index:'orden_stop',width:80, editable:false, sortable:false, resizable: false, align: 'right', hidden: false},//**
                    {name:'cve_destinatario',index:'cve_destinatario',width:150, editable:false, sortable:false, resizable: false, hidden: false},//**
                    {name:'destinatario',index:'destinatario',width:200, editable:false, sortable:false, resizable: false, hidden: false},//**
                    {name:'pedido',index:'pedido',width:110, editable:false, sortable:false, resizable: false, hidden: false},//**
                    {name:'fecha',index:'fecha',width:110, editable:false, sortable:false, resizable: false, align: 'center', hidden: false},//**
                    {name:'fecha_ent',index:'fecha_ent',width:110, editable:false, sortable:false, resizable: false, align: 'center', hidden: false},//**
                    ...
                    {name:'stock_fin_pz',index:'stock_fin_pz',width:130, editable:false, sortable:false, resizable: false, align: 'right', hidden: false}//**
                ],
                rowNum:30,
                rowList:[30,40,50],
