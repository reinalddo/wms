    ...
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header" id="modaltitle">
                ...
                <h4 class="modal-title">Propiedades del Protocolo</h4>
            </div>
            <form id="myform">
            <div class="modal-body">
			<label>Clave de Protocolo *</label><input id="clave" type="text" placeholder="Clave" class="form-control" maxlength="20" required="true"><!--<label id="CodeMessage" style="color:red;">--></label><br>
                <label>Descripción *</label><input id="descripcion" type="text" placeholder="Descripción" maxlength="100" class="form-control" required="true"><br>
                 <label>Folio *</label>   <input id="FOLIO" type="text" placeholder="Folio" oninput="this.value = this.value.replace(/[^0-9]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" maxlength="11" class="form-control" required="true">
                <input type="hidden" id="hiddenAction">
                <input type="hidden" id="hiddenIDProtocolo">
            </div>
        ...
        <div class="modal-dialog vertical-align-center modal-lg" style="width: 1200px!important;">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Recuperar Protocolo</h4>
                </div>
                <div class="modal-body">
                    <div class="col-lg-4">
                ...
                <div class="ibox-title">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <a href="/api/v2/protocolos/exportar" target="_blank" class="btn btn-primary pull-right" style="margin-left:15px;"><span class="fa fa-upload"></span> Exportar</a>
							...
							<button  class="btn btn-primary pull-right" type="button" id="inactivos"><i class="fa fa-search"></i>&nbsp;&nbsp;Protocolos de entrada inactivos</button>
                        </div>
                    </div>
                </div>
                <div class="ibox-content">
        ...
        <div class="vertical-alignment-helper">
            <div class="modal-dialog vertical-align-center">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Importar Protocolos</h4>
                    </div>
                    <div class="modal-body">
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            url:'/api/protocolos/lista/index.php',
            datatype: "json",
            shrinkToFit: false,
height:'auto',
            postData: {
            ...
            mtype: 'POST',
            colNames:['Clave','Descripción',"Folio","Acciones"],
            colModel:[
                //{name:'id',index:'id', width:60, sorttype:"int", editable: false},
                {name:'ID_Protocolo',index:'ID_Protocolo',width:200, editable:false, sortable:false, hidden: false},
                {name:'descripcion',index:'descripcion',width:433, editable:false, sortable:false},
                {name:'FOLIO',index:'FOLIO',width:300, editable:false, sortable:false},
                {name:'myac',index:'', width:100, fixed:true, sortable:false, resize:false, formatter:imageFormat},
            ],
            rowNum:30,
            rowList:[30,40,50],
            pager: pager_selector,
            sortname: 'ID_Protocolo',
            viewrecords: true,
            sortorder: "desc"
        });
  ...
  function borrar(_codigo) {
		...
		$.ajax({
            ...
            dataType: "json",
            data: {
                ID_Protocolo : _codigo,
                action : "tieneOrden"
            },
            beforeSend: function(x) { if(x && x.overrideMimeType) { x.overrideMimeType("application/json;charset=UTF-8"); }
            },
            url: '/api/protocolos/update/index.php',
            success: function(data) {
                if (data.success == true) {
                                   swal(
                        '¡Alerta!',
                        'El protocolo esta siendo usado en este momento',
                        'warning'
                    );
                ...
                swal({
                    title: "¿Está seguro que desea borrar el protocolo?",
                    text: "Está a punto de borrar un protocolo y esta acción no se puede deshacer",
                    type: "warning",
    ...
    function editar(_codigo) {
        $("#modaltitle").html('<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-laptop modal-icon"></i><h4 class="modal-title">Editar Protocolo</h4>');
    ...
    function agregar() {
        $("#modaltitle").html('<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><i class="fa fa-laptop modal-icon"></i><h4 class="modal-title">Agregar Protocolo</h4>');
        $modal0 = $("#myModal");
        $modal0.modal('show');
        l.ladda('stop');
	...
	l.click(function() {
			...
			$.post('/api/protocolos/update/index.php',
			{
                ID_Protocolo : $("#clave").val(),
		...
		$.ajax({
            ...
            $("#CodeMessage").html(" Clave de Protocolo ya existe");
            ...
            $("#CodeMessage").html("Por favor, ingresar una Clave de Protocolo válida");
            $("#btnSave").prop('disabled', true);
        }
    });
...
$(function($) {
        ...
        $(grid_selector).jqGrid({            
			 url:'/api/protocolos/lista/index_i.php',
            datatype: "json",
            shrinkToFit: false,
height:'auto',
            postData: {
            ...
            colModel:[
                //{name:'id',index:'id', width:60, sorttype:"int", editable: false},
                {name:'ID_Protocolo',index:'ID_Protocolo',width:150, editable:false, sortable:false, hidden: false},
                {name:'descripcion',index:'descripcion',width:450, editable:false, sortable:false},
                {name:'FOLIO',index:'FOLIO',width:150, editable:false, sortable:false},
