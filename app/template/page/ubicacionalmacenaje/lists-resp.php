                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input id="input-pesoM"  maxlength="6" type="text" class="form-control" value="0" required>
                    </div>
                  </div>
                </div>
...
<script type="text/javascript">
    ...
    radio_status_lib.onchange = radio_status_res.onchange = radio_status_cua.onchange = function(){
    ...
    function ver(id, csd, peso_max, vol_max, pes_porcentaje, vol_porcentaje)
    {//EDG
      console.log(id, csd, peso_max, vol_max, pes_porcentaje, vol_porcentaje);
      $("#tabla_vacia").hide();
      $("#pes_max").val("");
      $("#pes_total").val("");
      $("#pes_dispo").val("");
    ...
    function loadDetalles(id) 
    {
      ...
      }, datatype: 'json', page : 1, mtype: 'GET', url:'/api/ubicacionalmacenaje/lista/index.php'})
      .trigger('reloadGrid',[{current:true}]);
    }
