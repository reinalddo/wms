    ...
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modaltitle">Agregar Proyecto</h4>
            </div>
            <form id="myform">
                <div class="modal-body">
                    ...
                    <label>Descripción</label><input id="descripcion" type="text" placeholder="descripcion" class="form-control" <?php /* ?>required="true"<?php */ ?>><br>
...
<div class="wrapper wrapper-content  animated fadeInRight">
    ...
    <h3>Administración de Interfase</h3>
            ...
            <div class="ibox ">
                <div class="ibox-title">
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            <label>Status</label>
                            <select id="status_interfase" class="form-control">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select id="recepcion_interfase" class="form-control">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select id="dispositivo_interfase" class="form-control">
                                <option value="">Todos</option>
        ...
        <div class="modal-dialog vertical-align-center modal-lg" style="width: 1200px!important;">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Recuperar Proyecto</h4>
                </div>
                <div class="modal-body">
                    <div class="col-md-4">
                        <div class="input-group">
        ...
        <div class="vertical-alignment-helper">
            <div class="modal-dialog vertical-align-center">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title">Importar Proyecto</h4>
                    </div>
                    <div class="modal-body">
...
<script type="text/javascript">
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            url:'/api/interfases/lista/index.php',
            datatype: "json",
            shrinkToFit: false,
            height:'auto',
            postData: {
                status_interfase: $("#status_interfase").val(),
                recepcion_interfase: $("#recepcion_interfase").val(),
                dispositivo_interfase: $("#dispositivo_interfase").val(),
                fechaInicio: $("#fechai").val(),
                fechaFin: $("#fechaf").val(),
                criterio: $("#txtCriterio").val()
            },
            mtype: 'POST',
            colNames:["Acciones", 'ID Transacción', 'Fecha','Tipo', 'Mensaje', 'Dispositivo', 'In|Out', 'Status', 'Recepción', 'EstatusButton', 'RecepcionButton', 'Respuesta'],
            colModel:[
                //{name:'id',index:'id', width:60, sorttype:"int", editable: false},
                {name:'myac',index:'', width:100, fixed:true, sortable:false, resize:false, formatter:imageFormat},
                {name:'Id',index:'Id',width:100, editable:false, sortable:false},
                ...
                {name:'cadena_enviada',index:'cadena_enviada',width:500, editable:false, sortable:false},
                {name:'Dispositivo',index:'Dispositivo',width:100, editable:false, sortable:false},
                {name:'In_Out',index:'In_Out',width:200, editable:false, sortable:false},
                {name:'Estatus',index:'Estatus',width:100, editable:false, sortable:false},
                {name:'Recepcion',index:'Recepcion',width:100, editable:false, sortable:false},
                {name:'EstatusButton',index:'EstatusButton',width:100, editable:false, sortable:false, hidden: true},
                {name:'RecepcionButton',index:'RecepcionButton',width:100, editable:false, sortable:false, hidden: true},
                {name:'Respuesta',index:'Respuesta',width:100, editable:false, sortable:false},
            ],
        ...
        function imageFormat( cellvalue, options, rowObject ){
            ...
            var id = rowObject[1];
            var recepcion = rowObject[8];
            var EstatusButton = rowObject[9];
            var RecepcionButton = rowObject[10];
            ...
            var html = '';
            if(RecepcionButton == 'Error')
            html += '<a href="#" onclick="enviar_cadena(\''+id+'\')"><i class="fa fa-refresh" alt="Enviar Cadena Nuevamente" title="Enviar Cadena Nuevamente"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;';
    ...
    $(function($) {
        ...
        $(grid_selector).jqGrid({
            url:'/api/interfases/lista/index_i.php',
            datatype: "json",
            height: 250,
            postData: {
                status_interfase: $("#status_interfase").val(),
    ...
    function borrar(_codigo) {
        ...
        swal({
            title: "¿Está seguro que desea borrar este proyecto?",
            text: "",
            type: "warning",
            ...
            $.ajax({
                ...
                url: '/api/interfases/update/index.php',
                success: function(data) {
    ...
    function enviar_cadena(_codigo) {

        console.log("enviar_cadena ID = ", _codigo);

        swal({
            title: "Enviar Datos?",
            text: "Desea Enviar Nuevamente la cadena a la interfase?",
            type: "warning",
            ...
            closeOnConfirm: true
                ...
                $.ajax({
                    ...
                    error: function(data){console.log("ERROR", data); ReloadGrid();}
                });
    ...
    function agregar() {
        $("#CodeMessage").html("");
        $("#modaltitle").text("Agregar Proyecto");
    ...
    $("#status_interfase, #recepcion_interfase, #dispositivo_interfase").change(function(){
        ReloadGrid();
    });
...
*/
        ...
        $.post('/api/interfases/update/index.php',
               {
            id: $("#id_proyecto").val(),
    ...
    $("#Clave").keyup(function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success == false) {
                        ...
                        $("#CodeMessage").html(" Clave de Proyecto ya existe");
        ...
        //}else{
        //    $("#CodeMessage").html("Por favor, ingresar una Clave de Proyecto válida");
        //    $("#btnSave").prop('disabled', true);
        //}
    ...
    $('#btn-layout').on('click', function(e) {
        //console.log("Layout_proyectos", window.location.href, '/Layout/Layout_proyectos.xlsx');
