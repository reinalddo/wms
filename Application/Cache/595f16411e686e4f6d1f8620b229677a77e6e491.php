                    ...
                    <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group text-right">
                                <button onclick="ReloadGrid()" class="btn btn-primary">
                    ...
                    <div class="col-md-8 col-md-8 b-r">
                        ...
                        <div class="input-group">                                    
                            ...
                            <div class="input-group-btn">
                                <a href="#" onclick="ReloadGridBusqueda()" class="btn btn-primary">
                                        <span class="fa fa-search"></span> Buscar
                                </a>
                            </div>
...
<script>
    ...
    function agregarACuarentena(){
        ...
        $.ajax({
            url: '/api/v1/qacuarentena/agregar',
            dataType: "json",
            type: "POST",
            data : {
    ...
    $(function($) { 
        ...
        $(grid_selector).jqGrid({
            ...
            mtype: 'GET',
            colNames:['id','Clave', 'Descripción', 'Lote', 'Caducidad', 'N° de serie','Cantidad', 'Estatus', 
                    'Almacén','Zona','Pasillo','Rack', 'Nivel', 'Sección', 'Ubicación', 
                    'tipo',
                    'Entrada','Responsable',
                    'Salida','Responsable',''],
            colModel:[
                ...
                {name:'clave_producto',index:'clave_producto',width:100, editable:false, sortable:false, resizable: false},
                ...
                {name:'rack',index:'rack',width:100, editable:false, sortable:false, resizable: false},
                {name:'nivel',index:'nivel',width:100, editable:false, sortable:false, resizable: false},
                {name:'seccion',index:'seccion',width:100, editable:false, sortable:false, resizable: false},
    ...
    $(function($) { 
       //////////////////////////////////////////////////////////Aqui se contruye el Grid//////////////////////////////////////////////////////////
        ...
        $(grid_selector_busqueda).jqGrid({
            url:'/api/v1/qacuarentena/productos',
            datatype: "json",
            height: 250,
            postData: {
                    criterio: $("#txtBuscar").val(),
