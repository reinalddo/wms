                        ...
                        <div class="ibox-content">
                            <div class="row">
                                ...
                                <div class="col-md-6 b-r">
                                    ...
                                    <div class="form-group"><label>Clave de Destinatario</label> <input id="claveDeDestinatario" type="text" placeholder="Clave" class="form-control" maxlength="20"></div>
...
<!--EDG -->
                            ...
                            <table id="dt-detalles" class="table" style="table-layout: auto;width: 100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" style="width: 80px !important; min-width: 80px !important;">Ruta</th>
                                        ...
                                        <th scope="col" style="width: 100px !important; min-width: 100px !important;">Clave de Sucursal</th>
    ...
    <script>
      $('#btn-layout').on('click', function(e) {
          ...
          window.location.href = 'http://www.tinegocios.com/proyectos/wms/LAYOUT_DESTINATARIOS_IMPORTAR.xlsx';//Change
      }); 
    ...
    <script type="text/javascript">
      ...
      //EDG
        function imageFormat2(id, clave_cliente, cliente, clave_destinatario, destinatario,ruta) 
        {
          if(ruta == "--")
          {
            var html = '<input type="checkbox" aling="center" class="checkbox-asignator" id="'+id+'" value="'+destinatario+'-'+clave_cliente+'-'+cliente+'"/>';
          }
          else
          {
            var html = "";
