            ...
            <div class="row" style="display: flex; padding-left: 20px;">
              <div style="width:190px; padding-right: 15px;">
                ...
                <div class="input-group date">
                  ...
                  <input id="txt-fecha-inicio" type="text" class="form-control" style="width:140px">
                </div>
              </div>
              <div style="width:190px; padding-right: 15px;">
                ...
                <div class="input-group date">
                  <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                  <input id="txt-fecha-fin" type="text" class="form-control" style="width:140px">
                </div>
              </div>
              ...
              <div class="col-md-3" style="margin-top: 23px;">
                <div class="col-md-3">
                  <div class="input-group-btn">
                    <button onclick="filtroAvanzado()" type="button" class="btn btn-primary" style="width: 200px;">
...
<script type="text/javascript">
  ...
  $("#exportExcel").on("click", function() {
    ...
    $("#dt-detalles").jqGrid("exportToExcel", {
      includeLabels: true,
