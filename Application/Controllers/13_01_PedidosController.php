...
const NUM_CANTIDAD = 2;
    ...
    public function paginate()
    {
      ...
      if($tipopedido != "")
      {
          ...
          $sql_tipo_pedido1 = " AND IF(op.Folio_Pro = o.Fol_folio, 1, IF(LEFT(o.Fol_folio, 2) = 'TR', 2, 0)) = '{$tipopedido}' ";
          $sql_tipo_pedido2 = " AND IF(opx.Folio_Pro = th.Fol_folio, 1, IF(LEFT(thsp.Fol_folio, 2) = 'TR', 2, 0)) = '{$tipopedido}' ";
      }
...
*/
      ...
      SELECT * FROM (
        SELECT 
          o.id_pedido, 
          IF(op.Folio_Pro = o.Fol_folio, 1, IF(LEFT(o.Fol_folio, 2) = 'TR', 2, 0)) AS es_ot,
          ...
          #IFNULL(CONCAT('(',r.cve_ruta,') ', r.descripcion), '') as ruta_pedido,
          IFNULL(r.cve_ruta, o.cve_ubicacion) as ruta_pedido,
...
*/
      ...
      SELECT DISTINCT 
                    ...
                    IF(opx.Folio_Pro = th.Fol_folio, 1, IF(LEFT(thsp.Fol_folio, 2) = 'TR', 2, 0)) AS es_ot,
                    ...
                    '1' AS disponible,
                    #IFNULL(CONCAT('(',r.cve_ruta,') ', r.descripcion), '') as ruta_pedido,
                    IFNULL(r.cve_ruta, th.cve_ubicacion) as ruta_pedido,
                ...
                FROM th_subpedido thsp 
                  ...
                  {$sql_tipo_pedido2} 
                  {$sql_union_search}  {$status_subpedidos} AND thsp.cve_almac = '{$almacen}'
