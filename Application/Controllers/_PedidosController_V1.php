...
/*
    FOLIO                      = 0; FECHA_PEDIDO               = 1; CLAVE_CLIENTE              = 2; CLAVE_CLIENTE_PROV         = 3;
    DIR_ENTREGA_PRINCIPAL      = 4; FECHA_ENTREGA              = 5; CLAVE_VENDEDOR             = 6; MESES                      = 7;
    OBSERVACIONES              = 8; FECHA_ENTRADA              = 9; PRIORIDAD                  = 10;BLOQUEADO                  = 11;
    NUM_ORDEN_CLIENTE          = 12;PICK_NUMBER                = 13;CVE_ARTICULO               = 14;NUM_CANTIDAD               = 15;
    MESES                      = 16;ITEM_NUM                   = 17;CVE_DESTINATARIO           = 18;RAZON_SOCIAL               = 19;
    DIRECCION_DESTINATARIO     = 20;COLONIA_DESTINATARIO       = 21;CODIGO_POSTAL_DESTINATARIO = 22;CIUDAD_DESTINATARIO        = 23;
    ESTADO_DESTINATARIO        = 24;CONTACTO                   = 25;TELEF_DESTINATARIO         = 26;EMAIL_DESTINATARIO         = 27;
    LATITUD                    = 28;LONGITUD                   = 29;
*/
...
*/
        ...
        {//s54
            ...
            {//s44
                if($pedido_articulo)
                {
                    $cantidad_agr = $this->pSQL($row[10]);
                    $sql = "UPDATE td_pedido SET Num_cantidad = (Num_cantidad + ) WHERE Fol_folio = '$Folio' AND Cve_articulo = '$cve_articulo'";
                    $rs = mysqli_query($conn, $sql);
                }
                else
                   $respuesta = $model->save();
