...
*/
    ...
    public function importarRL($id_almacen, $id_proveedor, $palletizar_entrada, $sobreescribir_existencias, $articulos, $lp_prod, $ubicacion_prod, $folio_ot)
    {
/*
        $errores = [];
...
*/
    ...
    public function Ejecutar_Infinity_WS($clave, $Lote, $cantidad, $um, $clave_almacen)
    {
    ...
    public function consecutivo_folio_traslado() 
    {
      $conn = mysqli_connect(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME);
...
*/
                ...
                $this->Ejecutar_Infinity_WS($clave, '', $existencia_art_prod, $um, $clave_almacen);
                $sql_check .= ";5;".$sql."\n\n;\n";
                }
            }
