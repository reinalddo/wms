...
const NUM_CANTIDAD = 2;
    ...
    (SELECT SUM(IF(COALESCE((SELECT SUM(Existencia) AS suma 
...
*/
      ...
      SELECT DISTINCT 
        thsp.Fol_folio AS id_pedido,
                    ...
                    IFNULL((SELECT SUM(DISTINCT tdsub.Num_Cantidad) FROM td_subpedido tdsub WHERE tdsub.fol_folio = thsp.Fol_folio AND tdsub.Sufijo = thsp.Sufijo), '--') AS cantidad, 
                    #'S' AS disponible,
