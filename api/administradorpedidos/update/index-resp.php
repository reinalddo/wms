        ...
        case "S":
            switch($nuevo_status)
            {
                ...
                case "L":
                    ...
                    $sql = "
                        UPDATE th_subpedido set status = 'L', cve_usuario = '' where Fol_folio = '{$folio}' and cve_almac= '{$almacen}';
        ...
        case "L":
            switch($nuevo_status)
            {
                ...
                case "P":
                    ...
                    $sql = "UPDATE th_subpedido SET status = 'P'  WHERE fol_folio = '{$folio}' and cve_almac = '{$almacen}';";
                    if (!($res = mysqli_multi_query($conn, $sql))) {echo "Falló la preparación(L-P,C,T,F): (" . mysqli_error($conn) . ") ";}
                case "C":
                case "T":
                case "F":
    ...
    else
    {
            if($_POST["status"] == 'A')
            {
                  ...
                  $sql = "
                      ...
                      WHERE td_pedido.Fol_folio IN ($pedidos) GROUP BY clave
                  ";
