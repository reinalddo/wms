...
if (isset($_POST) && !empty($_POST)) {
    ...
    $sqlCount = "SELECT COUNT(*) FROM c_ubicacion WHERE c_ubicacion.Activo = '1' GROUP BY c_ubicacion.cve_almac;;";
    ...
    while ($row = mysqli_fetch_array($res)) {
        ...
        $responce["rows"][$i]['cell']=array($row['cve_almac'], $row['idy_ubica'], utf8_encode($row['des_almac']), $row['Ubicacion']);
        $i++;
    }
