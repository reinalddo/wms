...
if (isset($_POST) && !empty($_POST)) {
    ...
    $sql = "SELECT
            ...
            c_almacen ,c_almacenp
			where c_almacen.cve_almacenp= c_almacenp.id and
			(c_almacen.des_almac like '%".$_criterio."%' or c_almacen.clave_almacen like '%".$_criterio."%') and c_almacen.Activo != '1' and c_almacen.cve_almacenp='$almacen' LIMIT $_page, $limit;";
