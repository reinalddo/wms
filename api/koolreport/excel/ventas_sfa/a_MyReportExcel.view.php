...
SELECT DISTINCT
    ...
    while ($row = mysqli_fetch_array($res)) {
        ...
        <div cell="M<?php echo $i; ?>"><?php echo number_format($Precio, 2); ?></div>
        <div cell="N<?php echo $i; ?>"><?php echo number_format($Importe, 2); ?></div>
        <div cell="O<?php echo $i; ?>"><?php echo number_format($IVA, 2); ?></div>
        <div cell="P<?php echo $i; ?>"><?php echo number_format($Descuento, 2); ?></div>
        <div cell="Q<?php echo $i; ?>"><?php echo number_format($Importe + $IVA - $Descuento, 2); ?></div>
