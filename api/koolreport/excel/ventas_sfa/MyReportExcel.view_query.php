...
<?php 
    ...
    $SQLFecha = ""; $SQLFechaIN1 = ""; $SQLFechaIN2 = "";
      ...
      $SQLFechaIN1 = " AND DATE(Venta.Fecha) >= STR_TO_DATE('{$fecha_inicio}', '%d-%m-%Y') AND DATE(Venta.Fecha) <= STR_TO_DATE('{$fecha_fin}', '%d-%m-%Y') ";
      $SQLFechaIN2 = " AND DATE(RelOperaciones.Fecha) >= STR_TO_DATE('{$fecha_inicio}', '%d-%m-%Y') AND DATE(RelOperaciones.Fecha) <= STR_TO_DATE('{$fecha_fin}', '%d-%m-%Y') ";
      if($fecha_inicio == $fecha_fin)
      {
        $SQLFecha = " AND DATE(ventas.FechaBusq) = STR_TO_DATE('{$fecha_inicio}', '%d-%m-%Y') ";
        $SQLFechaIN1 = " AND DATE(Venta.Fecha) = STR_TO_DATE('{$fecha_inicio}', '%d-%m-%Y') ";
        $SQLFechaIN2 = " AND DATE(RelOperaciones.Fecha) = STR_TO_DATE('{$fecha_inicio}', '%d-%m-%Y') ";
      }
      ...
      else if (!empty($fecha_fin)) 
      {
        ...
        $SQLFecha = " AND DATE(ventas.FechaBusq) <= STR_TO_DATE('{$fecha_fin}', '%d-%m-%Y') ";
        $SQLFechaIN1 = " AND DATE(Venta.Fecha) <= STR_TO_DATE('{$fecha_fin}', '%d-%m-%Y') ";
        $SQLFechaIN2 = " AND DATE(RelOperaciones.Fecha) <= STR_TO_DATE('{$fecha_fin}', '%d-%m-%Y') ";
      }
    ...
    $sql = "SELECT * FROM (
          ...
          IF(DetalleVet.Tipo = 0, 0, IF(um.mav_cveunimed != 'XBX', (IF(DetalleVet.Pza > 0, DetalleVet.Pza, IF(DetalleVet.Kg > 0, DetalleVet.Kg, 0)) - (c_articulo.num_multiplo*TRUNCATE((IF(DetalleVet.Pza > 0, DetalleVet.Pza, IF(DetalleVet.Kg > 0, DetalleVet.Kg, 0))/c_articulo.num_multiplo), 0))), IF(c_articulo.num_multiplo = 1, IF(DetalleVet.Pza > 0, DetalleVet.Pza, IF(DetalleVet.Kg > 0, DetalleVet.Kg, 0)), 0))) AS piezas_total,
          ...
          {$SQLArticulo1} {$SQLArticulo_Obseq} {$SQLFechaIN1} 
...
SELECT DISTINCT
          ...
          #AND th.Cancelada = 0 
          {$SQLArticulo2} {$SQLArticulo_Obseq} {$SQLFechaIN2}
          GROUP BY Folio, cve_articulo
