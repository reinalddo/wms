...
?>
    <tr>
      ...
      <th scope="col" style="text-align: right;padding-top: 30px;"><?php echo $total_importe; ?></th>
...
?>
    ...
    <tr>
      ...
      <td scope="col" style="text-align: right;"><?php echo $Importe; ?></td>
    </tr>
<?php 
    $tot_cajas    += $Cajas;
    $tot_piezas   += $Piezas;
...
?>
    <tr>
      ...
      <th scope="col" style="text-align: right;"><?php echo $tot_cajas; ?></th>
      <th scope="col" style="text-align: right;"><?php echo $tot_piezas; ?></th>
      <th scope="col" style="text-align: right;"><?php echo $tot_importe; ?></th>
    </tr>
...
<?php 
    $sql = "SELECT 
            cob.Documento, cte.RazonSocial as Cliente, IFNULL(cob.Saldo, 0) AS limite_credito, IFNULL(dc.Abono, 0) AS saldo
            FROM Cobranza cob
            ...
            WHERE cob.DiaO = $diao AND r.cve_ruta = '$ruta' #AND IFNULL(dc.Abono, 0) > 0
            ";
    if (!($res = mysqli_query($conn, $sql))){
        echo "Falló la preparación(2): (" . mysqli_error($conn) . ") ";
    }
...
?>
    <tr>
      ...
      <td scope="col" style="text-align: right;"><?php echo $limite_credito; ?></td>
      <td scope="col" style="text-align: right;"><?php echo $saldo; ?></td>
    </tr>
<?php 
...
?>
    <tr>
      <th scope="col"></th>
      <th scope="col" style="text-align: right;">Total:</th>
      <th scope="col" style="text-align: right;"><?php echo $tot_limite_credito; ?></th>
      <th scope="col" style="text-align: right;"><?php echo $tot_saldo; ?></th>
    </tr>
...
?>
    <tr>
      ...
      <td scope="col" style="text-align: right;"><?php echo $preventa; ?></td>
    </tr>

    <tr>
      <th scope="col" style="text-align: left;">Ventas Contado</th>
      <td scope="col" style="text-align: right;"><?php echo $venta_contado; ?></td>
    </tr>

    <tr>
      <th scope="col" style="text-align: left;">Ventas Credito</th>
      <td scope="col" style="text-align: right;"><?php echo $venta_credito; ?></td>
    </tr>

    <tr>
      <th scope="col" style="text-align: left;">Devoluciones</th>
      <td scope="col" style="text-align: right;"><?php echo $devoluciones; ?></td>
    </tr>

    <tr>
      <th scope="col" style="text-align: left;">Cobranza</th>
      <td scope="col" style="text-align: right;"><?php echo $tot_saldo; ?></td>
    </tr>

    <tr>
      <th scope="col" style="text-align: left;">Descuentos</th>
      <td scope="col" style="text-align: right;"><?php echo $Descuento; ?></td>
    </tr>
    ...
    <tr>
      ...
      <th scope="col" style="text-align: right;"><?php echo ($preventa+$venta_contado+/*$venta_credito+*/$devoluciones+$tot_saldo+$Descuento); ?></th>
    </tr>
