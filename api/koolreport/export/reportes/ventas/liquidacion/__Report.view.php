            ...
            <td align="center" style="font-size: 14px;width: 950px; text-align: center; vertical-align: middle;">
                ...
                <table border="0">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;">&nbsp;&nbsp;&nbsp;<?php echo $diao; ?></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td style="font-size: 18px;text-align: right;"><span lang="th"><b>Agente:</b></span></td>
                        <td style="text-align: left;">
                            &nbsp;&nbsp;&nbsp;<?php echo "(" . $Cve_Vendedor . ") " . $Nombre_Vendedor; ?></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align: left;">
                            &nbsp;&nbsp;&nbsp;<?php echo "(" . $clave_almacen . ") " . $nombre_almacen; ?></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    </tr>
                ...
                <tr>
                    ...
                    for ($i = 0; $i < count($arr_fila); $i++) {
                        ...
                        if ($arr_res[0] == "Entrega") {
                            $entregaCaja += $arr_res[4];
                            $entregaPieza += $arr_res[5];
                            $descuentoCaja += $arr_res[7];
                            $descuentoPieza += $arr_res[8];
                            $total += $arr_res[6];
                            $tot_entrega_cajas += $arr_res[4] - $arr_res[7];
                            $tot_entrega_piezas += $arr_res[5] - $arr_res[8];
                            $stock_final_cajas -= $arr_res[4];
                            $stock_final_piezas -= $arr_res[5];
                            $row_promociones_cajas += $arr_res[7];
                            $row_promociones_piezas += $arr_res[8];
                    ...
                    <?php /*Cajas*/ ?>
                    <?php /*-----------------*/ ?>
                    <td align="right"><?php echo $entregaCaja - $descuentoCaja; ?></td>
                    <?php /*-----------------*/ ?>
                    <?php /*Piezas*/ ?>
                    <?php /*-----------------*/ ?>
                    <td align="right"><?php echo $entregaPieza - $descuentoPieza; ?></td>
                    <?php /*-----------------*/ ?>
...
//                    $stock_final_piezas -= $row_promociones_piezas;
            ...
            <tr>
                ...
                <th scope="col"
                    style="text-align: right;padding-top: 30px;"><?php echo $tot_stock_inicial_cajas; ?></th>
                <th scope="col"
                    style="text-align: right;padding-top: 30px;"><?php echo $tot_stock_inicial_piezas; ?></th>
                ...
                <th scope="col"
                    style="text-align: right;padding-top: 30px;"><?php echo $tot_devoluciones_piezas; ?></th>
                ...
                <th scope="col"
                    style="text-align: right;padding-top: 30px;"><?php echo $tot_promociones_prev_cajas; ?></th>
                <th scope="col"
                    style="text-align: right;padding-top: 30px;"><?php echo $tot_promociones_prev_piezas; ?></th>

                <th scope="col"
                    style="text-align: right;padding-top: 30px;"><?php echo number_format($total_importe, 2); ?></th>
...
GROUP BY liq.TipoOperacion
 ";
            ...
            while ($row = mysqli_fetch_array($res)) {
                extract($row);
                if ($TipoOperacion == 'PreVenta') $preventa += $Total - $Descuento;
                if ($TipoOperacion == 'Contado') $venta_contado += $Total - $Descuento;
                if ($TipoOperacion == 'Credito') $venta_credito += $Total - $Descuento;
                if ($TipoOperacion == 'Devoluciones') $devoluciones += $Total - $Descuento;
            ...
            <tr>
                ...
                <td scope="col"
                    style="text-align: right;"><?php echo number_format($venta_contado, 2); ?></td>
            </tr>
            ...
            <tr>
                ...
                <th scope="col"
                    style="text-align: right;"><?php echo number_format($total_importe) > 0 ? (number_format($total_importe - $preventa - $venta_credito - $descuentos_vp + $tot_saldo, 2)) : 0; ?></th>
            </tr>
