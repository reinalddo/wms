    ...
    */
    for ($i=0; $i<9; $i++) {
      ...
      for ($j=0; $j<3; $j++) {
        $index = $i * 3 + $j;
        $row = $data[$index];
        $productCode = "774384-".$j;//$row['productCode'];
        $code = $j;//(string)str_replace('_', '', substr($productCode, 1));
        // echo $code;
        ?>
        <div class="col-md-4">
          <a href="#" class="pk">
            <div class="card">
              ...
              <div class="card-body">
                <div class="pk-info">
                    <h3><strong><?php echo "Product".$j;//$row['productName']; ?></strong></h3>
                    <p><?php echo "Descripcion".$j;//$row['productDescription']; ?></p>
                </div>
                <table style="width:100%;">
                  <tbody>
                    <tr>
                      <td><b><?php echo "Precio"; ?></b></td>
                      <td class="text-right text-primary" style="vertical-align:bottom;"><b><?php echo '$' . "20".$j;//$row['buyPrice']; ?></b></td>
                    </tr>
                  </tbody>
                </table>
                <div class="row">
