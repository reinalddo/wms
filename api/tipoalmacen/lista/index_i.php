...
if (isset($_POST) && !empty($_POST)) {
    ...
    $sqlCount = "Select count(*) as cuenta from tipo_almacen Where Activo = '1'";
    ...
    $sql = "Select * from tipo_almacen Where desc_tipo_almacen like '%".$_criterio."%' and Activo = '0' Order by desc_tipo_almacen ASC  LIMIT $_page, $limit;";
    ...
    while ($row = mysqli_fetch_array($res)) {
        ...
        $responce->rows[$i]['cell']=array($row['id'],$row['clave_talmacen'], $row['desc_tipo_almacen']);
        $i++;
    }
