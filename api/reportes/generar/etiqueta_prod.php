...
$data = (array) $a->loadArt($_SESSION["cve_articulo"]);
        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <div class=\"barcodecell\"><barcode code=\"" . $d["barras2"] ."\" type=\"C128A\" class=\"barcode\" /></div>
                    <div style=\"width: 384px; height: 50px; text-align: center;\">" . $d["barras2"] ."</div>
					</td>
                </tr>
				<tr>
                    <td align='center' style=\"width: 384px; height: 60px;\">&nbsp;&nbsp;&nbsp;&nbsp;
                    <div class=\"barcodecell\"><barcode code=\"" . $d["barras3"] ."\" type=\"C128A\" class=\"barcode\" /></div>
                    <div style=\"width: 384px; height: 50px; text-align: center;\">" . $d["barras3"] ."</div>
					</td>
                </tr>
                <tr>
