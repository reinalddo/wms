...
if (isset($_POST) && !empty($_POST)) {
    ...
    $sqlCount = "Select count(*) as cuenta from c_tipocia Where Activo = '1'";
    ...
    $sql = "Select * from c_tipocia Where clave_tcia like '%".$_criterio."%' and Activo = '0' Order by des_tipcia ASC  LIMIT $_page, $limit;";
    ...
    while ($row = mysqli_fetch_array($res)) {
        ...
        $responce->rows[$i]['cell']=array($row['cve_tipcia'],$row['clave_tcia'], $row['des_tipcia'], utf8_encode(Sustituto_Cadena($row['cve_cia'])));
        $i++;
    }
