...
if (isset($_POST) && !empty($_POST)) {
  ...
  //die();
    ...
    $sqlCount = "SELECT *  FROM `c_procedimientos`";
  ...
  //echo var_dump($sqlCount);
    ...
    $sql = "SELECT id, nombreDeProcedimiento FROM c_procedimientos";
    ...
    while ($row = mysqli_fetch_array($res)) {
        ...
        $responce->rows[$i]['cell']=array($row["id"],$row["nombreDeProcedimiento"]);
        $i++;
    }
