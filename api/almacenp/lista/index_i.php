...
if (isset($_POST) && !empty($_POST)) {
    ...
    $sqlCount = "Select count(*) as cuenta from c_almacenp Where Activo = '1'";
    ...
    $sql = "Select * from c_almacenp Where nombre like '%".$_criterio."%' and Activo = '0' Order by nombre ASC  LIMIT $_page, $limit;";
    ...
    while ($row = mysqli_fetch_array($res)) {
        ...
        $responce->rows[$i]['cell']=array($row['id'],$row['nombre'], $row['nombre'], utf8_encode(Sustituto_Cadena($row['direccion'])), utf8_encode(Sustituto_Cadena($row['contacto'])));
        $i++;
    }
