...
if (isset($_POST) && !empty($_POST)) {
    ...
    $sql = "SELECT *
            ...
            Where MOT_DESC like '%{$_criterio}%' and Activo = '1' AND id_almacen = '{$id_almacen}';";
    ...
    while ($row = mysqli_fetch_array($res)) {
        ...
        $arr[] = $row;
        $responce->rows[$i]['id']=$row['MOT_ID'];
        $responce->rows[$i]['cell']=array($row['MOT_ID'], ($row['Clave_motivo']), ($row['MOT_DESC']));
        $i++;
    }
