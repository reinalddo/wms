...
if (isset($_POST) && !empty($_POST)) {
    ...
    $sqlCount = "Select * from th_aduana Where Activo = '1';";
    ...
    $conn = mysqli_connect(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME);
        ...
        $sql = "Select 
            ...
            c_proveedores.Empresa
        from th_aduana INNER JOIN c_proveedores ON th_aduana.ID_Proveedor = c_proveedores.ID_Proveedor Where c_proveedores.Empresa like '%".$_criterio."%' and th_aduana.Activo = '1';";
    ...
    while ($row = mysqli_fetch_array($res)) {
        ...
        $responce->rows[$i]['cell']=array($row['ID_Aduana'], $row['num_pedimento'], $row['Empresa']);
        $i++;
    }
