...
/*
    $sql = "
            SELECT DISTINCT
                ...
                #ROUND(((IFNULL(a.cajas_palet, 0))*0.25), 0) AS minimo,

                #IF(IFNULL(u.Reabasto, 'N') = 'C', ROUND((IFNULL(a.Max_Cajas, tu.CapacidadMinima)*0.25), 0), ROUND((IFNULL(a.Max_Cajas, tu.CapacidadMinima)*IFNULL(a.num_multiplo, 1)*0.25), 0)) AS minimo,
                IF(tu.caja_pieza = 'P', IFNULL(tu.CapacidadMaxima, 0), ROUND((IFNULL(tu.CapacidadMaxima, 0)/IFNULL(a.num_multiplo, 1)), 0)) AS maximo,
                #IFNULL(a.cajas_palet, 0) AS maximo,
                #IF(IFNULL(u.Reabasto, 'N') = 'C', (IFNULL(a.Max_Cajas, tu.CapacidadMaxima)), (IFNULL(a.Max_Cajas, tu.CapacidadMaxima)*IFNULL(a.num_multiplo, 1))) AS maximo,

                #IF((SUM(ve.Existencia) <= IFNULL(tu.CapacidadMinima, 0)), CONCAT('<span style=\'color:red;\'>',(IFNULL(tu.CapacidadMaxima, 0)-SUM(ve.Existencia)), '</span>'), 0) AS reabastop,
                #IF(((SUM(ve.Existencia)/IFNULL(a.num_multiplo, 1)) <= ROUND(((IFNULL(a.cajas_palet, 0))*0.25), 0)), CONCAT('<span style=\'color:red;\'>',(IFNULL(a.cajas_palet, 0)-(SUM(ve.Existencia)/IFNULL(a.num_multiplo, 1))), '</span>'), 0) AS reabastop,

                #IF((SUM(ve.Existencia) <= ROUND((IFNULL(a.Max_Cajas, 0)*IFNULL(a.num_multiplo, 1)*0.25), 0)), CONCAT('<span style=\'color:red;\'>',((IFNULL(a.Max_Cajas, 0)*IFNULL(a.num_multiplo, 1))-SUM(ve.Existencia)), '</span>'), 0) AS reabastop,
                ...
                #IF((TRUNCATE((SUM(ve.Existencia)/IFNULL(a.num_multiplo, 1)), 0) <= ROUND(((IFNULL(a.Max_Cajas, 0))*0.25), 0)), CONCAT('<span style=\'color:red;\'>',(IFNULL(a.Max_Cajas, 0)-TRUNCATE((SUM(ve.Existencia)/IFNULL(a.num_multiplo, 1)), 0)), '</span>'), 0) AS reabasto,
                ...
                a.num_multiplo,
                #TRUNCATE((SUM(ve.Existencia)/IFNULL(a.num_multiplo, 1)), 0) AS existencia,
                #SUM(ve.Existencia) AS existencia,
                ...
                #IF(IFNULL(u.Reabasto, 'N') = 'C', 'Cajas', 'Piezas') AS tipo_reabasto,
            ...
            LEFT JOIN c_articulo a ON a.cve_articulo = ve.cve_articulo #AND IFNULL(a.Max_Cajas, tu.CapacidadMinima) > 0
            INNER JOIN c_ubicacion u ON u.idy_ubica = ve.cve_ubicacion AND u.picking = 'S' #AND IFNULL(u.Reabasto, 'N') != 'N'
