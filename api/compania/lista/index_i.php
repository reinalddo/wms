...
if (isset($_POST) && !empty($_POST)) {
    ...
    $sqlCount = "Select count(*) as cuenta from c_compania Where Activo = '1'";
    ...
    $sql = "Select * from c_compania Where clave_empresa like '%".$_criterio."%' and Activo = '0' Order by des_cia ASC  LIMIT $_page, $limit;";
    ...
    while ($row = mysqli_fetch_array($res)) {
        ...
        $responce->rows[$i]['cell']=array($row['cve_cia'],$row['clave_empresa'], $row['des_cia'], utf8_encode(Sustituto_Cadena($row['des_direcc'])), utf8_encode(Sustituto_Cadena($row['des_contacto'])));
        $i++;
    }
