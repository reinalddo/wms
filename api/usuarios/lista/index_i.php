...
if (isset($_POST) && !empty($_POST)) {
    ...
    $sql = "Select * from c_usuario Where Activo = '0' {$sqlSearch} Order by des_usuario ASC  LIMIT $_page, $limit;";
    ...
    while ($row = mysqli_fetch_array($res)) {
        ...
        $responce->rows[$i]['cell']=array($row['id_user'],$row['cve_usuario'], $row['des_usuario'], utf8_encode(Sustituto_Cadena($row['cve_cia'])));
        $i++;
    }
