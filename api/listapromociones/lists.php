                    ...
                    <div class="ibox-content">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group"><label>Consecutivo de Protocolo</label> <input id="Consecut" onkeyup="return ValNumero(this);" type="text" placeholder="Consecutivo de Protocolo" class="form-control"></div>
